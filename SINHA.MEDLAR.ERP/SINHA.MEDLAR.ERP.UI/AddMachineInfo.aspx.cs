...
{
    public partial class AddMachineInfo : System.Web.UI.Page
    {
        ...
        public void loadMachineRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadMachineRecord();
        ...
        public void saveMachineInfo()
        {
            ...
            objLookUpDTO.MachineName = txtMacineName.Text;
            ...
            string strMsg = objLookUpBLL.saveMachineInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteMachineInfo()
        {
            ...
            string strMsg = objLookUpBLL.deleteMachineInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);

        }

        public void searchMachineEntry()
        {
            ...
            objLookUpDTO = objLookUpBLL.searchMachineEntry(txtMachineId.Text, strHeadOfficeId, strBranchOfficeId);

            txtMacineName.Text = objLookUpDTO.MachineName;
        ...
        {
            if (txtMacineName.Text == string.Empty)
            {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (txtMachineId.Text == string.Empty)
            {
                string strMsg = "Please Enter Machine ID!!!";
                txtMachineId.Focus();
                MessageBox(strMsg);
                return;
