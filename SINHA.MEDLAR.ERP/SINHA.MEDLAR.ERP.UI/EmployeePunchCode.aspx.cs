...
{
    public partial class EmployeePunchCode : System.Web.UI.Page
    {
        ...
        public void searchPunchingInfo()
        {
            ...
            dt = objEmployeeBLL.searchPunchingInfo(objEmployeeDTO);
        ...
        public void searchEmployeeRecordforPunching()
        {
            ...
            dt = objEmployeeBLL.searchEmployeeRecordforPunching(objEmployeeDTO);
        ...
        public void savePunchCode()
        {
            ...
            objSalaryDTO.PunchingCode = txtPunchCode.Text;
            ...
            string strMsg = objSalaryBLL.savePunchCode(objSalaryDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
            txtPunchCode.Focus();
        ...
        public void searchPunchingCode()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            objSalaryDTO = objSalaryBLL.searchPunchingCode(txtEmployeeId.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);

            if (objSalaryDTO.PunchingCode == null || objSalaryDTO.PunchingCode == "0")
            {
            ...
            else
            {
                ...
                txtPunchCode.Text = objSalaryDTO.PunchingCode;
            }
        ...
        protected void GridView1_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strPunchCode = GridView1.SelectedRow.Cells[4].Text;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtPunchCode.Text == string.Empty  )
                {
                    goToNextRecord();
                    searchPunchingCode();
                    clearMessage();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                searchEmployeeRecordforPunching();
                clearYellowTextBox();
                clearTextBox();
                gvEmployeeList.SelectedIndex = 0;
                goToNextRecord();
