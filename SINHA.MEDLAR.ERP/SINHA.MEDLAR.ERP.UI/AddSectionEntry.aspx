<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddSectionEntry.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddSectionEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtSectionName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD SECTION INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Item Name :"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Section Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSectionName" runat="server" Width="236px" BackColor="White" Height="20px"
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SECTION_NAME" HeaderText="NAME" />
