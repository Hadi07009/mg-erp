<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="Costing.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.Costing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        ...
        <table class="style1">
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        <legend>COSTING INFORMATION ENTRY</legend>
                        <table class="style1">
                            <tr>
                                <td style="width: 345px; text-align: right; height: 22px;">
                                ...
                                <td style="width: 157px; text-align: right; height: 22px;">
                                    <asp:Label ID="Label46" runat="server" Text="FOB Date :" CssClass="date"></asp:Label>
                                </td>
                                <td style="width: 238px; text-align: left; height: 22px;">
                                    <asp:TextBox ID="dtpCostingDate" runat="server" Width="152px" BackColor="Yellow"
                                        Font-Bold="False"
                            ...
                            <tr>
                                ...
                                <td style="width: 288px; text-align: left; height: 22px;">
                                    <asp:DropDownList ID="ddlContractId" runat="server" Width="156px" AutoPostBack="true"
                                        Height="23px" OnSelectedIndexChanged="ddlContractId_SelectedIndexChanged1">
                                    </asp:DropDownList>
                                ...
                                <td style="width: 238px; text-align: left; height: 22px;">
                                    <asp:DropDownList ID="ddlSeasonId" runat="server" Width="156px" Height="23px" AutoPostBack="true"
                            ...
                            <tr>
                                ...
                                <td style="width: 238px; text-align: left;">
                                    <asp:TextBox ID="txtOrderQuantity" runat="server" Width="154px" Font-Bold="False"
                                        ForeColor="Black" Height="22px" BackColor="Yellow" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td style="width: 238px; text-align: right;">&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 288px; text-align: left;">&nbsp;</td>
                                <td style="width: 157px; text-align: right;">
                                    <asp:Label ID="Label69" runat="server" Text="Reg/Tall/Big :"></asp:Label>
                                </td>
                                <td style="width: 238px; text-align: left;">
                                    <asp:TextBox ID="txtOrderQuantityForRegular" runat="server" Width="50px" Font-Bold="False"
                                        ForeColor="Black" Height="22px" BackColor="Yellow"
                                        ToolTip="Order Qty For Reg" ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox ID="txtOrderQuantityForTall" runat="server" Width="50px" Font-Bold="False"
                                        ForeColor="Black" Height="22px" BackColor="Yellow"
                                        ToolTip="Order Qty For Tall" ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox ID="txtOrderQuantityForBig" runat="server" Width="42px" Font-Bold="False"
                                        ForeColor="Black" Height="22px" BackColor="Yellow"
                                        ToolTip="Order Qty For Big" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td style="width: 238px; text-align: right;">&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                                            ...
                                            <td colspan="2">
                                                <asp:GridView ID="gvContractDetails" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="PARTICULARS" ItemStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <asp:DropDownList ID="ddlFabricId" DataTextField="fabric_name" DataValueField="fabric_ID"
                                                                    AutoPostBack="false" OnSelectedIndexChanged="ddlFabricId_SelectedIndexChanged"
                                                        ...
                                                        <asp:TemplateField HeaderText="CONSTRUCTION" ItemStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtConstruction" runat="server" Text='<%#Eval("CONSTRUCTION")%> '
                                                                    AutoPostBack="false"
                                                        ...
                                                        <asp:TemplateField HeaderText="CONSUMPTION" ItemStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtConsumption" runat="server" Text='<%#Eval("CONSUMPTION")%> '
                                                                    AutoPostBack="true" OnTextChanged="txtConsumption_TextChanged"
                                                                    Width="100" Font-Bold="true"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="UNIT PRICE($)" ItemStyle-Width="1%">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtUnitPrice" runat="server" Text='<%#Eval("UNIT_PRICE")%> ' Width="80"
            ...
            <tr>
                ...
                <td style="text-align: left; width: 288px;">&nbsp;</td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("[id *= txtOrderQty]").bind("change", Deductions);
        ...
        function Deductions() {
            if (!jQuery.trim($(this).val()) == '') {
                if (!isNaN(parseFloat($(this).val()))) {
                    ...
                    //result.orderQty = Number($("[id *= txtOrderQty]", row).val());
                    //result.consumption = Number($("[id *= txtConsumption]", row).val());

                    //result.totalQty = (result.orderQty * result.consumption).toFixed(4)
                    //$("[id *= txtQuantity]", row).val(result.totalQty);


                   
                    //resultNew.unitPrice = $("[id *= txtUnitPrice]", row).val();
                    //resultNew.totalQty = $("[id *= txtQuantity]", row).val();


                    //resultNew.netTotal = Math.round(resultNew.unitPrice * resultNew.totalQty).toFixed(2);
