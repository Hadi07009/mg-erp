...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddSupplierType : System.Web.UI.Page
    {
        ...
        public void loadSupplierType()
        {
            ...
            dt = objLookUpBLL.loadSupplierType();
        ...
        public void saveSupplierType()
        {
            ...
            objLookUpDTO.SupplierTypeId = txtSupplierTypeId.Text;
            objLookUpDTO.SupplierType = txtSupplierType.Text;
            ...
            string strMsg = objLookUpBLL.saveSupplierType(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtSupplierTypeId.Text = strCourseId;
            txtSupplierType.Text = strcourseName;
        ...
        {
            if (txtSupplierType.Text == "")
            {

                string strMsg = "Please Enter Supplier Type!!!";
