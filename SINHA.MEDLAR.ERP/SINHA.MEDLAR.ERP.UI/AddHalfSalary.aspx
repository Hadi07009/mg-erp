<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddHalfSalary.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddHalfSalary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>HALF SALARY INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 338px">
                    <asp:Label ID="lblId1" runat="server" Text="Employee Type :"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlEmployeeTypeId" runat="server" Width="154px" Height="22px">
                    </asp:DropDownList>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td style="text-align: right; width: 338px; height: 22px;">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Day :"></asp:Label>
                </td>
                <td style="height: 22px">
                    <asp:TextBox ID="txtWorkingDay" runat="server" Width="150px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 338px; height: 19px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Salary Percentage :"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtSalaryPercentage" runat="server" Width="150px" 
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="gvUnit_SelectedIndexChanged"
