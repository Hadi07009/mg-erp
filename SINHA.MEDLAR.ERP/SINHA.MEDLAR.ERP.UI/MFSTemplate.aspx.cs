...
{
    public partial class MFSTemplate : System.Web.UI.Page
    {
        private const string paymentTypeId = "1"; //MONTHLY SALARY
        ...
        public string CreatePhaseIdInMonthlySalary()
        {
            ...
            try
            {
                ...
                objEmployeeDTO.PaymentTypeId = paymentTypeId; //monthly salary
