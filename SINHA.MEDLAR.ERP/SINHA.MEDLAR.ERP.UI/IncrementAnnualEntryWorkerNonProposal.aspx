<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="IncrementAnnualEntryWorkerNonProposal.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.IncrementAnnualEntryWorkerNonProposal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>WORKER INCREMENT INFORMATION(NON PROPOSAL)</legend>
        <table class="style1">
            <tr>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 47px; text-align: right; height: 28px;">
                                    &nbsp;
                                </td>
                           ...
                           <tr>
                                ...
                                <td style="width: 191px; text-align: left; height: 22px;">
                                    <asp:CheckBox ID="ChkAllowGeneralIncrement" runat="server" Text="" Visible="true"  Enabled="true"></asp:CheckBox>
                                </td>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnIncrementSheetByUnit" runat="server" Height="31px" 
                                        Text="Sheet By Unit" Width="100px"
                                        CssClass="styled-button-4" OnClick="btnIncrementSheetByUnit_Click" />
                                    <asp:Button ID="btnWorkerSummerySheet" runat="server" Height="31px" 
                                        Text="Summery" Width="70px"
                                        CssClass="styled-button-4" OnClick="btnWorkerSummerySheet_Click"  />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MANUAL_INCREMENT_AMOUNT" HeaderText="INC." ItemStyle-Width="20px" />
