<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddMenuInfo.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMenuInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 339px; height: 21px;">
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Menu Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtMenuName" runat="server" Width="236px" BackColor="White" ></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 339px; height: 26px;">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Menu Path :"></asp:Label>
                </td>
                <td style="height: 26px">
                    <asp:TextBox ID="txtMenuPath" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)" Height="20px"></asp:TextBox>
                </td>
                <td style="height: 26px">
                    </td>
            </tr>
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                OnRowEditing="gvUnit_RowEditing" BorderStyle="Solid" Width="1034px">
                <Columns>
