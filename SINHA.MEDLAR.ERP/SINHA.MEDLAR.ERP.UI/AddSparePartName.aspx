<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="AddSparePartName.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddSparePartName" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtSparePartName.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSparePartId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                <td style="text-align: right; width: 279px; height: 22px;">
                    <asp:Label ID="lblProductCataroy1" runat="server" Text="Equipement Name :"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSparePartName" runat="server" Width="236px" BackColor="White"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="txtSparePartNo" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="SPARE_PART_ID" HeaderText="ID" />
                            <asp:BoundField DataField="EQUIPMENT_NAME" HeaderText="EQUIPMENT NAME" />
                            <asp:BoundField DataField="SPARE_PART_NAME" HeaderText="PART NAME" />
                            <asp:BoundField DataField="SPARE_PART_NO" HeaderText="PART NO" />
