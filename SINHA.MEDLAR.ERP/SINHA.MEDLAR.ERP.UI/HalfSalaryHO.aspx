<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="HalfSalaryHO.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.HalfSalaryHO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>HO HALF SALARY INFORMATION</legend>
        <table class="style1">
            <tr>
                ...
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="width: 257px; text-align: right">
                                    <asp:Label ID="Label44" runat="server" Text="Advance :"></asp:Label>
                                </td>
                                <td style="width: 288px; text-align: left;">
                                    <asp:TextBox ID="txtAdvanceAmount" runat="server" Width="96px" Height="20px" defaultfocus="txtWorkingDay"
                                        onkeydown="javascript:TextName_OnKeyDown(event)" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="width: 85px; text-align: right;">
                                    &nbsp;</td>
                            ...
                            <tr>
                                <td style="width: 257px; text-align: right">
                                    <asp:Label ID="Label45" runat="server" Text="Salary(%) :"></asp:Label>
                                </td>
                                <td style="width: 288px; text-align: left;">
                                    <asp:TextBox ID="txtSalaryPercentage" runat="server" Width="96px"   onkeydown="javascript:TextName_OnKeyDown(event)"
                                        Height="20px"
                                        BackColor="White" Font-Bold="True" ForeColor="Black"></asp:TextBox>
                                </td>
                                <td style="width: 85px; text-align: right;">
                                    &nbsp;</td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 257px; text-align: right; height: 26px;">
                                    <asp:Label ID="Label43" runat="server" Text="Advance Salary :"></asp:Label>
                                </td>
                                <td style="width: 288px; text-align: left; height: 26px;">
                                    <asp:TextBox ID="txtAdvanceFee" runat="server" Width="94px" Height="20px" Font-Bold="True"
                                ...
                                <td style="width: 85px; text-align: right; height: 26px;">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td style=" text-align: right; width: 257px;">
                                    &nbsp;
                                </td>
                                <td style="width: 288px; text-align: left;">
                                    &nbsp;
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnShow" runat="server" Height="31px" Text="Show" Width="55px" OnClick="btnShow_Click"
                                        CssClass="styled-button-4" />
                                    <asp:Button ID="btnSalaryProcess" runat="server" Height="31px" Text="Process" Width="55px"
                                        CssClass="styled-button-4" OnClick="btnSalaryProcess_Click" />
                                    <asp:Button ID="btnFirstSheet" runat="server" Height="31px" Text="First" CssClass="styled-button-4"
                                        Width="66px" onclick="btnFirstSheet_Click"  />
                                    <asp:Button ID="btnFirstSlip" runat="server" Height="31px" Text="Slip" CssClass="styled-button-4"
                                        Width="66px" onclick="btnFirstSlip_Click"   />
                                    <asp:Button ID="btnSecondSheet" runat="server" Height="31px" Text="Second" CssClass="styled-button-4"
                                        Width="66px" onclick="btnSecondSheet_Click"  />
                                    <asp:Button ID="btnSecondSlip" runat="server" Height="31px" Text="Slip" CssClass="styled-button-4"
                                        Width="66px" onclick="btnSecondSlip_Click"   />
                                    <asp:Button ID="btnBankSheet" runat="server" Height="31px" Text="Bank "
                                        CssClass="styled-button-4" Width="55px" onclick="btnBankSheet_Click" 
                                        />
                                    <asp:Button ID="btnCashSheet" runat="server" Height="31px" Text="Cash Sheet"
                                        CssClass="styled-button-4" Width="80px" OnClick="btnCashSheet_Click" 
                                        />
                                    <asp:Button ID="btnCashSlip" runat="server" Height="31px" Text="Cash Slip"
                                        CssClass="styled-button-4" Width="70px" OnClick="btnCashSlip_Click" 
                                        />
                                    <asp:Button ID="btnCashRequisitionSheet" runat="server" Height="31px" Text="Cash Requisition"
                                        CssClass="styled-button-4" Width="110px" OnClick="btnCashRequisitionSheet_Click"
                                        />
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="WORKING_DAY" HeaderText="DAY" />
                                             <asp:BoundField DataField="SALARY_PERCENTAGE" HeaderText="SALARY(%)" />
