...
{
    public partial class AddMachineBrand : System.Web.UI.Page
    {
        ...
        public void loadMachineBranchRecord()
        {
            ...
            dt = objLookUpBLL.loadMachineBranchRecord();
        ...
        {
            txtMachineBrandId.Text = string.Empty;
            txtMachineBrandName.Text = string.Empty;

        }

        public void saveMachineBrand()
        {
            ...
            objWokerProcessDTO.BrandId = txtMachineBrandId.Text;
            objWokerProcessDTO.BrandName = txtMachineBrandName.Text;
            ...
            string strMsg = objWorkerProcessBLL.saveMachineBrand(objWokerProcessDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtMachineBrandId.Text = strProcessId;
            txtMachineBrandName.Text = strProcessName;

            string strMsg = "Row Index: " + strRowId + "\\nMachine Brand ID: " + strProcessId + "\\nMachine Brand Name : " + strProcessName;
