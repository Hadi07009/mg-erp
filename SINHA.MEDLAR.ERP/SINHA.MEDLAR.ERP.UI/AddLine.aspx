<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddLine.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddLine" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtLine.ClientID %>").focus(); }) 
    </script>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 279px">
                    <asp:Label ID="txtLineName" runat="server" Text="Line Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtLine" runat="server" Width="236px" BackColor="White" Height="20px"
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LINE_NAME" HeaderText="NAME" />
