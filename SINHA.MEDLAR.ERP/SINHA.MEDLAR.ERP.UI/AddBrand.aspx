<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddBrand.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddBrand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtBrandName.ClientID %>").focus(); }) 
    </script>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtBrandId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 342px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Brand Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtBrandName" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
