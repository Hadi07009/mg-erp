<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="Promotion.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.Promotion" %>
                                        ...
                                        <table class="style1" style="width: 129%; height: 60px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 60px; text-align: right; height: 31px;" >
                                                    <asp:Button ID="btnSearch" runat="server" Height="25px" Text="Search" Width="50px"
