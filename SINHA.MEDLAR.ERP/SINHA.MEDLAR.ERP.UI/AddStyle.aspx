<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddStyle.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddStyle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtStyleName.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtStyleName" runat="server" Width="180px" BackColor="White" Font-Bold="True"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
