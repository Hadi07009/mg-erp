...
{
    public partial class SewingDefectEntry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         //   loadSewingDefectEntryInfo();
            ...
            txtFabricDefect.Attributes.Add("onkeypress", "return controlEnter('" + txtOpenInsecureStitch.ClientID + "', event)");
            txtOpenInsecureStitch.Attributes.Add("onkeypress", "return controlEnter('" + txtBrokenStitch.ClientID + "', event)");
        ...
        public void loadSewingDefectEntryInfo()
        {
            SewingDTO objSewingDTO = new SewingDTO();
            SewingBLL objSewingBLL = new SewingBLL();

            DataTable dt = new DataTable();
            dt = objSewingBLL.loadSewingDefectEntryInfo(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveSewingDefectEntryInfo()
        {

            SewingDTO objSewingDTO = new SewingDTO();
            SewingBLL objSewingBLL =new SewingBLL();

            objSewingDTO.SewingDefectEntryId = txtSewingDefectentryId.Text;
            ...
            objSewingDTO.OpenInsecureStitch = txtOpenInsecureStitch.Text;
            ...
            string strMsg = objSewingBLL.saveSewingDefectEntryInfo(objSewingDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void searchSewingDefectEntry()
        {
            ...
            objSewingDTO = objSewingBLL.searchSewingDefectEntry(txtSewingDefectentryId.Text,strHeadOfficeId, strBranchOfficeId);
            ...
            if (objSewingDTO.OpenInsecureStitch == "0")
            {
            ...
            {
                txtOpenInsecureStitch.Text = objSewingDTO.OpenInsecureStitch;
            }
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtSewingDefectentryId.Text = strSewingDefectentryId;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {

            {
                ...
                SewingDefectEntrySearch();
            }
           
        }

        public void SewingDefectEntrySearch()
        {
            SewingDTO objSewingDTO = new SewingDTO();
            SewingBLL objSewingBLL = new SewingBLL();
            DataTable dt = new DataTable();
        ...
        //    objSewingDTO.SewingDefectEntryId = txtSewingDefectentryId.Text;
            ...
            dt = objSewingBLL.SewingDefectEntrySearch(objSewingDTO);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            deleteSewingDefectRecord();
            loadSewingDefectEntryInfo();
            clearTextBox();
        }

        public void deleteSewingDefectRecord()
        {
            SewingDTO objSewingDTO = new SewingDTO();
            SewingBLL objSewingBLL = new SewingBLL();
            ...
            string strMsg = objSewingBLL.deleteSewingDefectRecord(objSewingDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
