<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AttendenceRemarksUpdate.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AttendenceRemarksUpdate" %>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 202px; text-align: left;">
                                    <asp:TextBox ID="txtLunchOutTime" runat="server" Width="100px" Height="20px" 
                            ...
                            <tr>
                                ...
                                <td style="width: 202px; text-align: left;">
                                    <asp:TextBox ID="txtLunchInTime" runat="server" Width="100px" Height="20px" 
                                        Font-Bold="True" Enabled="False"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">
                            ...
                            <tr>
                                ...
                                <td style="width: 202px; text-align: left;">
                                    <asp:TextBox ID="txtFinalTimeOut" runat="server" Width="100px" Height="20px" Font-Bold="True"
                                        onkeydown="javascript:TextName_OnKeyDown(event)" Enabled="False"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="chkAllUnit" runat="server" Text="Y/N" AutoPostBack="true" Font-Bold="True"
                                        ...
                                        OnCheckedChanged="chkExcel_CheckedChanged" Enabled="False" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             ...
                             <tr>
                                ...
                                <td style="width: 202px; text-align: left;">
                                    <asp:TextBox ID="txtOTHourMinute" runat="server" Width="213px" 
                                        BackColor="White" Height="25px" Enabled="False"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">
                                    &nbsp;</td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align: left;padding-left:270px" colspan="4">
                                    ...
                                    <asp:Button ID="btnPrevious" runat="server" Height="31px" Text="Previous" Width="66px"
                                        ...
                                        OnClientClick="target = '_SELF';" Visible="False" />
                                    ...
                                    <asp:Button ID="btnProcess" runat="server" Height="31px" Text="Process" Width="66px"
                                        CssClass="styled-button-4" OnClick="btnProcess_Click" Visible="False" />
                                    ...
                                    <asp:Button ID="btnAbsenceSheet0" runat="server" Height="31px" Text="Manual Attn Sheet"
                                        Width="114px" CssClass="styled-button-4" 
                                        OnClick="btnManualAttendanceSheet_Click" Visible="False" />
                                    <asp:Button ID="btnAttendenceSheet0" runat="server" Height="31px" 
                                        Text="WO LogIn Sheet" Width="66px"
                                        CssClass="styled-button-4" OnClick="btnWOLogInSheet_Click" 
                                        Visible="False" />
                                    <asp:Button ID="btnAttendenceSheet1" runat="server" Height="31px" 
                                        Text="WO Last Out Sheet" Width="83px"
