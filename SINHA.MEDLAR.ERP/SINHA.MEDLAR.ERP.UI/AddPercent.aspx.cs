...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class ADDPercent : System.Web.UI.Page
    {
        ...
        public void loadPercentageAmount()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadPercentageAmount();
        ...
        public void clearTextBox()
        {
            ...
            txtPercentageAmount.Text = string.Empty;
            txtPercentageAmountId.Text = string.Empty;
        ...
        public void savePercentageAmount()
        {
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strAmountId = gvUnit.SelectedRow.Cells[0].Text;
            string strAmount = gvUnit.SelectedRow.Cells[1].Text;

            string strMsg = "Row Index: " + strRowId + "\\n ID: " + strAmountId + "\\nPercent Amount : " + strAmount ;
