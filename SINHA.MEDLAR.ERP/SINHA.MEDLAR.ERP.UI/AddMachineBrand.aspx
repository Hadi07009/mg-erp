<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddMachineBrand.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineBrand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMachineBrandName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>MACHINE BRAND INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>MACHINE BRAND ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMachineBrandId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMachineBrandName" runat="server" Width="236px" BackColor="White"
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="MACHINE_BRAND_ID" HeaderText="ID" />
                            <asp:BoundField DataField="MACHINE_BRAND_NAME" HeaderText="MACHINE BRAND" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
