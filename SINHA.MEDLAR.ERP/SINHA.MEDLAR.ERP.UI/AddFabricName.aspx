<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddFabricName.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddFabricName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 340px; height: 22px;">
            ...
            <tr>
                <td style="text-align: right; width: 340px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Fabric Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtFabricName" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FABRIC_NAME" HeaderText="FABRIC NAME" />
