<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="AddMachineInfo.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMacineName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD MACHINE INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMachineId" runat="server" Width="72px" BackColor="Yellow" 
            ...
            <tr>
                <td style="text-align: right; width: 280px">
                    <asp:Label ID="lblId0" runat="server" Text="Machine Name  : "></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtMacineName" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"
                        Height="20px"></asp:TextBox>
                </td>
                <td style="width: 102px; text-align: right">
                    &nbsp;
