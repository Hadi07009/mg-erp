...
{
    public partial class AddMeasurementDiscrepancy : System.Web.UI.Page
    {
       ...
       // string strUpdateDate = "";
        ...
        public void loadMeasurementDiscrepancy()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadMeasurementDiscrepancy(strHeadOfficeId, strBranchOfficeId);
        ...
        public void clear()
        {
            ...
            txtMeasurementDiscrepancyId.Text = string.Empty;
            
            txtMeasurementDiscrepancyName.Text = string.Empty;


        }
        public void saveMeasurementDiscrepancy()
        {
            ...
            objLookUpDTO.FabricId = txtMeasurementDiscrepancyId.Text;
            objLookUpDTO.FabricName= txtMeasurementDiscrepancyName.Text;
            ...
            string strMsg = objLookUpBLL.saveMeasurementDiscrepancy(objLookUpDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtMeasurementDiscrepancyName.Text == "")
                {
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtMeasurementDiscrepancyId.Text = strSewingStitchDefectId;
            txtMeasurementDiscrepancyName.Text = strSewingStitchDefectName;
