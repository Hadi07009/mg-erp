<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddUnitStore.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddUnitStore" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtUnitName.ClientID %>").focus(); }) 
    </script>
    <table class="style1">
        <tr>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD UNIT STORE</legend>
        <table style="width: 100%">
            <tr>
                <td style="text-align: justify; height: 18px;" colspan="3">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtUnitName" runat="server" Width="236px" BackColor="White" Height="20px"
