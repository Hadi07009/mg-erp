<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddNationality.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddNationality" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(window).load(function () { document.getElementById("<%= txtNationalityId.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtNationalityId" runat="server" Width="72px" 
            ...
            <tr>
                <td style="text-align: right; width: 337px">
                    <asp:Label ID="lblNationalityName" runat="server" Text="Nationality:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtNationalityName" runat="server" Width="236px" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvNationality" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvNationality_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvNationality_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="NATIONALITY_ID" HeaderText="ID" />
