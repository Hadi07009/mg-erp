...
{
    public partial class AddProgrammeSection : System.Web.UI.Page
    {
        ...
        public void loadProgrammeSectionRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadProgrammeSectionRecord();
        ...
        public void saveProgrammeSection()
        {
            ...
            string strMsg = objLookUpBLL.saveProgrammeSection(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteProgrammeSection()
        {
            ...
            string strMsg = objLookUpBLL.deleteProgrammeSection(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void searchProgrammeSectionEntry()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchProgrammeSectionEntry(txtSectionId.Text, strHeadOfficeId, strBranchOfficeId);
