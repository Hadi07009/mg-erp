<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="AddBuyerStore.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddBuyerStore" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtBuyerName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 337px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Buyer Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtBuyerName" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td>&nbsp;
                </td>
            </tr>
