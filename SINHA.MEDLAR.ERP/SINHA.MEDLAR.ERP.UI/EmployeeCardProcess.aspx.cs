...
{
    public partial class EmployeeCardProcess : System.Web.UI.Page
    {
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "salary_sheet_worker");
        ...
        public void deleteEmployeeIdCard()
        {
            ...
            string strMsg = objEmployeeBLL.deleteEmployeeIdCard(objEmployeeDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
            
        }

        public void idCardSheet()
        {
            ...
            try
            {
                ...
                {
                    //New: 30.06.2021
                    strPath = Path.Combine(Server.MapPath("~/Reports/rptEmployeeIdCardLikePower.rpt"));
                    //Commented on 30.06.2021
                    //Original: Head Office 
                    //strPath = Path.Combine(Server.MapPath("~/Reports/rptEmployeeIdCardHO.rpt"));
                }
                else if (strHeadOfficeId == "441")
                {
                    //New: Do not remove- user in emmergency case
                    //strPath = Path.Combine(Server.MapPath("~/Reports/rptEmployeeIdCardLikePower.rpt"));
                ...
                {
                    //New: 19.09.2022
                    strPath = Path.Combine(Server.MapPath("~/Reports/rptEmployeeIdCardJK.rpt"));
                ...
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.idCardSheet(objReportDTO));
