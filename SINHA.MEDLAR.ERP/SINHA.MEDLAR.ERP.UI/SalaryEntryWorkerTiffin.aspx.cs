...
{
    public partial class SalaryEntryWorkerTiffin : System.Web.UI.Page
    {
        ...
        public void GetWorkerSalaryMasterSheet()
        {
            ...
            try
            {
                ...
                if (objReportDTO.EmployeeTypeId == "2") //worker
                {
                    ...
                    {
                        strPath = Path.Combine(Server.MapPath("~/Reports/RptWorkerSalaryMasterSheetTiffin.rpt"));
                        this.Context.Session["strReportPath"] = strPath;
                        rd.Load(strPath);
                        rd.SetDataSource(objReportBLL.GetWorkerSalaryMasterSheetTiffin(objReportDTO));
                    }
                }
                rd.SetDatabaseLogon("erp", "erp");
                CrystalReportViewer1.ReportSource = rd;
