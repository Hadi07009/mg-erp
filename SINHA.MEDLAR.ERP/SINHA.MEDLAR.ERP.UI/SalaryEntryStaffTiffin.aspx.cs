...
{
    public partial class SalaryEntryStaffTiffin : System.Web.UI.Page
    {
        ...
        public void saveSalaryMiscEntryStaff()
        {
            ...
            string strMsg = objSalaryBLL.saveMiscSalaryEntryStaff(objSalaryDTO);

            if (strMsg == "SALARY HAS BEEN LOCKED!!!" || strMsg == "THIS EMPLOYEE HAS ALREADY RESIGNED!!!")
            {
        ...
        public void GetAllStaffSalarySheetMisc()
        {
            try
            {
                ReportDTO objReportDTO = new ReportDTO();
                ...
                objReportDTO.EmployeeId = null;
                objReportDTO.CardNo = null;
                ...
                string strPath = string.Empty;
                strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetAllStaffMisc.rpt"));
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "salary_sheet_staff_misc");
        ...
        public void StaffSalarySummaryMisc()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySummeryStaffwTiffin.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.StaffSalarySummaryMiscTiffin(objReportDTO));
        ...
        public void processSalaryMiscStaff()
        {
            ...
            string strMsg = objSalaryBLL.processSalaryMiscStaff(objSalaryDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtAdvanceFee.Text == string.Empty && txtArrearFee.Text == string.Empty && txtFoodAllowance.Text == string.Empty && txtFoodDeduction.Text == string.Empty)
                {
                    goToNextRecord();
                    searchMiscEntryStaff();
                    clearMessage();
        ...
        protected void btnSalaryRequisitionStaffMisc_Click(object sender, EventArgs e)
        {
            try
            {
                GetStaffSalaryRequisitionMisc();
            }
            catch (Exception ex)
            {
                this.CrystalReportViewer1.Dispose();
        ...
        public void GetStaffSalaryRequisitionMisc()
        {
            try
            {
                string strDefaultName = "Report";
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptStaffSalaryRequisitionMisc.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetStaffSalaryRequisitionMisc(objReportDTO));
        ...
        protected void btnStaffMiscReqSummary_Click(object sender, EventArgs e)
        {
            try
            {
                GetStaffMiscReqSummary();
            }
            catch (Exception ex)
            {
                this.CrystalReportViewer1.Dispose();
        ...
        public void GetStaffMiscReqSummary()
        {
            try
            {
                string strDefaultName = "Report";
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptStaffMiscBKashSalaryReqSummary.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetStaffMiscReqSummary(objReportDTO));
        ...
        protected void btnMonthlySalarySheetAll_Click(object sender, EventArgs e)
        {
            try
            {
