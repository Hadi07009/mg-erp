<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="IncrementProposalStaff.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.IncrementProposalStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>INCREMENT PROPOSAL STAFF INFORMATION</legend>
        <table class="style1">
            <tr>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 274px; text-align: left; height: 22px;">
                                    &nbsp;</td>--%>
                                ...
                                <td style="width: 277px; text-align: left; height: 22px;">
                                    <asp:CheckBox ID="ChkAllowGeneralIncrement" runat="server" Text="" Visible="true" Enabled="true" Checked="true"></asp:CheckBox>
                                </td>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    <asp:Button ID="btnProcess" runat="server" Height="31px" Text="Process"
                                        Width="66px" CssClass="styled-button-4" OnClick="btnProcess_Click" 
                                       />
                                    <asp:Button ID="btnSheetAboveOneYear" runat="server" Height="31px" Text="Sheet "
                                        Width="66px" CssClass="styled-button-4" OnClick="btnSheetAboveOneYear_Click" />
                                    <asp:Button ID="btnSheetAboveOneYearAll" runat="server" Height="31px" Text="Sheet All"
                                     ...
                                     <asp:Button ID="btnSheetAboveOneYearOnlyQuality" runat="server" Height="31px" Text="Sheet Quality"
                                        Width="84px" CssClass="styled-button-4" OnClick="btnSheetAboveOneYearOnlyQuality_Click" />
                                    <asp:Button ID="btnSummery" runat="server" Height="31px" Text="Summery Bng." Width="100px"
                                        CssClass="styled-button-4" OnClick="btnSummery_Click" />
                                    <asp:Button ID="btnSummeryEnglish" runat="server" Height="31px" 
                                        Text="Summery Eng." Width="100px"
                                        CssClass="styled-button-4" OnClick="btnSummeryEnglish_Click"  />
                                     <asp:Button ID="btnSummeryEnglishByUnitGroup" runat="server" Height="31px" 
                                        Text="Summary Eng (UG)" Width="140px"
                                        CssClass="styled-button-4" OnClick="btnSummeryEnglishByUnitGroup_Click"  />
                                    <asp:Button ID="btnShow" runat="server" Height="31px" Text="Show" Width="66px" OnClick="btnShow_Click"
                                        CssClass="styled-button-4" />
                                    <asp:Button ID="btnSheetAboveOneYearForExcel" runat="server" 
                            ...
                            <tr>
                                <td style="text-align: right" colspan="4">
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            <tr>
                                                <td style="width: 291px; text-align: right; height: 22px;">
