<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddSalaryLockEntry.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddSalaryLockEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD SALRY LOCK INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>SALARY LOCK ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSalaryYear" runat="server" Width="100px" BackColor="Yellow"></asp:TextBox>
