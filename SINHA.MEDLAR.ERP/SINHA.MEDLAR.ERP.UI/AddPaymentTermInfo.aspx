<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="AddPaymentTermInfo.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddPaymentTermInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtPaymentDay.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD PAYMENT TERMS INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPaymentTermId" runat="server" Width="72px" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPaymentDay" runat="server" Width="236px" onkeydown="javascript:TextName_OnKeyDown(event)"
                        BackColor="White" Font-Bold="False"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="PAYMENT_TERM_ID" HeaderText="ID" />
                            <asp:BoundField DataField="PAYMENT_DAY" HeaderText="DAY" />
