<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="BuyerMeasurement.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.BuyerMeasurement" %>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtQuantity" runat="server" Width="158px" Height="20px" onkeydown="javascript:TextName_OnKeyDown(event)"
                                        ...
                                        <table class="style1">
                                            <tr>
                                                ...
                                                <td style="height: 22px">
                                                    <asp:TextBox ID="txtPoSearchNo" runat="server" Width="149px" BackColor="White"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
