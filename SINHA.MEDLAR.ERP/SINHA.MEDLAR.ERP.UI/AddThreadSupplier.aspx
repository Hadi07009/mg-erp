<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddThreadSupplier.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddThreadSupplier" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtTreadSupplierName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD THREAD SUPPLIER INFO</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtTreadSupplieId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="txtLineName" runat="server" Text="Supplier Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtTreadSupplierName" runat="server" Width="236px" BackColor="White" Height="20px"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvTreadSupplier" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvTreadSupplier_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvTreadSupplier_RowEditing" BorderStyle="Solid">
                <Columns>
