...
{
    public partial class LocalFabricIssue : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtChallanNo.Attributes.Add("onkeypress", "return controlEnter('" + dtpIssueDate.ClientID + "', event)");
        ...
        private void FirstGridViewRow()
        {
            ...
            dt.Columns.Add(new DataColumn("BALANCE_QUANTITY", typeof(string)));
            ...
            dr["BALANCE_QUANTITY"] = string.Empty;
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        TextBox txtBlance = (TextBox)gvFabricDetails.Rows[rowIndex].Cells[4].FindControl("txtBlance");

                        TextBox txtQuantity = (TextBox)gvFabricDetails.Rows[rowIndex].Cells[5].FindControl("txtQuantity");

                        DropDownList ddlMeasureId = (DropDownList)gvFabricDetails.Rows[rowIndex].Cells[6].FindControl("ddlMeasureId");

                        TextBox txtTranId = (TextBox)gvFabricDetails.Rows[rowIndex].Cells[6].FindControl("txtTranId");
                        ...
                        dtCurrentTable.Rows[i - 1]["BALANCE_QUANTITY"] = txtBlance.Text;
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        txtBlance.Text = dt.Rows[i]["BALANCE_QUANTITY"].ToString();
        ...
        public void saveLocalFabricIssue()
        {
            int rowIndex = 0;
            string strMsg = "";
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        sc.Add(string.Format("{0},{1},{2},{3},{4},{5},{6}",  ddlProgrammeId.SelectedValue.ToString(), ddlFabricId.SelectedValue.ToString(), ddlFabricConstructionId.SelectedValue.ToString(), ddlColorId.SelectedValue.ToString(), txtBlance.Text, txtQuantity.Text, ddlMeasureId.SelectedValue.ToString()));
                        ...
                        if (chkReturnToSupplierYn.Checked == true)
                        {
                            objFabricIssueDTO.ReturnToSupplier = "Y";

                        }
                        else
                        {

                            objFabricIssueDTO.ReturnToSupplier = "N";
                        ...
                        strMsg = objFabricIssueBLL.saveLocalFabricIssue(objFabricIssueDTO);
                        //MessageBox(strMsg);
                        lblMsg.Text = strMsg;
        ...
        public void deleteLocalFabricIssue(string strTranId)
        {
            ...
            strMsg = objFabricIssueBLL.deleteLocalFabricIssue(objFabricIssueDTO);
            //MessageBox(strMsg);
            //lblMsg.Text = strMsg;
        ...
        public void searchFabricIssue()
        {
            ...
            dt = objFabricIssueBLL.searchFabricIssue(objFabricIssueDTO);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (dtpIssueDate.Text.Length < 6)
            {
            ...
            else
            {
                ...
                saveLocalFabricIssue();
                searcLocalFabricIssueMain();
                searchFabricIssue();
        ...
        public void searcLocalFabricIssueMain()
        {
            ...
            objFabricIssueDTO = objFabricIssueBLL.searcLocalFabricIssueMain(txtChallanNo.Text, dtpIssueDate.Text, ddlSupplierId.SelectedValue.ToString(), ddlStoreId.SelectedValue.ToString(), strHeadOfficeId, strBranchOfficeId);
            ...
            if (objFabricIssueDTO.ReturnToSupplier == "0")
            {
                chkReturnToSupplierYn.Checked = false;

            }
            else
            {
                chkReturnToSupplierYn.Checked = true;
        ...
        protected void gvFabricDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            deleteLocalFabricIssue(strTranId);
