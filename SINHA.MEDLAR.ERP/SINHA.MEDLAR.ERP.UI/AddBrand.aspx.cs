...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddBrand : System.Web.UI.Page
    {
        ...
        public void loadBrandRecord()
        {
            ...
            dt = objLookUpBLL.loadBrandRecord();
        ...
        public void saveBrandName()
        {
            ...
            objLookUpDTO.BrandId = txtBrandId.Text;
            objLookUpDTO.BrandName = txtBrandName.Text;
            ...
            string strMsg = objLookUpBLL.saveBrandName(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtBrandId.Text = strCourseId;
            txtBrandName.Text = strcourseName;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (txtBrandName.Text == "")
            {
                ...
                string strMsg = "Please Enter Brand Name!!!";
                txtBrandName.Focus();
                MessageBox(strMsg);
                return;
