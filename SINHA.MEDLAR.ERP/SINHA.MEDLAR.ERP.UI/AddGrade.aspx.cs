...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddGrade : System.Web.UI.Page
    {
        ...
        public void loadGradeRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadGradeRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveGrade()
        {
            ...
            objLookUpDTO.GradeId = txtGradeId.Text;
            objLookUpDTO.GradeNo = txtGrade.Text;
            ...
            string strMsg = objLookUpBLL.saveGrade(objLookUpDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void gvUnit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strGradeName = gvUnit.SelectedRow.Cells[1].Text;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string strMsg = "Please Enter Grade!!!";
                    MessageBox(strMsg);
                    txtGradeId.Focus();
                    return;
