...
{
    public partial class AddAestheticDefect : System.Web.UI.Page
    {
        ...
        #region "FUNCTION"
        public void loadAestheticDefectRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadAestheticDefectRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        public void clear()
        {
            ...
            txtAestheticDefectId.Text = string.Empty;
           
            txtAestheticDefectName.Text = string.Empty;


        }

        public void saveAestheticDefect()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO.AestheticDefectId = txtAestheticDefectId.Text;
            objLookUpDTO.AestheticDefectName = txtAestheticDefectName.Text;
            ...
            string strMsg = objLookUpBLL.saveAestheticDefect(objLookUpDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtAestheticDefectId.Text = strSectionId;
            txtAestheticDefectName.Text = strSectionName;
