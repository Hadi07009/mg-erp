...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "report_other");
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rdoDailyAttendenceSheet.Checked == true)
                {
                ...
                if (rdoDailyLateSheet.Checked == true)
                {
                ...
                if (rdoDailyAbsenceSheet.Checked == true)
                {
                ...
                if (rdoEmployeeJobHistoryOverall.Checked == true)
                {
                    ...
                    string strPath = Path.Combine(Server.MapPath("~/Reports/RptGetEmployeeJobHistoryCommon.rpt"));
                    this.Context.Session["strReportPath"] = strPath;
                    rd.Load(strPath);
