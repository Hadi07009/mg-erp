<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryCertificateProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryCertificateProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>SALARY CERTIFICATE INFORMATION</legend>
        <table class="style1">
            <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        <legend>CERTIFICATE PROCESS</legend>
                        <table class="style1">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 277px; text-align: left;">
                                    <asp:DropDownList ID="ddlApprovedBy" runat="server" Width="180px" Height="22px">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnCertificateSheet" runat="server" Height="31px" Text="Sheet" Width="66px"  CssClass = "styled-button-4"
                                        OnClick="btnCertificateSheet_Click" />
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CERTIFICATE_YEAR" HeaderText="YEAR" />
                                            <asp:BoundField DataField="CERTIFICATE_MONTH" HeaderText="MONTH" />
