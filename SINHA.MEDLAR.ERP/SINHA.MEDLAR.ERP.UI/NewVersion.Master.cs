...
{
    //    public partial class NewVersion : System.Web.UI.MasterPage
    //    {
    ...
    public partial class NewVersion : System.Web.UI.MasterPage
    {
        ...
        //            NavigateUrl = row["MENU_PATH"].ToString(),
        //            Selected = row["MENU_PATH"].ToString().EndsWith(currentPage, StringComparison.CurrentCultureIgnoreCase)
        //        };
        //        if (parentMenuId == 0)
        //        {
        //            NavigationMenu.Items.Add(menuItem);
        //            //DataTable dtChild = this.getTopMenuItem(int.Parse(menuItem.Value));
        ...
        //{
        //    get { return this.lblHeadOfficeName.Text; }
        //    set { this.lblHeadOfficeName.Text = value; }

        //}

        //public string HeadOfficeAddress
        //{
        //    get { return this.lblHeadOfficeAddress.Text; }
        //    set { this.lblHeadOfficeAddress.Text = value; }
