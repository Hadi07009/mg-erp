<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="AddWorkerSalaryByGrade.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddWorkerSalaryByGrade" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtSalaryAmount.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD WORKER SALARY ACCODING TO GRADE</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtYear" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                <td style="text-align: right; width: 333px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Grade :"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlGradeId" runat="server" Width="215px" Height="22px">
                    </asp:DropDownList>
                </td>
                <td>
                    &nbsp;
            ...
            <tr>
                <td style="text-align: right; width: 333px; height: 19px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Salary:"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtSalaryAmount" runat="server" Width="210px" 
                        BackColor="White" 
                        onkeydown="javascript:TextName_OnKeyDown(event)" MaxLength="300" 
