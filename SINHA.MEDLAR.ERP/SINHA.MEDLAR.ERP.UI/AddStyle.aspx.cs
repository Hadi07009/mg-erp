...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddStyle : System.Web.UI.Page
    {
        ...
        public void searchStyleEntry()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchFebricEntry(txtStyleId.Text, strHeadOfficeId, strBranchOfficeId);

            txtStyleName.Text = objLookUpDTO.StyleName;
        ...
        public void loadStyleName()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadStyleName();
        ...
        public void saveStyleName()
        {
            ...
            objLookUpDTO.StyleName = txtStyleName.Text;
            ...
            string strMsg = objLookUpBLL.saveStyleName(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtStyleId.Text = strCourseId;
            txtStyleName.Text = strcourseName;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (txtStyleName.Text == "")
            {
                ...
                string strMsg = "Please Enter Style Name!!!";
                txtStyleName.Focus();
                MessageBox(strMsg);
                return;
