...
{
    public partial class AddSalaryLockEntry : System.Web.UI.Page
    {
        ...
        public void loadSalaryLockSetup()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadSalaryLockSetup( txtSalaryYear.Text, txtSalaryMonth.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveSalaryLockSetup( )
        {
            ...
            string strMsg = objLookUpBLL.saveSalaryLockSetup(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
