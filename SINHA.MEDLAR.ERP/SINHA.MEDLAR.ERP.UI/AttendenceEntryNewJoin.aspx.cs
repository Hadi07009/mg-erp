...
{
    public partial class AttendenceEntryNewJoin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                getCurrentDate();
                btnSearch.Focus();
                dtpAttendenceDate.Attributes["min"] = DateTime.Today.ToString("dd-MM-yyyy");
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "attendence_report");
        ...
        public void saveEmployeeAttendence()
        {
            ...
            string strMsg = objEmployeeBLL.saveEmployeeAttendenceNewJoin(objEmployeeDTO);
            lblMsg.Text = strMsg;
        }
