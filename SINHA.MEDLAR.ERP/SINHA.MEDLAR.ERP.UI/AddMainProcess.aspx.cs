...
{
    public partial class AddMainProcess : System.Web.UI.Page
    {
        ...
        public void loadMainProcessRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadMainProcessRecord();
        ...
        public void saveMainProcess()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO.ProcessId = txtProcessId.Text;
            objLookUpDTO.ProcessName = txtProcessName.Text;
            ...
            string strMsg = objLookUpBLL.saveMainProcess(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteMainProcess()
        {
            ...
            string strMsg = objLookUpBLL.deleteMainProcess(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        {
            if (txtProcessId.Text == string.Empty)
            {
