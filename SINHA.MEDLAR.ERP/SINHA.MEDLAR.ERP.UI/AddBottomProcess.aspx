<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="AddBottomProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddBottomProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtBottomName.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBottomId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBottomName" runat="server" Width="236px" BackColor="White" Height="20px"
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="BOTTOM_PROCESS_ID" HeaderText="ID" />
                    <asp:BoundField DataField="BOTTOM_PROCESS_NAME" HeaderText="NAME" />
                </Columns>
            </asp:GridView>
        </td>
    </fieldset>
