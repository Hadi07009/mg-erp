<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddFabricConstruction.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddFabricConstruction" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtFabricConstructionName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD FABRIC CONSTRUCTION</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtFabricConstructionId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Fabric Construction :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtFabricConstructionName" runat="server" Width="236px" BackColor="White"
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="FABRIC_CONSTRUCTION_ID" HeaderText="ID" />
                    <asp:BoundField DataField="FABRIC_CONSTRUCTION_NAME" HeaderText="FABRIC CONSTRUCTION" />
