...
{
    public partial class TiffinEntryDaily : System.Web.UI.Page
    {
        ...
        public void monthlyDayForTiffin()
        {
            ...
            string strMsg = objTiffinBLL.monthlyDayForTiffinDaily(objTiffinDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void monthlyDayForTiffinStaff()
        {
            ...
            string strMsg = objTiffinBLL.TiffinStaffDaily(objTiffinDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
