<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddJobType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddJobType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(window).load(function () { document.getElementById("<%= txtJobTypeId.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtJobTypeId" runat="server" Width="72px" 
            ...
            <tr>
                <td style="text-align: right; width: 336px">
                    <asp:Label ID="lblNationalityName" runat="server" Text="Job Type:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtJobTypeName" runat="server" Width="236px" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvJobType" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvJobType_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvJobType_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="JOB_TYPE_ID" HeaderText="ID" />
