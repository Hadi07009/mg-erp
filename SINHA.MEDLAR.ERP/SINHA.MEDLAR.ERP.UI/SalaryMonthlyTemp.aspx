<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryMonthlyTemp.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryMonthlyTemp" %>
    ...
    <fieldset>
        ...
        <table class="style1">
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnStaff" runat="server" Height="31px" Text="Staff Sheet" Width="80px"
                                        CssClass="styled-button-4" onclick="btnStaff_Click" />
                                    <asp:Button ID="btnSalarySheet" runat="server" Height="31px" 
                                        Text="Worker Sheet" Width="95px"
            ...
            <tr>
                <td colspan="2">
                    <fieldset>
                        <legend>SALARY ENTRY RESULT</legend>
                        <%-- </div>--%>
