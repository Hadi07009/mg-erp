...
{
    public partial class OfficeShiftHoliday : System.Web.UI.Page
    {
       ...
       protected void gvOfficeShiftTime_RowDataBound(GridViewRowEventArgs e)
        ...
        protected void gvOfficeShiftTime_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strCardNo = gvOfficeShiftTime.SelectedRow.Cells[1].Text.Replace("&nbsp;", "");
            string strEmployeeName = gvOfficeShiftTime.SelectedRow.Cells[2].Text.Replace("&nbsp;", "");
            string strDesignation = gvOfficeShiftTime.SelectedRow.Cells[3].Text.Replace("&nbsp;", "");
            string employeeId = gvOfficeShiftTime.SelectedRow.Cells[4].Text.Replace("&nbsp;", "");
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            deleteOfficeShiftHolidayRecord(strEmpId);
            loadOfficeShiftHoliday();
        ...
        protected void GridView1_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string holidayName = GridView1.SelectedRow.Cells[2].Text.Replace("&nbsp;", "");
            string effectDate = GridView1.SelectedRow.Cells[3].Text.Replace("&nbsp;", "");
            string activeYn = GridView1.SelectedRow.Cells[4].Text.Replace("&nbsp;", "");
