<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="PaymentHold.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.PaymentHold" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <fieldset>
        <legend runat="server" id="lgPaymentHold" style="text-align:left; font-size:15px; font-weight:400;"></legend>
          ...
          <tr>
             ...
             <tr>
              <td style="width: 254px; text-align: right">
                  &nbsp;</td>
              <td colspan="4">           
                  <asp:Button ID="btnHold" runat="server" Height="32px" Text="Hold" Width="80px" style="text-align:center;"
                   CssClass="styled-button-4" OnClick="btnHold_Click" />      
                   
                  <asp:Button ID="btnPayment" runat="server" Height="32px" Text="Paid" Width="80px" style="text-align:center;"
                   CssClass="styled-button-4" OnClick="btnPayment_Click" />
                  <asp:Button ID="btnUnpaid" runat="server" Height="32px" Text="Unpaid" Width="80px" style="text-align:center;"
                   CssClass="styled-button-4" OnClick="btnUnpaid_Click" />
                   <asp:Button ID="btnBkashTemplateByPhase" runat="server" Text="Template" Height="30px" Width="80px" style="text-align:center;"
                  CssClass="styled-button-4" OnClick="btnBkashTemplateByPhase_Click" />
                  <asp:Button ID="btnSheet" runat="server" Text="Sheet" Height="30px" Width="80px" style="text-align:center;"
                  CssClass="styled-button-4" OnClick="btnSheet_Click" />
                  <asp:Button ID="btnClear" runat="server" Height="32px" Text="Clear" Width="80px" style="text-align:center;"
      ...
      <fieldset>
        ...
        <table class="style1">    
            ...
            <tr>
              ...
              <td style="width: 95px">
                  <asp:DropDownList ID="ddlEidTypeId" runat="server" Width="264px" Height="28" >
                  </asp:DropDownList>
              </td>
              <td style="width: 66px">
         ...
         <tr>
            ...
            AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting">
                <Columns>
                  ...
                  <asp:BoundField DataField="payment_yn" HeaderText="PAID?"/>
                  ...
                  <asp:TemplateField HeaderText="Id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                    <ItemTemplate>
                      <asp:TextBox ID="txtHoldId" runat="server" Text='<%#Eval("hold_Id")%>' ReadOnly="true"></asp:TextBox>
                    </ItemTemplate>
                 </asp:TemplateField>
             ...
             <td colspan="5">
                ...
                OnPageIndexChanging="GvPayableEmployeeList_PageIndexChanging" Width="1030px" Height="133px">
                 <Columns>
                       ...
                       <asp:BoundField DataField="payment_year" HeaderText="Payment Year" />
                       <asp:BoundField DataField="month_name" HeaderText="Payment Month" />
                      
                     
                      <asp:TemplateField HeaderText="payment_type_id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                        <ItemTemplate>
                             <asp:TextBox ID="txtPayTypeId" runat="server" Text='<%#Eval("payment_type_id")%>' ReadOnly="true"></asp:TextBox>
                         </ItemTemplate>
                     </asp:TemplateField>

                     <asp:TemplateField HeaderText="Payment Year" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                         <ItemTemplate>
                              <asp:TextBox ID="txtPayYear" runat="server" Text='<%#Eval("payment_year")%>' ReadOnly="true"></asp:TextBox>
                         </ItemTemplate>
                     </asp:TemplateField>

                     <asp:TemplateField HeaderText="Payment Month" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                        <ItemTemplate>
                             <asp:TextBox ID="txtPayMonth" runat="server" Text='<%#Eval("payment_month")%>' ReadOnly="true"></asp:TextBox>
                         </ItemTemplate>
                     </asp:TemplateField>
