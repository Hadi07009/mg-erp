<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="LeaveEntryStaff.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.LeaveEntryStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>STAFF LEAVE INFORMATION</legend>
        <table class="style1">
            <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        ...
                        <table class="style1">
                            <tr>
                                <td style="width: 297px; text-align: right">
                            ...
                            <tr>
                                <td style="width: 297px; text-align: right; height: 22px;">
                                    <asp:Label ID="Label27" runat="server" Text="Leave Day :"></asp:Label>
                                </td>
                                <td style="width: 286px; text-align: left; height: 22px;">
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnLeaveStaffSheet" runat="server" Height="31px" Text="1st Sheet"
                                        CssClass="styled-button-4" Width="65px" OnClick="btnLeaveStaffSheet_Click" />
                                    <asp:Button ID="btnLeaveStaffSheetMisc" runat="server" Height="31px" Text="2nd Sheet"
                                        CssClass="styled-button-4" Width="70px" OnClick="btnLeaveStaffSheetMisc_Click" />

                                    <asp:Button ID="btnNonAccountHolderEncashSheet" runat="server" Height="31px" Text="Cash Sheet"
                                        CssClass="styled-button-4" Width="91px" 
                                        OnClick="btnNonAccountHolderEncashSheet_Click" />

                                    <asp:Button ID="BtnMasterSheet" runat="server" Height="31px" Text="Master Sheet" Width="90px"
                                        CssClass="styled-button-4" OnClick="BtnMasterSheet_Click" />

                                    <asp:Button ID="btnLeaveEncashBKashSheetStaff" runat="server" Height="31px" Text="bKash Sheet" Width="84px"
                                        CssClass="styled-button-4" OnClick="btnLeaveEncashBKashSheetStaff_Click" />
                                    <asp:Button ID="btnLeaveEncashCasSheetStaff" runat="server" Height="31px" Text="Cash Sheet" Width="84px"
                                        CssClass="styled-button-4" OnClick="btnLeaveEncashCashSheetStaff_Click" />

                                    <asp:Button ID="btnAccountHolderEncashSheet" runat="server" Height="31px" Text="Bank Sheet"
                                        CssClass="styled-button-4" Width="74px" OnClick="btnAccountHolderEncashSheet_Click" />
                                    <asp:Button ID="btnLeaveEncashBKashTemplateStaff" runat="server" Height="31px" Text="Bkash Template" Width="101px"
                                        CssClass="styled-button-4" OnClick="btnLeaveEncashBKashTemplateStaff_Click" />

                                    <asp:Button ID="btnLeaveEncashBKashTemplateAll" runat="server" 
                                        CssClass="styled-button-4" Height="31px"  Visible="false"
                                        OnClick="btnLeaveEncashBKashTemplateAll_Click" Text="Bkash Template(All)" 
                                        Width="120px" />

                                    <asp:Button ID="btnSheetDetail" runat="server" Height="31px" Text="Sheet Detail"
                                        CssClass="styled-button-4" Width="100px" OnClick="btnSheetDetail_Click" />

                                    <asp:Button ID="btnBankSheet" runat="server" Height="31px" Text="Bank Summary Sheet"
                                        CssClass="styled-button-4" Width="137px" OnClick="btnBankSheet_Click" />
                                    <asp:Button ID="btnLeaveEncashReqStaff" runat="server" Height="31px" 
                                        Text="Staff Req" Width="80px"
                                        CssClass="styled-button-4" onclick="btnLeaveEncashReqStaff_Click"  />
                                    <asp:Button ID="btnLeaveEncashBkashReqStaff" runat="server" Height="31px" 
                                        Text="BKash Req" Width="80px"
                                        CssClass="styled-button-4" onclick="btnLeaveEncashBkashReqStaff_Click"  />
                                    <asp:Button ID="btnCashReqSheet" runat="server" Height="31px" Text="Cash Req."
                                        CssClass="styled-button-4" Width="70px" OnClick="btnCashReqSheet_Click" />

                                    <asp:Button ID="BtnMiscRequisition" runat="server" Height="31px" Text="Misc Req."
                                        CssClass="styled-button-4" Width="70px" OnClick="BtnMiscRequisition_Click" />

                                    <asp:Button ID="btnBankReqSheet" runat="server" Height="31px" Text="Bank Req"
                                        CssClass="styled-button-4" Width="68px" OnClick="btnBankReqSheet_Click" />

                                    <asp:Button ID="btnStaffEncashmentSummary" runat="server" 
                                        CssClass="styled-button-4" Height="31px" 
                                        OnClick="btnStaffEncashmentSummary_Click" Text="Encash(Summary)" 
                                        Width="110px" />

                                    <asp:Button ID="btnLeaveEncashmentSummery" runat="server" Height="31px" Text="Summary"
                                        CssClass="styled-button-4" Width="70px" OnClick="btnLeaveEncashmentSummery_Click" />
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 294px; text-align: right; height: 22px;">
            ...
            <tr>
                <td colspan="2">
                    <fieldset>
                        <legend>LEAVE ENTRY RESULT STAFF</legend>
                        <%-- </div>--%>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        CausesValidation="false" GridLines="None" AllowPaging="false" OnRowEditing="GridView1_OnRowEditing"
