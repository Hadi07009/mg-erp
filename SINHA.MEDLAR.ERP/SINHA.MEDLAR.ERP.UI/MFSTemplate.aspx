<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="MFSTemplate.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.MFSTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend style="text-align:left; font-size:15px;" >MFS TEMPLATE- MONTHLY SALARY</legend>
        <table class="style1">
                    ...
                    <asp:GridView ID="gvEmployeeList" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="SL" HeaderText="SL" ItemStyle-Width="30px"/>
                            ...
                            <asp:BoundField DataField="SECTION_NAME" HeaderText="SECTION" ItemStyle-Width="150px"/>
                            <asp:BoundField DataField="EMP_COUNT" HeaderText="No. Of Employee" ItemStyle-Width="70px"/>
