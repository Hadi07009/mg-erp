<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddIncrementProposalLockEntry.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddIncrementProposalLockEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD INCREMENT PROPOSAL LOCK INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>INCREMENT PROPOSAL LOCK ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
