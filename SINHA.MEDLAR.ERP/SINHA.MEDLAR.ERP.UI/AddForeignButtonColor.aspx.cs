...
{
    public partial class AddForeignButtonColor : System.Web.UI.Page
    {
        ...
        public void searchForeignButtonColor()
        {
            ...
            objLookUpDTO = objLookUpBLL.searchForeignButtonColor(txtColorId.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void loadForeignButtonColorRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadForeignButtonColorRecord();
        ...
        public void saveForeignButtonColor()
        {
            ...
            string strMsg = objLookUpBLL.saveForeignButtonColor(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
