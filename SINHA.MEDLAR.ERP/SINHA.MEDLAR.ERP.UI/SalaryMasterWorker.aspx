<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryMasterWorker.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryMasterWorker" %>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;" class="auto-style6">
                                    <%--<asp:TextBox ID="txtPartialWorkingDay" runat="server" Width="63px" Height="20px" defaultfocus="txtWorkingDay"
                                        Font-Bold="True"></asp:TextBox>--%>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;" class="auto-style6">
                                    ...
                                    <asp:TextBox ID="txtLoanAmount" runat="server" Width="62px" Height="20px" Font-Bold="True"
                                        ForeColor="Red" onkeydown="javascript:TextName_OnKeyDown(event)"
                                        BackColor="Yellow" ReadOnly="True" Enabled="False"></asp:TextBox>
                                </td>
                                <td style="text-align: right;" class="auto-style5">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;" class="auto-style6">
                                    <asp:TextBox ID="txtArrearFee" runat="server" Width="130px" Height="20px" OnTextChanged="txtArrearFee_TextChanged"
                                        onkeydown="javascript:TextName_OnKeyDown(event)" Font-Bold="True" 
                                        Enabled="False"></asp:TextBox>
                                </td>
                                <td style="text-align: right;" class="auto-style5">&nbsp;
                                    <%--<asp:Label ID="Label48" runat="server" Text="Early Dpt Hour:"></asp:Label>--%>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                   ...
                                   <asp:Button ID="btnNext" runat="server" Height="31px" Text="Next" Width="50px" OnClick="btnNext_Click"
                                        CssClass="styled-button-4" />
                                    <asp:Button ID="btnEmpInfoManualSalary" runat="server" Height="31px" Text="Manual Sheet" Width="90px"
                                        CssClass="styled-button-4" OnClick="btnEmpInfoManualSalary_Click" />
                                    <asp:Button ID="btnGetEmpWhoWdayLessThan10" runat="server" Height="31px" Text="Sheet(W.DAY<M.Day)" Width="141px"
                                        CssClass="styled-button-4" OnClick="btnGetEmpWhoWdayLessThan10_Click" />
                                </td>
                            </tr>
                            <tr>
                ...
                <td colspan="2">
                    <fieldset>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GvSalaryMaster" runat="server" DataSourceID="" AutoGenerateColumns="False" DataKeyNames="EMPLOYEE_ID" 
                                        OnRowDataBound="GvSalaryMaster_OnRowDataBound" AllowSorting="True" EnableViewState="true"
                                        GridLines="None" AllowPaging="false" OnRowEditing="GvSalaryMaster_OnRowEditing" CssClass="mGrid"
                                        PagerStyle-CssClass="pgr" OnSelectedIndexChanged="GvSalaryMaster_OnSelectedIndexChanged"
                                        CausesValidation="false" OnRowCommand="GvSalaryMaster_RowCommand" AlternatingRowStyle-CssClass="alt"
                                        OnPageIndexChanging="GvSalaryMaster_OnSelectedIndexChanged" OnRowDeleting="GvSalaryMaster_RowDeleting">
                                        <Columns>
