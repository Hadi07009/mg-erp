...
{
    public partial class WorkerTransfer : System.Web.UI.Page
    {
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "salary_sheet_worker");
        ...
        public void searchWorkerPromotionEntry()
        {
            ...
            dt = objEmployeeBLL.searchWorkerPromotionEntry(objEmployeeDTO);
        ...
        public void saveWorkerTransfer()
        {
            ...
            foreach (GridViewRow row in gvEmployeeList.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                        ...
                        string strMsg = objSalaryBLL.saveWorkerTransfer(objSalaryDTO);
                        MessageBox(strMsg);
                        lblMsg.Text = strMsg;
        ...
        public void searchEmployeeRecordforTransfer()
        {
            ...
            dt = objEmployeeBLL.searchEmployeeRecordforTransfer(objEmployeeDTO);
        ...
        public void workerTransferSheet()
        {
