...
{
    public partial class IdCardProcess : System.Web.UI.Page
    {
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "salary_sheet_worker");
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                        ...
                        string strMsg = objEmployeeBLL.SaveIdCard(objEmployeeDTO);
                        //MessageBox(strMsg);
                        lblMsg.Text = strMsg;
                    }
        ...
        public void idCardSheet()
        {
            ...
            try
            {
                ...
                {
                    strPath = Path.Combine(Server.MapPath("~/Reports/rptIdentityCard.rpt"));
                }
