...
{
    public partial class AddBuyerType : System.Web.UI.Page
    {
        ...
        public void loadSesscion()
        {
            ...
            strDepartmentId = Session["strDepartmentId"].ToString().Trim();
        ...
        public void loadBuyerRecord()
        {
            ...
            dt = objLookUpBLL.loadBuyerRecord();
        ...
        public void clear()
        {
            ...
            txtBuyerType.Text = string.Empty;
        }
        ...
        public void saveBuyerInfo()
        {
            ...
            objLookUpDTO.BuyerType = txtBuyerType.Text;


            objLookUpDTO.HeadOfficeId = "101";
            objLookUpDTO.BranchOfficeId = "101";
            objLookUpDTO.UpdateBy = "1";
        ...
        {
            if (txtBuyerType.Text == string.Empty)
            {
                string strMsg = "Please Enter Buyer Type!!!";
                MessageBox(strMsg);
                txtBuyerType.Focus();
                return;
