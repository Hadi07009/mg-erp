<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="IncrementAnnualEntryStaffNonProposal.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.IncrementAnnualEntryStaffNonProposal" %>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnWorkerSummerySheet" runat="server" Height="31px" 
                                        Text="Summary" Width="70px"
                                        CssClass="styled-button-4" OnClick="btnStaffNonProposalSummerySheet_Click"  />
                                </td>
                            </tr>
                            <tr>
