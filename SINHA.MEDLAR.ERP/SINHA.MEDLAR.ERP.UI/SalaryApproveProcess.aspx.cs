...
{
    public partial class SalaryApproveProcess : System.Web.UI.Page
    {
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "attendence_report");
        ...
        public void LoadEmployeeSalaryApprove()
        {
            ...
            objEmployeeDTO.HeadOfficeId = strHeadOfficeId;
            objEmployeeDTO.BranchOfficeId = strBranchOfficeId;
            objEmployeeDTO.EmployeeId = txtEmpId.Text.Trim();
            objEmployeeDTO.CardNo = txtEmpCardNo.Text.Trim();
            objEmployeeDTO.Year = txtSalaryYear.Text.Trim();
            objEmployeeDTO.Month = txtsalaryMonth.Text.Trim();
           // objEmployeeDTO.LogDate = dtpAttendenceDate.Text;
            ...
            dt = objEmployeeBLL.LoadEmployeeSalaryApprove(objEmployeeDTO);
        ...
        public void searchSalaryApprovedEmployeeEntry()
        {
           ...
           // objEmployeeDTO.AprovedDate = dtpAttendenceDate.Text;
            ...
            dt = objEmployeeBLL.searchSalaryApprovedEmployeeEntry(objEmployeeDTO);
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                        ...
                        string occurenceTypeId = (row.FindControl("lblOCCURENCE_TYPE_ID") as Label).Text;


                        objEmployeeDTO.OccurenceTypeId = occurenceTypeId;
                        ...
                        strMsg = objEmployeeBLL.addSalaryAppovedProcessForEmp(objEmployeeDTO);
        ...
        protected void gvSalaryAprovedEmpList_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            //commented by7 asad on 01.04.2019
            //addSalaryAppovedProcessForEmp();
            searchSalaryApprovedEmployeeEntry();
        ...
        public void deleteSalaryAprovedEmpRecord(string strEmpId)
        {
            ...
            string strMsg = objEmployeeBLL.deleteSalaryAprovedEmpRecord(objEmployeeDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteSalaryCheckEmpRecord(string strEmpId)
        {
            EmployeeDTO objEmployeeDTO = new EmployeeDTO();
            EmployeeBLL objEmployeeBLL = new EmployeeBLL();
            ...
            string strMsg = objEmployeeBLL.deleteSalaryCheckEmpRecord(objEmployeeDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            deleteSalaryCheckEmpRecord(strEmpId);
            LoadEmployeeSalaryApprove();
