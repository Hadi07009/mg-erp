<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" ValidateRequest = "false" 
    EnableEventValidation="false" CodeBehind="ADDProductPrice.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.ADDProductPrice" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" language="javascript">
        $(window).load(function () { document.getElementById("<%= txtProductName.ClientID %>").focus(); }) 
    </script>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right">
                    <asp:Label ID="lblProductTranId" runat="server" Text="ID :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtProductTranId" runat="server" Width="72px" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtProductName" runat="server" Width="236px" 
            ...
            <tr>
                <td style="text-align: right">
                    <asp:Label ID="lblBranchOfficeId0" runat="server" Text="Device Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDeviceName" runat="server" Width="236px" 
                        BackColor="White" ></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td style="text-align: right">
                    <asp:Label ID="lblDevicePrice" runat="server" 
                        Text="Price :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDevicePrice" runat="server" Width="236px" 
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvProductPrice" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                        AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvProductPrice_PageIndexChanging"
                        OnRowDataBound="OnRowDataBound" 
                        OnSelectedIndexChanged="OnSelectedIndexChanged" Width="688px">
                        <Columns>
