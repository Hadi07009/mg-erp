<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="HearingInfo.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.HearingInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function TextName_OnKeyDown(e) {
            ...
            if (keynum == 13) {
                document.getElementById('<%= BtnSaveHearingInfo.ClientID %>').click();
            }
        }
    </script>
    <script type="text/javascript" language="javascript">
    ...
    <script type="text/javascript">  {
      ...
      $(document).ready(function () {
          ...
          autoComplete("#ContentPlaceHolder2_txtCaseNo", "#ContentPlaceHolder2_txtCaseId", 'HearingInfo.aspx/GetCaseNoByCaseID?prefix=' + $("#ContentPlaceHolder2_txtCaseNo").val());
          $('#ContentPlaceHolder2_txtCaseNo').keyup(function () {
              autoComplete("#ContentPlaceHolder2_txtCaseNo", "#ContentPlaceHolder2_txtCaseId", 'HearingInfo.aspx/GetCaseNoByCaseID?prefix=' + $("#ContentPlaceHolder2_txtCaseNo").val());
          });
      ...
      //function GetCaseNoByCaseID() {
      //    var CASE_ID;
      //    var CASR_NO;
      //        $("#ddlCaseId").empty();
      //        $("#ddlCaseId").append($("<option></option>").val("").html("Select Case No"));

      //        $.ajax({
      //            type: "POST",
      //            url: "HearingInfo.aspx/GetCaseNoByCaseID",
      //            data: JSON.stringify({ }),
      //            dataType: "json",
      ...
      //                    $("#ddlCaseId").append($("<option></option>").val(value.CASE_ID).html(value.CASE_NO));
    ...
    <script type="text/javascript" language="javascript">
         ...
         function autoComplete(selector, keySelector, url) {
             ...
             $(selector).autocomplete({
                 ...
                 select: function (e, i) {
                     $(keySelector).val(i.item.val);//selector
                 },
                 minLength: 1
             });
         }     
                                    ...
                                    <table class="style1">
                                        ...
                                        <tr>
                                            <td style="width: 254px; text-align: right">
                                                <asp:Label ID="Label42" runat="server" Text="Hearing Date :"></asp:Label>
                                            </td>
                                            <td style="width: 95px">
                                        ...
                                        <tr>
                                            <td style="width: 254px; text-align: right">
                                                <asp:Label ID="Label39" runat="server" Text="Case Status :"></asp:Label>
                                            </td>
                                            <td style="width: 95px">
                                                <asp:DropDownList ID="ddlCaseStatussId" runat="server" Width="240px" Height="22px">
                                                </asp:DropDownList>
                                            </td>
                                            <td style="width: 66px">
                                                <asp:TextBox ID="txtHearingId" runat="server" Width="28px" BackColor="White" Visible="false"></asp:TextBox>
                                            </td>
                                            <td style="text-align: right; width: 100px">
                                                <asp:Label ID="Label41" runat="server" Text="Remarks :"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtRemarks" runat="server" Width="236px" BackColor="White" TextMode="MultiLine" Height="25px"></asp:TextBox>
                                            </td>
                                        </tr>
                                       <%-- <tr>
                                            <td style="width: 254px; text-align: right; height: 22px;">
                                        ...
                                        <tr>
                                            ...
                                            <asp:Button ID="BtnSaveHearingInfo" runat="server" Height="31px" Text="Save" Width="80px" B
                                                    OnClick="BtnSaveHearingInfo_Click" CssClass="styled-button-4" />
                                            <asp:Button ID="btnClear" runat="server" Height="31px" Text="Clear" Width="66px"
                                                    OnClick="btnClear_Click" CssClass="styled-button-4" />
                                            <asp:Button ID="btnReminder" runat="server" Height="31px" Text="Reminder" BackColor="Red"  CssClass="styled-button-4"
                                                    OnClick="btnReminder_Click" />
                                            </td>
                                        </tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <asp:TextBox ID="dtpFromHearingDateSearch" runat="server" Width="236px" BackColor="White" CssClass="date"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                <asp:TextBox ID="dtpToHearingDateSearch" runat="server" Width="236px" BackColor="White" CssClass="date"></asp:TextBox>
                                                </td>
                                            </tr>
                ...
                <td colspan="2">
                    <fieldset>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GridViewHearingInfo" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        OnRowDataBound="GridViewHearingInfo_OnRowDataBound" AllowSorting="True" EnableViewState="true"
                                        GridLines="None" AllowPaging="false" OnRowEditing="GridViewHearingInfo_OnRowEditing" CssClass="mGrid"
                                        PagerStyle-CssClass="pgr" OnSelectedIndexChanged="GridViewHearingInfo_OnSelectedIndexChanged"
                                        CausesValidation="false" OnRowCommand="GridViewHearingInfo_RowCommand" AlternatingRowStyle-CssClass="alt"
                                        OnPageIndexChanging="GridViewHearingInfo_PageIndexChanging" OnRowDeleting="GridViewHearingInfo_RowDeleting">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DEFENDANT_NAME" HeaderText="Defendant" ItemStyle-Width="200" /> 
                                             ...
                                             <asp:BoundField DataField="ISSUE_DATE" HeaderText="Hearing Date" ItemStyle-Width="100" />
                                            ...
                                            <asp:BoundField DataField="hearing_id" HeaderText="Hearing Id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn" /> 
