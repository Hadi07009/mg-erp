<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="YearlyWorkerPromotion.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.YearlyWorkerPromotion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>YEARLY PROMOTION (STAFF/WORKER)</legend>
        <table class="style1">
                <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        <legend>YEARLY PROMOTION PROCESS</legend>
                        <table class="style1">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 176px; text-align: right">
                    <asp:Label ID="Label41" runat="server" Text="Designation/Grade :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                    <asp:DropDownList ID="ddlDesignationId" runat="server" Width="148px" Height="22px">
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlGradeNo" runat="server" Width="88px" Height="22px" 
                                        >
                    </asp:DropDownList>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="width: 176px; text-align: right">
                                    <asp:Label ID="Label45" runat="server" Text="Effect Date/Year :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="dtpEffectDate" runat="server" Width="122px" Height="20px" CssClass="date"
                                        Font-Bold="True"></asp:TextBox>
                                    <asp:TextBox ID="txtPromotionYear" runat="server" Width="110px" Height="20px" Font-Bold="True"
            ...
            <tr>
                <td colspan="2">
                    <fieldset>
                        <legend>WORKER PROMOTION RESULT </legend>
                        <%-- </div>--%>
