<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ERP.Master" CodeBehind="ShiftConfiguration.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.ShiftConfiguration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>Shift Configurations</legend>
        <table style="width: 100%">
           ...
           <%-- <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlShiftId" runat="server" Width="168px" Height="22px">
                    </asp:DropDownList>
                </td>

               
                <td style="text-align: right; width: 200px">
                    <asp:Label ID="lblPunchTime" runat="server" Text="Punch Start/End :" Font-Bold="False"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPunchStartTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White"></asp:TextBox>
                    <asp:TextBox ID="txtPunchEndTime" runat="server" Width="80px" Height="20px" Font-Bold="True"
            ...
            <tr>
                <td style="text-align: right; width: 200px; height: 19px">
                    <strong>
                        <asp:Label ID="lblLoginTime" runat="server" Text="Login Start/End :" Font-Bold="False"></asp:Label>
                    </strong>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtLoginStartTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White"></asp:TextBox>
                    <asp:TextBox ID="txtLoginEndTime" runat="server" Width="80px" Height="20px" Font-Bold="True"
                        BackColor="White"></asp:TextBox>
                    <span>hh:mm</span>
                </td>
                ...
                <td style="text-align: right; width: 200px; height: 19px">
                    <strong>
                        <asp:Label ID="lblLoginGraceTime" runat="server" Text="Login Grace Time :" Font-Bold="False"></asp:Label>
                    </strong>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtLoginGraceTime" runat="server" Width="163px" Height="20px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White"></asp:TextBox>
                    <span>mm</span>
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 200px; height: 19px">
                    <asp:Label ID="lblLunchOut" runat="server" Text="Lunch-Out Start/End :"></asp:Label>
                </td>
                <td style="height: 19px">
                ...
                <td style="text-align: right; width: 200px; height: 19px">
                    <asp:Label ID="lblLunchIn" runat="server" Text="Lunch-In Start/End :"></asp:Label>
                </td>
                <td style="height: 19px">
            ...
            <tr>
                ...
                <td style="text-align: right; width: 200px; height: 19px">
                    <asp:Label ID="lbLogoutTime" runat="server" Text="Logout Strat Time/Log Out :" Font-Bold="False"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtLogoutStartTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White"></asp:TextBox>
                    <asp:TextBox ID="txtLogoutTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White"></asp:TextBox>
                    <span>hh:mm</span>
                </td>
            </tr>
            ...
            <tr>
                <td style="text-align: right; width: 200px; height: 19px">
                    <asp:Label ID="lblEarlyOt" runat="server" Text="Early Ot/ Early Strat Time :" Font-Bold="False"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtEearlyOtStartTime" runat="server" Width="77px" Height="19px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White"></asp:TextBox>
                    <span>hh:mm</span>
                </td>
           ...
           <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlShiftId" runat="server" Width="165px" Height="22px">
                    </asp:DropDownList>
                </td>
                ...
                <td>
                    <asp:TextBox ID="dtpEffectDate" runat="server" Width="161px" Height="20px" Font-Bold="True"
                        BackColor="White" CssClass="date" placeholder="dd/mm/yyyy"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLoginGraceTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        Style="margin-left: 0px" BackColor="White" placeholder="mm"></asp:TextBox>
                    <asp:TextBox ID="txtLoginEndTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
            ...
            <tr>
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="txtLunchOutTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <asp:TextBox ID="txtLunchInTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <%--<span>hh:mm</span>--%>
                </td>
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="txtLunchOutStartTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <asp:TextBox ID="txtLunchOutEndTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <%--<span>hh:mm</span>--%>
                </td>
            ...
            <tr>
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="txtLunchInStartTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <asp:TextBox ID="txtLunchInEndTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <%--<span>hh:mm</span>--%>
                </td>
                <td style="text-align: right; width: 200px; height: 19px">
            ...
            <tr>
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="txtPunchEndTime" runat="server" Width="77px" Height="20px" Font-Bold="True"
                        BackColor="White" placeholder="hh:mm"></asp:TextBox>
                    <%--<span>hh:mm</span>--%>
                </td>
                <td style="text-align: right; width: 200px; height: 19px">
