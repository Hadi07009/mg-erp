...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class PasswordChange : System.Web.UI.Page
    {
        ...
        public void getLoginEmpId()
        {
            ...
            ddlEmpId.DataSource = objLookUpBLL.getLoginEmpId(strHeadOfficeId, strBranchOfficeId);
        ...
        public void submitPassword()
        {
            ...
            else
            {
                ...
                {
                    objLoginDTO.EmployeeId = ddlEmpId.SelectedValue.ToString();
                }
                else
                {
                    objLoginDTO.EmployeeId = "";
        ...
        protected void ddlEmpId_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlEmpId.Text != " " )
            {
                ...
                searchLoginEmployeeName(ddlEmpId.SelectedValue.ToString(), strHeadOfficeId, strBranchOfficeId);
