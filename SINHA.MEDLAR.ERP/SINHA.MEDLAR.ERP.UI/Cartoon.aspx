<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="Cartoon.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.Cartoon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(window).load(function () { document.getElementById("<%= txtCartoonId.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCartoonId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                <td style="text-align: right; width: 279px">
                    <asp:Label ID="lblGenderName" runat="server" Text="Cartoon  Size :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCartoonSize" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvCartoon" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvCartoon_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvCartoon_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="CARTOON_ID" HeaderText="ID" />
                    <asp:BoundField DataField="CARTOON_SIZE" HeaderText="CARTOON SIZE" />
