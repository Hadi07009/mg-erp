<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddHoliday.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddHoliday" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 341px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Holiday Date :"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td style="text-align: right; width: 341px; height: 19px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="End Holiday Date :"></asp:Label>
                </td>
