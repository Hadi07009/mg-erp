...
{
    public partial class AddBottomProcess : System.Web.UI.Page
    {
        ...
        public void loadBottomRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadBottomRecord();
        ...
        public void saveBottomInfo()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO.BottomId = txtBottomId.Text;
            objLookUpDTO.BottomName = txtBottomName.Text;
            ...
            string strMsg = objLookUpBLL.saveBottomInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteBottomInfo()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO.TopId = txtBottomId.Text;
            ...
            string strMsg = objLookUpBLL.deleteBottomInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        {
            if (txtBottomName.Text == string.Empty)
            {
                string strMsg = "Please Enter Bottom Name!!!";
                txtBottomName.Focus();
                MessageBox(strMsg);
                return;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            if (txtBottomName.Text == string.Empty)
            {
                string strMsg = "Please Enter Bottom ID!!!";
                txtBottomName.Focus();
                MessageBox(strMsg);
                return;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtBottomId.Text = strCourseId;
            txtBottomName.Text = strcourseName;
