...
{
    public partial class AddMachineNameMainta : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtMachineName.Attributes.Add("onkeypress", "return controlEnter('" + btnSave.ClientID + "', event)");
        }
        ...
        public void saveMachineInfo()
        {

            MaintenanceDTO objMaintenanceDTO = new MaintenanceDTO();
            MaintenanceBLL objMaintenanceBLL = new MaintenanceBLL();

            objMaintenanceDTO.MachinelId = txtMachineNameId.Text;
            objMaintenanceDTO.MachineName = txtMachineName.Text;


            objMaintenanceDTO.UpdateBy = strUnitId;
            objMaintenanceDTO.HeadOfficeId = strHeadOfficeId;
            objMaintenanceDTO.BranchOfficeId = strBranchOfficeId;

            string strMsg = objMaintenanceBLL.saveMachineInfo(objMaintenanceDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strMachineId = gvUnit.SelectedRow.Cells[0].Text.Replace("&nbsp;", "");
            string strMachineName = gvUnit.SelectedRow.Cells[1].Text.Replace("&nbsp;", "");

            txtMachineNameId.Text = strMachineId;
