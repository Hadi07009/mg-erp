<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="InactiveEmployee.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.InactiveEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>INACTIVE EMPLOYEE</legend>
        <table class="style1">
            <tr>
                        ...
                        <table class="style1">
                            <tr>
                                <td style="text-align: right">
                                    <table class="style1">
                                        <tr>
                                            <td style="width: 242px; text-align: right; height: 22px;">
                                        ...
                                        <tr>
                                            <td style="text-align: center" colspan="5">
                                                ...
                                                <asp:Button ID="btnActiveEmployee" runat="server" Height="31px" Text="Inactive" Width="66px"
