...
{
    public partial class AddUnitStore : System.Web.UI.Page
    {
        ...
        public void searchUnitStoreRecord()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchUnitStoreRecord(txtUnitId.Text, strHeadOfficeId, strBranchOfficeId);

            txtUnitName.Text = objLookUpDTO.UnitName;
        ...
        public void loadUnitStoreName()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadUnitStoreName(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveUnitStoreName()
        {
            ...
            objLookUpDTO.UnitName = txtUnitName.Text;
            ...
            string strMsg = objLookUpBLL.saveUnitStoreName(objLookUpDTO);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtUnitName.Text = strUnitName;


            //string strMsg = "Row Index: " + strRowId + "\\nSubject ID: " + txtUnitId + "\\nSubject Name : " + txtUnitName;
