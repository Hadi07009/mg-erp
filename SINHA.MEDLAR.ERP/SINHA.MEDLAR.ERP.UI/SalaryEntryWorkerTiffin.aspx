<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryEntryWorkerTiffin.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryEntryWorkerTiffin" %>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    <asp:Button ID="btnAtten" runat="server" Height="31px" Text="ATTEN." CssClass="styled-button-4"
                                        Width="50px" OnClick="btnAtten_Click" Visible ="False" />
                                    ...
                                    <asp:Button ID="btnSalarySheet" runat="server" Height="31px" Text="bKash Sheet" Width="100px"
                                        ...
                                        Visible="False" />
                                    <asp:Button ID="btnCashSalarySheetWorker" runat="server" Height="31px" 
                                        Text="Cash Sheet" Width="87px"
                                        CssClass="styled-button-4" OnClick="btnCashSalarySheetWorker_Click" 
                                        Visible="False" />
                                    <asp:Button ID="btnBankSalarySheet" runat="server" Height="31px" 
                                        Text="Bank Sheet" Width="80px"
                                    ...
                                    <asp:Button ID="btnBKashSheetWorker" runat="server" Height="31px" 
                                        Text="BKash Template" Width="120px"
                                        CssClass="styled-button-4" OnClick="btnBKashSheetWorker_Click" 
                                        Visible="False" />
                                     <asp:Button ID="btnWalletSheet" runat="server" Height="31px" 
                                        Text="BKash Template(All)" Width="130px"
                                        CssClass="styled-button-4" OnClick="btnWalletSheet_Click" 
                                        Visible="False" />
                                    
                                    <asp:Button ID="btnRequisitionWorker" runat="server" Height="31px" 
                                        Text="Requisition(W)" Width="91px"
                                        CssClass="styled-button-4" OnClick="btnRequisitionWorker_Click" 
                                        Visible="False" />
                                    <asp:Button ID="btnWorkerBkashRequisition" runat="server" Height="31px" 
                                        Text="BKash Req(W)" Width="90px"
                                    ...
                                    <asp:Button ID="btnRequisition" runat="server" Height="31px" Text="Requisition" Width="80px"
                                        ...
                                        Visible="False" />
                                    <asp:Button ID="btnRequisitionBkash" runat="server" Height="31px" 
                                        Text="BKash Req" Width="80px"
                                        CssClass="styled-button-4" OnClick="btnRequisitionBKash_Click" 
                                        Visible="False" />
                                                                        
                                    <asp:Button ID="btnRequisitionCash" runat="server" Height="31px" 
                                    ...
                                    <asp:Button ID="btnMonthlyRequisitionSummery" runat="server" Height="31px"
                                        ...
                                        Visible="False" />
                                    <asp:Button ID="btnRequisitionSummaryBkash" runat="server" Height="31px" 
                                        Text="BKash Summary" Width="100px"
                                        CssClass="styled-button-4" OnClick="btnRequisitionSummaryBKash_Click" 
                                        Visible="False" />
                                    <asp:Button ID="btnRequisitionSummaryCash" runat="server" Height="31px" 
                                        Text="Cash Summary" Width="97px"
                                    ...
                                    <asp:Button ID="btnMonthlyOTSheet" runat="server" Height="31px" Text="OT" CssClass="styled-button-4"
                                        Width="40px" OnClick="btnMonthlyOTSheet_Click" Visible="False" />
                                    ...
                                    <asp:Button ID="btnOTBKashTemplate" runat="server" Height="31px" 
                                        Text="OT Template" Width="90px"
                                    ...
                                    <asp:Button ID="btnDformReq" runat="server" Height="31px" Text="D Req Form" Width="80px"
                                        CssClass="styled-button-4" OnClick="btnDformReq_Click" Visible="False" />
                                    <asp:Button ID="btnNonDformReq" runat="server" Height="31px" 
                                        Text="Non DReq Form" Width="108px"
                                        CssClass="styled-button-4" OnClick="btnNonDformReq_Click" 
                                        Visible="False" />
                                     <asp:Button ID="btnDformWallet" runat="server" Height="31px" 
                                        Text="Template(DF)" Width="100px"
                                        CssClass="styled-button-4" OnClick="btnDformWallet_Click" 
                                        Visible="False" />
                                     <asp:Button ID="btnNonDformWallet" runat="server" Height="31px" 
                                        Text="Template(NDF)" Width="100px"
                                    ...
                                    <asp:Button ID="BtnMasterSheetAll" runat="server" Height="31px" 
                                        Text="Sheet (All)" Width="80px"
                                    ...
                                    <asp:Button ID="btnSalaryMisc" runat="server" Height="31px" Text="Misc" CssClass="styled-button-4"
                                        Width="40px" OnClick="btnSalaryMisc_Click" Visible="False" />
                                    
                                    <asp:Button ID="btnEmployeeGrossSalarySheet" runat="server" Height="31px"
                                     Text="Gross Salary" CssClass="styled-button-4" 
                                     OnClick="btnEmployeeGrossSalarySheet_Click" Visible="False"/>
                                     <asp:Button ID="btnGetEmpWhoWdayLessThanXDays" runat="server" Height="31px" 
                                        Text="Sheet(W.DAY<M.Day)" Width="141px"
