<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GazetteProcessSingle.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.GazetteProcessSingle" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="GazetteProcessSingle.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.GazetteProcessSingle" %>
                            ...
                            <tr>
                                <td style="text-align: right" colspan="4">
                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 66px">
                                                    <asp:TextBox ID="txtEmpId" runat="server" Width="200px" ReadOnly="True"
                                        BackColor="Yellow"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 66px">
                                                    <asp:TextBox ID="txtCardNo" runat="server" Width="200px" ReadOnly="True"
                                        BackColor="Yellow"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 163px">
                                                    <asp:TextBox ID="txtGazetteYear" runat="server" Width="235px" BackColor="White" Text="2018" ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td style="width: 66px">&nbsp;
                                                </td>
                                                <td style="text-align: right" class="auto-style3">
                                                ...
                                                <td style="width: 163px">
                                                    <asp:TextBox ID="txtEmployeeName" runat="server" Width="200px" ReadOnly="True"
                                        BackColor="Yellow"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlGazetteMonth" runat="server" Width="240px" Height="22px" Enabled="false">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="width: 66px">&nbsp;
                                                </td>
                                                ...
                                                <td style="width: 163px">
                                                    <asp:TextBox ID="txtDesignationName" runat="server" Width="200px" ReadOnly="True"
                                        BackColor="Yellow"></asp:TextBox>
                                                </td>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                   <asp:CheckBox ID="chkIncrementYn" runat="server" Text="Yes" Checked="true" Enabled="false"/>
                                                </td>
                                                  <td style="width: 66px">&nbsp;
                                                </td>
                                ...
                                <td style="text-align: center" colspan="4">
                                   ...
                                   <asp:Button ID="btnGazetAdjustment" runat="server" Height="31px" 
                                         Text="Adjust Gazette" Width="100px" CssClass="styled-button-4" 
