<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ...
    CodeBehind="OfficeShiftTime.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.OfficeShiftTime" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>OFFICE SHIFT TIME</legend>
        <table class="style1">
            <%--  <tr>
                ...
                <td style="text-align: left; height: 26px;" align="right" colspan="3">
                    ...
                    <asp:DropDownList ID="ddlShiftId" runat="server" Width="163px" Height="22px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEmployeeId" runat="server" Width="103px" Height="20px" BackColor="Yellow"
                                    ReadOnly="True" Font-Bold="True" ForeColor="Red"></asp:TextBox>
                                </td>
                        </tr>
                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="SHIFT_TYPE_NAME" HeaderText="SHIFT" />
