...
{
    public partial class IncrementAnnualEntryStaffNonProposal : System.Web.UI.Page
    {
        ...
        public void SearchAnnualIncrementNonProposalStaff()
        {
            ...
            dt = objEmployeeBLL.SearchAnnualIncrementNonProposalStaff(objEmployeeDTO);
        ...
        public void searchIncrementEntryStaffNonProposal()
        {
            ...
            dt = objEmployeeBLL.searchIncrementEntryStaffNonProposal(objEmployeeDTO);
        ...
        public void searchStaffIncrementEntryNonProposal()
        {
            ...
            objSalaryDTO = objSalaryBLL.searchStaffIncrementEntryNonProposal(txtEmployeeId.Text, txtIncrementYear.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveIncrementStaffNonProposal()
        {
            ...
            string strMsg = objSalaryBLL.saveIncrementStaffNonProposal(objSalaryDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "increment_sheet_worker_monthly");
        ...
        public void processIncrementAmountStaffNonProposal()
        {
            ...
            objReportDTO.BranchOfficeId = strBranchOfficeId;
            objReportDTO.UpdateBy = strEmployeeId;
            string strMsg = objReportBLL.processIncrementAmountStaffNonProposal(objReportDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;


        }
        public void processStaffNonProposal()
        {
            ...
            objReportDTO.BranchOfficeId = strBranchOfficeId;
            objReportDTO.UpdateBy = strEmployeeId;
            string strMsg = objReportBLL.processStaffNonProposal(objReportDTO);
            //MessageBox(strMsg);
            //lblMsg.Text = strMsg;
        ...
        public void rptIncrementAnnualSheetStaffNonProposal()
        {
            ...
            try
            {
                ...
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.rptIncrementAnnualSheetStaffNonProposal(objReportDTO));
        ...
        public void addStaffYearlyIncrementNonProposal()
        {
            ...
            foreach (GridViewRow row in gvEmployeeList.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                        ...
                        strMsg = objSalaryBLL.addStaffYearlyIncrementNonProposal(objSalaryDTO);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    clearTextBox();
                    gvEmployeeList.SelectedIndex = 0;
                    searchIncrementEntryStaffNonProposal();
                    goToNextRecord();
                    searchStaffIncrementEntryNonProposal();
                }
        ...
        protected void btnIncrementSheet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptIncrementAnnualSheetStaffNonProposal();
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                  processIncrementAmountStaffNonProposal();
                   searchIncrementEntryStaffNonProposal();
                   searchStaffIncrementEntryNonProposal();                
            }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    addStaffYearlyIncrementNonProposal();
                    processStaffNonProposal();
                    searchIncrementEntryStaffNonProposal();
                }
            }
        ...
        protected void btnStaffNonProposalSummerySheet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptIncrementNonProposalStaffSummeryBangla.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.incrementProposalSheetStaffSummeryNonProposal(objReportDTO));
