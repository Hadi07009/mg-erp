<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="DailyCutting.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.DailyCutting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>BUYER MEASUREMENT INFORMATION</legend>
        <table class="style1">
            <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        <legend>MEASUREMENT ENTRY</legend>
                        <table class="style1">
                            <tr>
                            ...
                            <tr>
                                <td style="width: 385px; text-align: right">
                                    <asp:Label ID="Label27" runat="server" Text="Order Quantity :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtTotalOrderQuantity" runat="server" Width="158px" Height="20px"
                                        Font-Bold="True" ForeColor="Red" 
                                        BackColor="Yellow" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td style="width: 247px; text-align: right;">
                                    <asp:Label ID="Label32" runat="server" Text="Buyer  :"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 385px; text-align: right">
                                    <asp:Label ID="Label43" runat="server" Text="Size :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtSize" runat="server" Width="158px" Height="20px" Font-Bold="True"
                            ...
                            <tr>
                                <td style="width: 385px; text-align: right">
                                    <asp:Label ID="Label44" runat="server" Text="Quantity :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtQuantity" runat="server" Width="158px" Height="20px"
                                        onkeydown="javascript:TextName_OnKeyDown(event)" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="width: 247px; text-align: right;">
                                    <asp:Label ID="Label46" runat="server" Text="Line :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtLineName" runat="server" Width="200px" Height="20px" BackColor="Yellow"
                                        ReadOnly="True" Font-Bold="True" ForeColor="Red"></asp:TextBox>
                                        ...
                                        <table class="style1">
                                            <tr>
                                                <td style="width: 118px; text-align: right; height: 22px;">
                                                    <asp:Label ID="Label34" runat="server" Text="Buyer :"></asp:Label>
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td style="height: 22px; text-align: right; width: 69px;">
                                                    <asp:Label ID="Label39" runat="server" Text="PO No :"></asp:Label>
                                                </td>
                                                <td style="height: 22px">
                                                    <asp:TextBox ID="txtPoSearchNo" runat="server" Width="149px" BackColor="White" 
                                                        CssClass="date"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 118px; text-align: right">
                                                    <asp:Label ID="Label35" runat="server" Text="Style :"></asp:Label>
                                                    &nbsp;
                                                </td>
