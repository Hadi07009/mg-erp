<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddMachineModelMainta.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineModelMainta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMachineModel.ClientID %>").focus(); }) 
    </script>
    <table class="style1">
        <tr>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD MACHINE MODEL</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMachineModelId" runat="server" Width="50px" 
                        BackColor="Yellow" Height="20px"
                       ></asp:TextBox>
                </td>
                <td>
                    &nbsp;
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtMachineModel" runat="server" Width="200px" Height="20px"  onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;</td>
            </tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
         ...
         <div id="div1" style="width: 680px; height: 300px; overflow: scroll">
            <table style="width: 100%">
                <tr>
                    <td colspan="2">
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="MACHINE_MODEL_NAME_ID" HeaderText="ID" />
                    <asp:BoundField DataField="MACHINE_NAME" HeaderText="MACHINE NAME" />
                   <asp:BoundField DataField="MACHINE_MODEL_NAME" HeaderText="MODEL NAME" />
