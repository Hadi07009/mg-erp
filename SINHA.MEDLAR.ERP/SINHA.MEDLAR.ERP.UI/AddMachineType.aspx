<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="AddMachineType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMachineTypeName.ClientID %>").focus(); }) 
    </script>
                    ...
                    <fieldset>
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMachineTypeName" runat="server" Width="236px" BackColor="White"
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="MACHINE_TYPE_ID" HeaderText="ID" />
                            <asp:BoundField DataField="MACHINE_TYPE_NAME" HeaderText="MACHINE TYPE" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
