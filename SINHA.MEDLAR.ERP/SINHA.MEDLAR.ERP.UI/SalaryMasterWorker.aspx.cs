...
{
    public partial class SalaryMasterWorker : System.Web.UI.Page
    {
        ...
        //    objEventPermissionDTO.MenuCode = "0005";
       ...
       public void getMonthYearForTax()
        ...
        public void searchSalaryInfoWorker()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                GvSalaryMaster.DataSource = dt;
                GvSalaryMaster.DataBind();

                int count = ((DataTable)GvSalaryMaster.DataSource).Rows.Count;
            ...
            else
            {
                ...
                GvSalaryMaster.DataSource = dt;
                GvSalaryMaster.DataBind();
                int totalcolums = GvSalaryMaster.Rows[0].Cells.Count;
                GvSalaryMaster.Rows[0].Cells.Clear();
                GvSalaryMaster.Rows[0].Cells.Add(new TableCell());
                GvSalaryMaster.Rows[0].Cells[0].ColumnSpan = totalcolums;
                GvSalaryMaster.Rows[0].Cells[0].Text = "NO RECORD FOUND";

                //GvSalaryMaster.DataSource = null;
                //GvSalaryMaster.DataBind();
        ...
        public void goToNextRecordTop()
        {
            ...
            int l;
            l = GvSalaryMaster.SelectedRow.RowIndex;
            if (l != 0)
            {

                int strId = GvSalaryMaster.SelectedRow.RowIndex + 1;
                int strRowCount = strId;
                int intCount = GvSalaryMaster.Rows.Count;
                ...
                {
                    GvSalaryMaster.SelectedIndex += 1;
                    result = GvSalaryMaster.SelectedRow.RowIndex + k;
                }
            ...
            {
                int intCount = GvSalaryMaster.Rows.Count;
                int intCountRow = GvSalaryMaster.Rows.Count;
                if (intCountRow == 1)
                {
                    intCountRow = 2;
                }
                ...
                else
                {
                    ...
                    {
                        GvSalaryMaster.SelectedIndex = 0;
                        result = GvSalaryMaster.SelectedRow.RowIndex + k;
                        txtSLNew.Text = "1";
                    }
                    else
                    {
                        ...
                        int intC = GvSalaryMaster.Rows.Count;
                        int intCo = GvSalaryMaster.Rows.Count;
                        int ll = 0;
                        int pp = intCo - 1;
                        if (ll == pp)
                        {
            ...
            int strRowId = GvSalaryMaster.SelectedRow.RowIndex + 1;
            string strSLNo = GvSalaryMaster.SelectedRow.Cells[0].Text;
            ...
            else
            {
                ...
                string strCardNo = GvSalaryMaster.SelectedRow.Cells[1].Text;

                string strEmployeeName = GvSalaryMaster.SelectedRow.Cells[2].Text;
                string strDesignation = GvSalaryMaster.SelectedRow.Cells[3].Text;
                //new
                string strEmployeeId = GvSalaryMaster.SelectedRow.Cells[15].Text;
                //old
                //string strEmployeeId = GvSalaryMaster.SelectedRow.Cells[16].Text;
        ...
        public void goToPreviousRecordTop()
        {
            ...
            if (l == 0)
            {
                ...
                else
                {
                    ...
                    l = 1;
                    GvSalaryMaster.SelectedIndex = l;
                    result = GvSalaryMaster.SelectedRow.RowIndex - k;
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "salary_sheet_worker");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                    ...
                    if (GvSalaryMaster.Rows.Count > 0)
                    {
                        if(GvSalaryMaster.Rows[0].Cells[0].Text != "NO RECORD FOUND")
                        {
                        ...
                        else
                        {
                            if (gvEmployeeList.Rows.Count > 0)
                            {
                                if (gvEmployeeList.Rows[0].Cells[0].Text != "NO RECORD FOUND")
                                {
                                    HfGridView.Value = "Bottom";
                                    gvEmployeeList.SelectedIndex = 0;
                                    goToNextRecordBottom();
        ...
        protected void GvSalaryMaster_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            GvSalaryMaster.PageIndex = e.NewPageIndex;

        }
        protected void GvSalaryMaster_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            HfGridView.Value = "Top";
            int strRowId = GvSalaryMaster.SelectedRow.RowIndex + 1;
            string strSLNo = GvSalaryMaster.SelectedRow.Cells[0].Text;
        ...
        protected void GvSalaryMaster_OnRowEditing(object sender, GridViewEditEventArgs e)
        {
        }
        protected void GvSalaryMaster_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            //if (e.CommandName == "Select")
            //{
        ...
        protected void GvSalaryMaster_Sorting(object sender, GridViewSortEventArgs e)
        {
        }
        protected void GvSalaryMaster_OnRowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                e.Row.Attributes["onmouseover"] = "this.style.cursor='pointer';this.style.textDecoration='underline';";
        ...
        protected void GvSalaryMaster_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            //start: original code
            //SalaryDTO objSalaryDTO = new SalaryDTO();
            //SalaryBLL objSalaryBLL = new SalaryBLL();

            //string EmployeeId = Convert.ToString(GvSalaryMaster.DataKeys[e.RowIndex].Values["EMPLOYEE_ID"]);
            ...
            int rowCount = GvSalaryMaster.Rows.Count;

            if (rowCount > index + 1)
            {
                string sl = GvSalaryMaster.Rows[index + 1].Cells[0].Text;
                string cardNo = GvSalaryMaster.Rows[index + 1].Cells[1].Text;
                string employeeName = GvSalaryMaster.Rows[index + 1].Cells[2].Text;
                string designationName = GvSalaryMaster.Rows[index + 1].Cells[3].Text;
                string workingDay = GvSalaryMaster.Rows[index + 1].Cells[4].Text;
                string partialDay = GvSalaryMaster.Rows[index + 1].Cells[5].Text;

                string overtimeHour = GvSalaryMaster.Rows[index + 1].Cells[6].Text;
                string earlyDeputureHour = GvSalaryMaster.Rows[index + 1].Cells[7].Text;
                string advanceFee = GvSalaryMaster.Rows[index + 1].Cells[8].Text;
                string advanceSalary = GvSalaryMaster.Rows[index + 1].Cells[9].Text;

                string arrearFee = GvSalaryMaster.Rows[index + 1].Cells[10].Text;
                string attendanceFee = GvSalaryMaster.Rows[index + 1].Cells[11].Text;
                string absentDay = GvSalaryMaster.Rows[index + 1].Cells[12].Text;
                string leaveDay = GvSalaryMaster.Rows[index + 1].Cells[13].Text;

                string lateDay = GvSalaryMaster.Rows[index + 1].Cells[14].Text;
                string bKashYn = GvSalaryMaster.Rows[index + 1].Cells[15].Text;
                string employeeId = GvSalaryMaster.Rows[index + 1].Cells[16].Text;
                string punchYn = GvSalaryMaster.Rows[index + 1].Cells[17].Text;
        ...
        protected void btnEmpInfoManualSalary_Click(object sender, EventArgs e)
        {
            try
            {
                GetEmpInfoManualSalary();
            }
            catch (Exception ex)
            {
                this.CrystalReportViewer1.Dispose();
        ...
        public void GetEmpInfoManualSalary()
        {
            try
            {
                string strDefaultName = "Report";
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/RptEmpInfoManualSalary.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetEmpInfoManualSalary(objReportDTO));
        ...
        protected void btnGetEmpWhoWdayLessThan10_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        public void GetEmpWhoseWDayLessThanXDays()
        {
            try
            {
                string strDefaultName = "Report";
