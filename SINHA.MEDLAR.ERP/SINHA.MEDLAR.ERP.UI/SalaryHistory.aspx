...
<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="SalaryHistory.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryHistory" %>
                                             ...
                                             <tr>
                                               <td style="text-align: right" class="auto-style3">
                                                ...
                                                <td style="width: 132px" colspan="2">
                                                    <asp:Button ID="btnSearch" runat="server" Height="31px" Text="Search" 
                                                        CssClass="styled-button-4" OnClick="btnSearch_Click" />
                                                    <asp:Button ID="BtnSalaryHistory" runat="server" Height="31px" Text="History"
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False" DataKeyNames="EMPLOYEE_ID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="History" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnselect" Width="25" Height="20" runat="server" CommandName="Select"
                                                        Style="cursor: pointer" Text="..." CausesValidation="false" ImageUrl="~/images/select_png.jpg"  AlternateText="History" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
