<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddMainProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMainProcess" %>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtProcessName" runat="server" Width="236px" BackColor="White" Height="20px"
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="MAIN_PROCESS_ID" HeaderText="ID" />
                    <asp:BoundField DataField="MAIN_PROCESS_NAME" HeaderText="NAME" />
