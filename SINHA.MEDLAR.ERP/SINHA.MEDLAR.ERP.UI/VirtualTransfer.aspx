...
<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="VirtualTransfer.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.VirtualTransfer" %>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <td style="width: 300px; text-align: right; height: 22px;">
                <asp:Label ID="Label1" runat="server" Text="Unit To:"></asp:Label>
                &nbsp;
            </td>
            ...
            <tr>
            <td style="width: 300px; text-align: right; height: 22px;">
                <asp:Label ID="Label2" runat="server" Text="Section To"></asp:Label>
                &nbsp;
            </td>
            <td style="width: 163px; height: 22px;">
                <asp:DropDownList ID="ddlSectionIdTo" runat="server" Width="240px" Height="22px">
                    </asp:DropDownList>
            </td>
            <td style="height: 22px; width: 66px;">
                ...
                <td colspan="2">
                    ...
                    <asp:GridView ID="GvVirtualTransfer" runat="server" DataSourceID="" AutoGenerateColumns="False" DataKeyNames="transfer_id"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="virtual_unit_id" HeaderText="virtual_section_id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"/>
                            <asp:BoundField DataField="virtual_section_id" HeaderText="virtual_section_id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"/>
