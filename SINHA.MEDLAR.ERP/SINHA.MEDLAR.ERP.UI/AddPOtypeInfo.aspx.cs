...
{
    public partial class AddPOTypeInfo : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtPOTypeName.Text == string.Empty)
            {
                string strMsg = "Please Enter PO TYPE  Name!!!";
                MessageBox(strMsg);
                txtPOTypeName.Focus();
                return;
            }
        ...
        public void SavePOtypeInfo()
        {
            ...
            objLookUpDTO.POTypeId = txtPOtypeId.Text;
            objLookUpDTO.POTypeName = txtPOTypeName.Text;
            ...
            string strMsg = objLookUpBLL.SavePOtypeInfo(objLookUpDTO);
            MessageBox(strMsg);

        }

        public void searchPOTypeInfo()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchPOTypeInfo(txtPOtypeId.Text);

            txtPOTypeName.Text = objLookUpDTO.POTypeName;
           


        }

        public void loadPOTypeRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadPOTypeRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        {
            if (txtPOtypeId.Text == string.Empty)
            {
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtPOtypeId.Text = strBuyerId;
            txtPOTypeName.Text = strBuyerShortName;
