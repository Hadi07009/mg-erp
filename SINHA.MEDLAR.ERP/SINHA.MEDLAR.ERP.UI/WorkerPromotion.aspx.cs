...
{
    public partial class WorkerPromotion : System.Web.UI.Page
    {
        ...
        public void searchWorkerPromotionEntry()
        {
            ...
            dt = objTiffinBLL.searchWorkerPromotionEntry(objTiffinDTO);
        ...
        public void searchWorkerPromotion()
        {
            ...
            dt = objTiffinBLL.searchWorkerPromotion(objTiffinDTO);
        ...
        public void processWorkerPromotion()
        {
            ...
            string strMsg = objReportBLL.processWorkerPromotion(objReportDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void addWorkerPromotion()
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                            ...
                            strMsg = objSalaryBLL.addWorkerPromotion(objSalaryDTO);
