<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="IncrementEntryCasual.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.IncrementEntryCasual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>STAFF INCREMENT INFORMATION(NON PROPOSAL)</legend>
        <table class="style1">
            <tr>
                            ...
                            <tr>
                                <td style="text-align: right" colspan="4">
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            <tr>
                                                <td style="width: 329px; text-align: right; height: 22px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right; width: 69px; height: 22px;">
            ...
            <tr>
                <td colspan="2">
                    <fieldset>
                        <legend>INCREMENT ENTRY CASUAL RESULT WORKER</legend>
                        <%-- </div>--%>
