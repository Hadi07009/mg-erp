...
{
    public partial class AddShiftType : System.Web.UI.Page
    {
        ...
        {
            if (txtShiftTypeName.Text == "")
            {

                string strMsg = "Please Enter Shift Type Name!!!";
        ...
        public void searchShiftType()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchShiftType(txtShiftTypeId.Text, strHeadOfficeId, strBranchOfficeId);

            txtShiftTypeName.Text = objLookUpDTO.ShiftName;
        ...
        public void saveShiftTypeName()
        {
            ...
            objLookUpDTO.ShiftId = txtShiftTypeId.Text;
            objLookUpDTO.ShiftName = txtShiftTypeName.Text;
            ...
            string strMsg = objLookUpBLL.saveShiftTypeName(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strShiftName = gvUnit.SelectedRow.Cells[1].Text;


            txtShiftTypeId.Text = strShiftId;
            txtShiftTypeName.Text = strShiftName;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (txtShiftTypeId.Text == "")
            {
                ...
                string strMsg = "Please Enter Shift ID!!!";
                txtShiftTypeId.Focus();
                MessageBox(strMsg);
                return;
