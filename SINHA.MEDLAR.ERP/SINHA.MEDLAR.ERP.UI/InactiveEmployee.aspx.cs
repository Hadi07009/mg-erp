...
{
    public partial class InactiveEmployee : System.Web.UI.Page
    {
        ...
        public void searchActiveEmployeeList()
        {
        ...
        public void saveInactiveEmployee()
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                        ...
                        string strMsg = objEmployeeBLL.saveInactiveEmployee(objEmployeeDTO);
                        //MessageBox(strMsg);
                        lblMsg.Text = strMsg;
                    }
