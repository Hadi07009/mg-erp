...
{
    public partial class MonthlyLunchEntryHO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtAbsentDay.Attributes.Add("onkeypress", "return controlEnter('" + txtLunchDay.ClientID + "', event)");
        ...
        public void getMonthDay()
        {
            ...
            objLookUpDTO = objLookUpBLL.getMonthDay();

            txtMonthDay.Text = objLookUpDTO.Month;
        ...
        public void searchMonthlyLunchEntryHO()
        {
            ...
            dt = objEmployeeBLL.searchMonthlyLunchEntryHO(objEmployeeDTO);
        ...
        public void searchEmployeeforLunchEntry()
        {
            ...
            dt = objEmployeeBLL.searchEmployeeforLunchEntry(objEmployeeDTO);
        ...
        public void saveSalaryMiscEntryCash()
        {
            ...
            objSalaryDTO.Year = txtSalaryYear.Text;
            objSalaryDTO.Month = txtsalaryMonth.Text;
            objSalaryDTO.LunchDay = txtLunchDay.Text;
        ...
        public void saveMonthlyLunchEntryHO()
        {
            ...
            objSalaryDTO.LunchDay = txtLunchDay.Text;
            objSalaryDTO.AbsentDay = txtAbsentDay.Text;
            objSalaryDTO.WorkingDay = txtWorkingDay.Text;
            objSalaryDTO.MonthDay = txtMonthDay.Text;
            ...
            string strMsg = objSalaryBLL.saveMonthlyLunchEntryHO(objSalaryDTO);
            if (strMsg == "LUNCH ENTRY HAS BEEN LOCKED!!!" || strMsg ==  "PLEASE CHECK WORKING DAY!!!" )
            {
        ...
        public void searchLunchEntryHO()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            objSalaryDTO = objSalaryBLL.searchLunchEntryHO(txtEmployeeId.Text, txtSalaryYear.Text, txtsalaryMonth.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);

            if (objSalaryDTO.LunchDay == null || objSalaryDTO.LunchDay == "0")
            {
            ...
            else
            {
                ...
                txtLunchDay.Text = objSalaryDTO.LunchDay;
            }
            if (objSalaryDTO.AbsentDay == null || objSalaryDTO.AbsentDay == "0")
            {
            ...
            else
            {
                ...
                txtAbsentDay.Text = objSalaryDTO.AbsentDay;
            }
            ...
            if (objSalaryDTO.MonthDay == null || objSalaryDTO.MonthDay == "0")
            {
            ...
            else
            {
                ...
                txtMonthDay.Text = objSalaryDTO.MonthDay;
            }
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            objSalaryDTO.HeadOfficeId = strHeadOfficeId;
            objSalaryDTO.BranchOfficeId = strBranchOfficeId;
            string MSG = objSalaryBLL.DeleteLunchHO(objSalaryDTO);
            lblMsg.Text = MSG;
            MessageBox(MSG);
            searchMonthlyLunchEntryHO();

            //from search button
            //searchEmployeeforLunchEntry();
            //clearYellowTextBox();
            //clearTextBox();
            //gvEmployeeList.SelectedIndex = 0;
            //goToNextRecord();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtLunchDay.Text == string.Empty && txtAbsentDay.Text == string.Empty)
                {
                    goToNextRecord();
                    searchLunchEntryHO();
                    clearMessage();
        ...
        public void monthlyLunchSheet()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptMonthlyLunchSheet.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.monthlyLunchSheet(objReportDTO));
        ...
        public void monthlyLunchSheetSummery()
        {
        ...
        public void processMonthlyLunch()
        {
            ...
            string strMsg = objSalaryBLL.processMonthlyLunch(objSalaryDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;

        }

        protected void btnLunchSheetSummery_Click(object sender, EventArgs e)
        {
            try
            {
