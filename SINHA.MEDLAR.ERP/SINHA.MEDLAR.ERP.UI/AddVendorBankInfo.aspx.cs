...
{
    public partial class AddVendorBankInfo : System.Web.UI.Page
    {
        ...
        public void saveVendorBankInfo()
        {
            ...
            string strMsg = objLookUpBLL.saveVendorBankInfo(objLookUpDTO);
            MessageBox(strMsg);

        }

        public void searchVendorBankInfo()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchVendorBankInfo(txtBankId.Text);
        ...
        public void loadVendorBankRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadVendorBankRecord(strHeadOfficeId, strBranchOfficeId);
