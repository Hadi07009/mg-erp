<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="AddAuxiliaryProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddAuxiliaryProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtAuxiliaryProcessName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD AUXILIARY PROCESS</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAuxiliaryProcessId" runat="server" Width="72px" 
            ...
            <tr>
                <td style="text-align: right; width: 279px; height: 22px;">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Auxiliary Name :"></asp:Label>
                </td>
                <td style="height: 22px">
                    <asp:TextBox ID="txtAuxiliaryProcessName" runat="server" Width="236px" 
                        BackColor="White" Height="20px"
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="AUXILIARY_PROCESS_ID" HeaderText="ID" />
                    <asp:BoundField DataField="AUXILIARY_PROCESS_NAME" HeaderText="NAME" />
                </Columns>
            </asp:GridView>
        </td>
    </fieldset>
