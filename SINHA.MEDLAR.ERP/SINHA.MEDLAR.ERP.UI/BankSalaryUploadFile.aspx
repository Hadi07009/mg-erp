<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="BankSalaryUploadFile.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.BankSalaryUploadFile" %>
            ...
            <tr>
                <td style="text-align: left;" colspan="2">
                    <fieldset>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="text-align: right; width: 438px; height: 19px">
                            ...
                            <tr>
                                <td style="text-align: right; width: 438px; height: 19px">
                                    <asp:Label ID="lblProductCataroy3" runat="server" Text="Year/Month :"></asp:Label>
                                </td>
                                <td style="height: 19px; width: 297px;">
                                    <asp:TextBox ID="txtSalaryYear" runat="server" Width="127px" BackColor="Yellow" Font-Bold="True"></asp:TextBox>
                                    <asp:TextBox ID="txtSalaryMonth" runat="server" Width="102px" BackColor="Yellow"
