...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddStore : System.Web.UI.Page
    {
        ...
        public void loadStoreRecord()
        {
            ...
            dt = objLookUpBLL.loadStoreRecord();
        ...
        public void saveStoreInfo()
        {
            ...
            objLookUpDTO.StoreId = txtStoreId.Text;
            objLookUpDTO.StoreName = txtStoreName.Text;
            ...
            string strMsg = objLookUpBLL.saveStoreInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string strMsg = "Please Enter Store Name!!!";
                txtStoreName.Focus();
                MessageBox(strMsg);
                return;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtStoreId.Text = strCourseId;
            txtStoreName.Text = strcourseName;
