...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddCategory : System.Web.UI.Page
    {
        ...
        public void loadFrontCatagoryRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadFrontCatagoryRecord();
        ...
        public void clear()
        {
            ...
            txtFrontCatagoryId.Text = "";
            txtFrontCatagoryName.Text = "";
            txtSubCatagoryName.Text = "";

        }
        public void saveFrontCategory()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO.FrontCategoryId = txtFrontCatagoryId.Text;
            objLookUpDTO.FrontCategoryName = txtFrontCatagoryName.Text;
            objLookUpDTO.SubCatagoryName = txtSubCatagoryName.Text;
            ...
            string strMsg = objLookUpBLL.saveFrontCategory(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteFrontCategory()
        {
            ...
            string strMsg = objLookUpBLL.deleteFrontCategory(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);

        }

        public void searchCatagoryEntry()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchCatagoryEntry(txtFrontCatagoryId.Text, strHeadOfficeId, strBranchOfficeId);
           ...
           txtFrontCatagoryName.Text = objLookUpDTO.CatagoryNameEng;
           txtSubCatagoryName.Text = objLookUpDTO.SubCatagoryName;
        ...
        {
            if (txtFrontCatagoryName.Text == string.Empty)
            {
                string strMsg = "Please Enter Front Catagory Name!!!";
                txtFrontCatagoryName.Focus();
                MessageBox(strMsg);
                return;
        ...
        {
            if (txtFrontCatagoryId.Text == string.Empty)
            {
                string strMsg = "Please Enter Front Catagory ID!!!";
                txtFrontCatagoryId.Focus();
                MessageBox(strMsg);
                return;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strcourseName = gvUnit.SelectedRow.Cells[3].Text;


            txtFrontCatagoryId.Text = strCourseId;
            //txtFrontCatagoryName.Text = strcourseName;
