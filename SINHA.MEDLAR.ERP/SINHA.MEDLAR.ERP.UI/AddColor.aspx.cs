...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddColor : System.Web.UI.Page
    {
        ...
        public void searchColorEntry()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO = objLookUpBLL.searchColorEntry(txtColorId.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveColorName()
        {
            ...
            string strMsg = objLookUpBLL.saveColorName(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
