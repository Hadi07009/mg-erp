<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="AddMachineModel.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineModel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMachineModelName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>MACHINE MODEL INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>MACHINE MODEL ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMachineModelId" runat="server" Width="72px" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMachineModelName" runat="server" Width="236px" BackColor="White"
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="MACHINE_MODEL_ID" HeaderText="ID" />
                            <asp:BoundField DataField="MACHINE_MODEL_NAME" HeaderText="MACHINE MODEL" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
