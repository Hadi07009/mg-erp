<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddSubject.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddSubject" %>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSubjectId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 337px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Subject Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSubjectName" runat="server" Width="236px" BackColor="White"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
