...
{
    public partial class AddStaffSalarySetup : System.Web.UI.Page
    {
        ...
        public void loadStaffSalary()
        {
            ...
            dt = objLookUpBLL.loadStaffSalary(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveStaffSalary()
        {
            ...
            string strMsg = objLookUpBLL.saveStaffSalary(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
