<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="IncrementEntryStaff.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.IncrementEntryStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>STAFF INCREMENT INFORMATION</legend>
        <table class="style1">
            <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 293px; text-align: left;">
                                    <asp:TextBox ID="dtpJoiningDate" runat="server" Width="80px" Height="20px" defaultfocus="txtWorkingDay"
                                        Font-Bold="True" BackColor="Yellow" ReadOnly="True" style="margin-left: 0"></asp:TextBox>
                            ...
                            <tr>
                               <%-- <td style=" text-align: right; width: 303px;">
                                ...
                                <td style="width: 288px; text-align: right;">
                                    <asp:Label ID="LblAllowGeneralIncrement" runat="server" Text="Allow Increment (5%) :" Visible="false"></asp:Label>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnIncrementSheetByUnitGroup" runat="server" Height="31px" 
                                        Text="Requisition (UG)" Width="120px"
                                        CssClass="styled-button-4" 
                               ...
                               <tr>
                                <td style="text-align: right" class="auto-style3">
                                 ...
                                 <td style="width: 100px">
                                     <%--<asp:Button ID="Button1" runat="server" Height="24px" Text="Search" Width="47px"
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <%--7--%>
                                            <asp:BoundField DataField="proposed_gross_salary" HeaderText="PROP. GROSS" />
                ...
                <td colspan="2">
                    <asp:GridView ID="gvEmployeeList" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DESIGNATION_NAME" HeaderText="DESIGNATION" />
                            <asp:BoundField DataField="JOINING_DATE" HeaderText="J.D" />
                            <asp:BoundField DataField="gross_salary_new" HeaderText="GROSS" />
                            <asp:BoundField DataField="EMPLOYEE_ID" HeaderText="ID" />
