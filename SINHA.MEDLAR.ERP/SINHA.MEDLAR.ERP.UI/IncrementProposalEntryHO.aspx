<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="IncrementProposalEntryHO.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.IncrementProposalEntryHO"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>INCREMENT PROPOSAL INFORMATION</legend>
        <table class="style1">
            <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        <legend>INCREMENT PROPOSAL ENTRY</legend>
                        <table class="style1">
                            <tr>
                            ...
                            <tr>
                                <td style="width: 341px; text-align: right">
                                    <asp:Label ID="Label29" runat="server" Text="Gross Salary :"></asp:Label>
                                </td>
                                <td style="width: 268px; text-align: left;">
                                ...
                                <td style="width: 130px; text-align: right;">
                                    <asp:Label ID="lblIncrementType" runat="server" Text="Increment Type :"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlIncrementType" runat="server" Width="160px" Height="22px"></asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 268px; text-align: left;">
                                    <asp:TextBox ID="txtScore" runat="server" Width="130px" Height="20px" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="width: 86px; text-align: right;">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 268px; text-align: left;">
                                    <asp:TextBox ID="txtRemarks" runat="server" Width="269px" Height="75px" onkeydown="javascript:TextName_OnKeyDown(event)"
                            ...
                            <tr>
                                <td style=" text-align: right; height: 15px; width: 341px;">
                                    &nbsp;
                                </td>
                                <td style="width: 268px; text-align: left; height: 15px;">
                                    &nbsp;
                                </td>
                                <td style="width: 86px; text-align: right; height: 15px;">
                                    &nbsp;
                                </td>
                                <td style="height: 15px">
                                    &nbsp;
                            ...
                            <tr>
                                <td style="text-align: center; height: 15px;" colspan="4">
                                    ...
                                    <asp:Button ID="btnCreateProposal" runat="server" Height="31px" Text="Create Proposal" Width="110px" OnClick="btnCreateProposal_Click"
                                    ...
                                    <asp:Button ID="btnProposalSheet" runat="server" Height="31px" Text="Proposal" Width="60px"
                                        CssClass="styled-button-4" OnClick="btnProposalSheet_Click" />

                                    <asp:Button ID="btnSheet" runat="server" Height="31px" Text="Score" Width="66px"
                                        CssClass="styled-button-4" OnClick="btnSheet_Click" />
                                    <asp:Button ID="btnForceProposal" runat="server" Height="31px" Text="Force Proposal" Width="100px"
                                        CssClass="styled-button-4" OnClick="btnForceProposal_Click" />
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 148px; text-align: right;">
                                                    <asp:DropDownList ID="ddlSupervisorId" runat="server" Width="150px" Height="22px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="width: 79px">
                                                    &nbsp;
                                                ...
                                                <td style="width: 79px; text-align: right;">
                                                    <asp:Label ID="lblIncrementType2" runat="server" Text="Incr. Type :"></asp:Label>
                                                     &nbsp;
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlIncrementType2" runat="server" Width="153px" Height="22px"></asp:DropDownList>
                                                </td>
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="increment_type_name" HeaderText="Increment Type" />
                                            ...
                                            <asp:BoundField DataField="increment_type_id" HeaderText="Increment Type" HeaderStyle-CssClass = "hideGridColumn" ItemStyle-CssClass="hideGridColumn" />
                                        </Columns>
                                    </asp:GridView>
                                </td>
                            </tr>
