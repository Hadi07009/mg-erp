<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="AddSizeForPacking.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddSizeForPacking" %>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtStyleNo" runat="server" Width="182px" BackColor="White" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPoNo" runat="server" Width="183px" BackColor="White"></asp:TextBox>
                &nbsp;</td>
                <td>&nbsp;
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 337px; height: 19px">
                    <asp:Label ID="lblId0" runat="server" Text="Size Name : "></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtSizeName" runat="server" Width="182px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                &nbsp;</td>
                <td style="height: 19px">&nbsp;</td>
            </tr>
            <tr>
                <td style="text-align: right; width: 337px; height: 19px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Barcode Number :"></asp:Label>
                </td>
                <td style="height: 19px"><asp:TextBox ID="txtBarcodeNumber" runat="server" Width="183px" BackColor="White"></asp:TextBox>
                </td>
                <td style="height: 19px">&nbsp;
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 337px; height: 19px">
                    <asp:Label ID="lblId1" runat="server" Text="Order Qty : "></asp:Label>
                </td>
                <td style="height: 19px"><asp:TextBox ID="txtOrderQty" runat="server" Width="183px" 
            ...
            <tr>
                <td style="text-align: right; width: 337px; height: 19px">
                    <asp:Label ID="lblId2" runat="server" Text="Quantity Per Cutton : "></asp:Label>
                </td>
                <td style="height: 19px"><asp:TextBox ID="txtQtyperCutton" runat="server" 
                        Width="183px" BackColor="White"></asp:TextBox>
                </td>
                <td style="height: 19px">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvBuyerEntry" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="BARCODE_NUMBER_ID" HeaderText="BARCODE NUMBER" />
                           <asp:BoundField DataField="ORDER_QTY" HeaderText="ORDER QTY" />
                            <asp:BoundField DataField="QTY_PER_CUTTON" HeaderText="QTY PER CUTTON" />
