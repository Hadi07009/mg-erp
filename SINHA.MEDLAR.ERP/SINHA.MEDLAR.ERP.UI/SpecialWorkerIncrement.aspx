<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="SpecialWorkerIncrement.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SpecialWorkerIncrement" %>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="text-align: center" colspan="5">
                                    <asp:Button ID="btnSave0" runat="server" Height="31px" Text="Proposal" Width="66px" OnClick="btnProposal_Click"
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; width: 59px;" class="auto-style3">
