...
{
    public partial class AddSizeForPacking : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtStyleNo.Attributes.Add("onkeypress", "return controlEnter('" + txtPoNo.ClientID + "', event)");

            txtPoNo.Attributes.Add("onkeypress", "return controlEnter('" + txtSizeName.ClientID + "', event)");
            txtSizeName.Attributes.Add("onkeypress", "return controlEnter('" + txtBarcodeNumber.ClientID + "', event)");
            txtBarcodeNumber.Attributes.Add("onkeypress", "return controlEnter('" + txtOrderQty.ClientID + "', event)");
            txtOrderQty.Attributes.Add("onkeypress", "return controlEnter('" + txtQtyperCutton.ClientID + "', event)");
            txtQtyperCutton.Attributes.Add("onkeypress", "return controlEnter('" + btnSave.ClientID + "', event)");
        ...
        public void saveSizeNameForPacking()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();
            objLookUpDTO.StyleNo = txtStyleNo.Text.Trim();
            objLookUpDTO.PONo = txtPoNo.Text.Trim();
            objLookUpDTO.BarcodeNumber = txtBarcodeNumber.Text.Trim();
            objLookUpDTO.SizeName = txtSizeName.Text.Trim();

            objLookUpDTO.OrderQty = txtOrderQty.Text.Trim();
            objLookUpDTO.SizeWisePackingQTY = txtQtyperCutton.Text.Trim();
            objLookUpDTO.UpdateBy = strEmployeeId;
            objLookUpDTO.HeadOfficeId = strHeadOfficeId;
            objLookUpDTO.BranchOfficeId = strBranchOfficeId;

            string strMsg = objLookUpBLL.saveSizeNameForPacking(objLookUpDTO);
        ...
        public void loadSizeNameForPacking()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadSizeNameForPacking(txtPoNo.Text, txtStyleNo.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtPoNo.Text = strBuyerId;
            txtStyleNo.Text = strBuyerName;
