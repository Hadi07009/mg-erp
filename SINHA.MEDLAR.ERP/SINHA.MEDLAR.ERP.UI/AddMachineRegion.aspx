<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddMachineRegion.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineRegion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMachineRegion.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>MACHINE TYPE INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>MACHINE TYPE ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMachineRegionId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblProductCataroy" runat="server" Text="Machine Region :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtMachineRegion" runat="server" Width="236px" BackColor="White"
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="MACHINE_REGION_ID" HeaderText="ID" />
                            <asp:BoundField DataField="MACHINE_REGION_NAME" HeaderText="MACHINE REGION" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
