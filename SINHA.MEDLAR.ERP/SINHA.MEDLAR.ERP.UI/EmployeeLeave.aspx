<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="EmployeeLeave.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmployeeLeave" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 76px; text-align: right">
                    <asp:Label ID="lblProductCataroy10" runat="server" Text="Card No :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCardNo" runat="server" Width="208px" BackColor="Yellow" Height="20px"
                        Font-Bold="True"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="height: 19px">
                    ...
                    <asp:TextBox ID="txtFileName" runat="server" Width="40px" BackColor="Yellow" ReadOnly="True"
             ...
             <tr>
                <td style="text-align: right; width: 157px; height: 19px">
                    <asp:Label ID="Label40" runat="server" Text="Unit :"></asp:Label>
                    &nbsp;
                </td>
                <td style="height: 19px; width: 226px;">
                    <asp:TextBox ID="txtUnitName" runat="server" Width="223px" Height="20px" BackColor="Yellow"
                        ReadOnly="True" Font-Bold="True"></asp:TextBox>
                </td>
                <td style="height: 19px; width: 76px; text-align: right;">
                    <asp:Label ID="Label41" runat="server" Text="Section :"></asp:Label>
                    </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtSectionName" runat="server" Width="250px" Height="20px" BackColor="Yellow"
                        ReadOnly="True" Font-Bold="True" ></asp:TextBox>
                </td>
                <td style="height: 19px">
                    &nbsp;</td>
                                    ...
                                    <div style="overflow-x: scroll;">
                                        <asp:GridView ID="GridView2" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MAX_ALLOW" HeaderText="ALLOWED" />
                                                <asp:BoundField DataField="TOTAL_LEAVE" HeaderText="AVAILED" />
            ...
            <tr>
                <td style="text-align: right; width: 157px; height: 19px">
                    <asp:Label ID="lblProductCataroy12" runat="server" Text="File Upload :"></asp:Label>
                </td>
                <td style="height: 19px; width: 226px;">
                    <asp:FileUpload ID="FileUpload1" runat="server" onchange="validateFile()"/>
                    &nbsp;
                </td>
                <td style="height: 19px; width: 76px; text-align: right;">
                    &nbsp;
            ...
            <tr>
                <td style="text-align: center; height: 19px" colspan="5">
                    ...
                    <asp:Button ID="btnSummerySheet" runat="server" Height="31px" Text="Summery" Width="66px"
                        CssClass="styled-button-4" OnClick="btnSummerySheet_Click"  />
                    <asp:Button ID="BtnMonthWiseSummerySheet" runat="server" Height="31px" Text="Summery(MW)" Width="100px"
                        CssClass="styled-button-4" OnClick="BtnMonthWiseSummerySheet_Click"  />
        ...
        <table class="style1">
            <tr>
                ...
                <td style="width: 46px">
                    Em Type:</td>
                <td>
                    <asp:DropDownList ID="ddlEmployeeTypeId" runat="server" Height="22px" 
                        Width="152px">
            ...
            <tr>
                ...
                <td style="width: 163px">
                    <asp:DropDownList ID="ddlFloor" runat="server" Width="239px" Height="25px">
                    </asp:DropDownList>
                </td>
               <td style="width: 147px">&nbsp;</td>
                <td style="width: 46px">Sits Type </td>
                <td>  
                  <asp:DropDownList ID="ddlSittingType" runat="server" Width="152px" Height="22px">
