<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="PasswordChange.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.PasswordChange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <fieldset>
        <legend>CHANGE PASSWORD OF OTHER USERS</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 336px; height: 22px;">
                    <asp:Label ID="lblId5" runat="server" Text="User Name :"></asp:Label>
                </td>
                <td style="height: 22px; width: 188px;">
                    <asp:DropDownList ID="ddlEmpId" runat="server" Width="217px" Height="22px" AutoPostBack ="true"
                        BackColor="#CCCCCC" onselectedindexchanged="ddlEmpId_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 336px; height: 22px;">
                    <asp:Label ID="lblId6" runat="server" Text="Employee Name :"></asp:Label>
                </td>
                <td style="height: 22px; width: 188px;">
                    <asp:TextBox ID="txtEmployeeName" runat="server" Width="212px" Height="20px" BackColor="Yellow"
                        ForeColor="Black" ControlToValidate="txtNewPassword" 
                        ErrorMessage="Please Enter New Password!!!" ReadOnly="True"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="height: 22px; width: 188px;">
                    <asp:TextBox ID="txtNewPassword" runat="server" Width="212px" Height="20px" BackColor="White"
                        ForeColor="Black" TextMode="Password" ControlToValidate="txtNewPassword" ErrorMessage="Please Enter New Password!!!"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
