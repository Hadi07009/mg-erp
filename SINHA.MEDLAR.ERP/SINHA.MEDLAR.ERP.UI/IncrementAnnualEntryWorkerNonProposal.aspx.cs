...
{
    public partial class IncrementAnnualEntryWorkerNonProposal : System.Web.UI.Page
    {
        ...
        public void searchWorkerRecordForAnnualIncrementNonProposal()
        {
            ...
            dt = objEmployeeBLL.searchWorkerRecordForAnnualIncrementNonProposal(objEmployeeDTO);
        ...
        public void searchIncrementEntryWorkerNonProposal()
        {
            ...
            dt = objEmployeeBLL.searchIncrementEntryWorkerNonProposal(objEmployeeDTO);
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "increment_sheet_worker_monthly");
        ...
        public void addWorkerYearlyIncrementNonProposal()
        {
            ...
            foreach (GridViewRow row in gvEmployeeList.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkEmployee.Checked)
                    {
                        ...
                        strMsg = objSalaryBLL.addWorkerYearlyIncrementNonProposal(objSalaryDTO);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    searchWorkerRecordForAnnualIncrementNonProposal();
                    clearYellowTextBox();
                    clearTextBox();
                    gvEmployeeList.SelectedIndex = 0;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    saveIncrementWorkerNonProposal();
                    searchIncrementEntryWorkerNonProposal();
                    goToNextRecord();
                    searchWorkerIncrementEntryNonProposal();
