<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryEntryHOMiscellaneous.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.MiscEntryHOMISC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>HO MISC SALARY INFORMATION</legend>
        <table class="style1">
            <tr>
                ...
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="width: 274px; text-align: right; height: 15px;">
                                    <asp:Label ID="Label44" runat="server" Text="Food Deduction :"></asp:Label>
                                </td>
                                <td style="width: 292px; text-align: left; height: 15px;">
                                    <asp:TextBox ID="txtFoodDeductFee" runat="server" Width="130px" Height="20px" onkeydown="javascript:TextName_OnKeyDown(event)"
                            ...
                            <tr>
                                <td style=" text-align: right; height: 15px; width: 274px;">
                                    &nbsp;
                                </td>
                                <td style="width: 292px; text-align: left; height: 15px;">
                                    &nbsp;
                            ...
                            <tr>
                                <td style="text-align: center; height: 15px;" colspan="4">
                                    ...
                                    <asp:Button ID="btnShow" runat="server" Height="31px" Text="Show" Width="66px" OnClick="btnShow_Click"
                                        CssClass="styled-button-4" />
                                    <asp:Button ID="btnProcess" runat="server" Height="31px" Text="Process" CssClass="styled-button-4"
                                        Width="66px" OnClick="btnProcess_Click" />
                                    ...
                                    <asp:Button ID="btnSalarySlip" runat="server" Height="31px" Text="Slip" CssClass="styled-button-4"
                                        Width="66px" OnClick="btnSalarySlip_Click" />

                                    <asp:Button ID="BtnHiddenSalarySheet" runat="server" Height="31px" Text="Hihhen Sheet" Width="100px"
                                        CssClass="styled-button-4" OnClick="BtnHiddenSalarySheet_Click" />
            ...
            <tr>
                <td colspan="2">
                    <fieldset>
                        <legend>SALARY ENTRY RESULT HO MISC</legend>
