...
{
    public partial class MFSTemplateLeaveEncashment : System.Web.UI.Page
    {
        private const string paymentTypeId = "4";
        ...
        public void getMonthYearForTax()
        {
            ...
            txtSalaryYear.Text = Convert.ToString(Convert.ToInt32(objLookUpDTO.Year) - 1);
        ...
        public void GetMonthlySalaryMfsReq()
        {
            ...
            try
            {
                ...
                //string strPath = Path.Combine(Server.MapPath("~/Reports/RptMfsTplReq.rpt"));
        ...
        public void GetSalaryUnitSectionBottomGrid()
        {
            ...
            objEmployeeDTO.PaymentTypeId = paymentTypeId;  //lEAVE ENCASHMENT
        ...
        public string CreatePhaseIdInMonthlySalary()
        {
            ...
            try
            {
                ...
                objEmployeeDTO.PaymentTypeId = paymentTypeId; //LEAVE ENCASHMENT
                objEmployeeDTO.EidTypeId = eidTypeId; //LEAVE ENCASHMENT
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                MessageBox("Please select one or more to remove.");
                return;
            }
