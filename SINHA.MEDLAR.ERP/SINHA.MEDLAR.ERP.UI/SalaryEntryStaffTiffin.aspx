<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryEntryStaffTiffin.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.SalaryEntryStaffTiffin" %>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnMonthlyStaffSalarySheet" runat="server" Height="31px" Text="Sheet"
                                        CssClass="styled-button-4" Width="66px" 
                                        OnClick="btnMonthlyStaffSalarySheet_Click" Visible="False" />
                                  <asp:Button ID="btnSalaryRequisitionStaffMisc" runat="server" Height="31px" Text=" Requisition."
                                        CssClass="styled-button-4" Width="73px" 
                                        OnClick="btnSalaryRequisitionStaffMisc_Click" Visible="False" />
                                    <asp:Button ID="btnStaffMiscReqSummary" runat="server" Height="31px" 
                                        Text="Req Summmary" Width="100px"
                                        CssClass="styled-button-4" OnClick="btnStaffMiscReqSummary_Click" 
                                        Visible="False" />
                                    <asp:Button ID="btnMonthlyStaffPaySlip" runat="server" Height="31px" Text="Pay Slip"
                                        CssClass="styled-button-4" Width="66px" 
                                        OnClick="btnMonthlyStaffPaySlip_Click" Visible="False" />
                                    <asp:Button ID="btnStaffSalarySummerySheet" runat="server" Height="31px" Text="Indv. Summary"
                                        CssClass="styled-button-4" Width="130px" 
                                    ...
                                    <asp:Button ID="btnMonthlySalarySheetAll" runat="server" Height="31px" Text="Sheet(All)"
                                        CssClass="styled-button-4" Width="70px" 
                                        OnClick="btnMonthlySalarySheetAll_Click" Visible="False" />                                 
