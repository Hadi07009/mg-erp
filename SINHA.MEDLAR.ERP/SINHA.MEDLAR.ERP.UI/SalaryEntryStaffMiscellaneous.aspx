<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryEntryStaffMiscellaneous.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.SalaryEntryStaffMiscellaneous" %>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                  ...
                                  <asp:Button ID="btnSalaryRequisitionStaffMisc" runat="server" Height="31px" Text=" Requisition."
                                        CssClass="styled-button-4" Width="73px" OnClick="btnSalaryRequisitionStaffMisc_Click" />
                                    <asp:Button ID="btnStaffMiscReqSummary" runat="server" Height="31px" Text="Req Summmary" Width="100px"
                                    ...
                                    <asp:Button ID="btnMonthlySalarySheetAll" runat="server" Height="31px" Text="Sheet(All)"
                                        CssClass="styled-button-4" Width="70px" OnClick="btnMonthlySalarySheetAll_Click" />                                 
