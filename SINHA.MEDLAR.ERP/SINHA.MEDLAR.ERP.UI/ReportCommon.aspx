<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="ReportCommon.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.ReportCommon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <tr>
        <td style="width: 256px">
            <asp:RadioButton ID="rdoDailyAttendenceSheet" runat="server" 
                AutoPostBack="true" Text="Daily Attendence Sheet"
        ...
        <td style="width: 79px; text-align: right;">
            <asp:Label ID="lblUnitId2" runat="server" Text="Card No :" Visible="true"></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="txtCardNo" runat="server" Width="144px" placeholder="CARD NO"
                Height="20px" Visible="true"></asp:TextBox>

        </td>
    </tr>
    <tr>
        <td style="width: 256px">
            <asp:RadioButton ID="rdoDailyLateSheet" runat="server" AutoPostBack="true" Text="Daily Late Sheet"
                Font-Bold="False" GroupName="Controls" 
                oncheckedchanged="rdoAttendenceSheet_CheckedChanged" />
        </td>
        <td style="width: 81px; text-align: right;">
        ...
        <td style="width: 79px; text-align: right;">
            <asp:Label ID="lblyear" runat="server" Text="Year :" Visible="true"></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="txtYear" runat="server" Width="144px" placeholder="Year"
                Height="20px" Visible="true"></asp:TextBox>
    ...
    <tr>
        <td style="width: 256px">
            <asp:RadioButton ID="rdoDailyAbsenceSheet" runat="server" AutoPostBack="true" Text="Daily Absence Sheet"
                Font-Bold="False" GroupName="Controls" 
                oncheckedchanged="rdoAttendenceSheet_CheckedChanged" />
        </td>
        <td style="width: 81px; text-align: right;">
    ...
    <tr>
        <td style="width: 256px; height: 22px;">
            <asp:RadioButton ID="rdoMonthlyAttendenceSheet" runat="server" AutoPostBack="true"
                Text="Monthly Attendence  Sheet By ID" GroupName="Controls" />
        </td>
    ...
    <tr>
        <td style="width: 256px">
            <asp:RadioButton ID="rdoMonthlyAttendenceSheetAll" runat="server" AutoPostBack="true"
                Text="Monthly Attendence  Sheet All" GroupName="Controls" />
        </td>
        <td style="width: 81px; text-align: right;">
    ...
    <tr>
       <td style="width: 268px; height: 22px;">
            <asp:RadioButton ID="rdoEmployeeJobHistoryOverall" runat="server" AutoPostBack="true" Text="Employee Job History(Overall)"
                GroupName="Controls" />
        </td>
