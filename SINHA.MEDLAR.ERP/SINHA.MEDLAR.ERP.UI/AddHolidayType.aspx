<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddHolidayType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddHolidayType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtHolidayName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD HOLIDAY TYPE</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblHolidayName" runat="server" Text="Holiday Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtHolidayName" runat="server" Width="236px" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvHolidayType" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvHolidayType_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvHolidayType_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="HOLIDAY_TYPE_ID" HeaderText="ID" />
