<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="ActiveEmployee.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.ActiveEmployee" %>
                        ...
                        <table class="style1">
                            <tr>
                                <td style="text-align: right">
                                    <table class="style1">
                                        <tr>
                                            <td style="width: 219px; text-align: right; height: 22px;">
                                        ...
                                        <tr>
                                            <td style="text-align: center" colspan="5">
                                                ...
                                                <asp:Button ID="btnActiveEmployee" runat="server" Height="31px" Text="Active" Width="66px"
