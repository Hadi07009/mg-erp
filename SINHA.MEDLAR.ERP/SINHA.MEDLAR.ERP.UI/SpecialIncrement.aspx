...
<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="SpecialIncrement.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SpecialIncrement" %>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="text-align: center" colspan="5">
                                    ...
                                    <asp:Button ID="btnShow" runat="server" Height="31px" Text="Show" Width="66px" OnClick="btnShow_Click"
                                        CssClass="styled-button-4" />
                                    <asp:Button ID="btnProposal" runat="server" Height="31px" Text="Create Proposal" Width="110px" OnClick="btnProposal_Click"
                                        CssClass="styled-button-4" />
                            ...
                            <tr>
                                                ...
                                                <td style="width: 100px; text-align: right;">
                                                    <asp:TextBox ID="txtIncrementAmountLimit" runat="server" Width="95px" BackColor="White"></asp:TextBox>
                                                </td>
                                                <td style="width: 100px; text-align: right;">
                                                    &nbsp;
