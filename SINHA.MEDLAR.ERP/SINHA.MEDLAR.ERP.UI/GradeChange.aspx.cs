...
{
    public partial class GradeChange : System.Web.UI.Page
    {
        ...
        public void getGradeNoSearch()
        {
            LookUpBLL objLookUpBLL = new LookUpBLL();
            ddlGradeSearch.DataSource = objLookUpBLL.getGradeId(strHeadOfficeId, strBranchOfficeId);

            ddlGradeSearch.DataTextField = "GRADE_NO";
            ddlGradeSearch.DataValueField = "GRADE_ID";

            ddlGradeSearch.DataBind();
            if (ddlGradeSearch.Items.Count > 0)
            {
                ddlGradeSearch.SelectedIndex = 0;
            }
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlGradeSearch.SelectedItem.Value == " ")
                {
        ...
        public void GetEmpForGradeChange()
        {
