<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryMonthlyResignOTEntry.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryMonthlyResignOTEntry" %>
                ...
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="text-align: right" class="auto-style2">
                                    <asp:Label ID="Label27" runat="server" Text="OT Hour :"></asp:Label>
                                </td>
                                <td style="text-align: left;" class="auto-style7">
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnOTSheet" runat="server" Height="31px" 
                                        Text="Sheet" Width="66px"
