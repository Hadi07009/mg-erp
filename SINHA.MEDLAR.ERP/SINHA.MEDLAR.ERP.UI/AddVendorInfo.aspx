<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddVendorInfo.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddVendorAddress" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD VENDOR INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>VENDOR INFORMATION ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblId0" runat="server" Text="Vedor Name :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtVendorName" runat="server" Width="236px" BackColor="White"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblId3" runat="server" Text="Fax No :"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtVendorAddress" runat="server" Width="236px" BackColor="White"
