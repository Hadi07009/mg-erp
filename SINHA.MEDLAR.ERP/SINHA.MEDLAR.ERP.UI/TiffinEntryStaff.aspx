<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="TiffinEntryStaff.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.TiffinEntryStaff" %>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnMasterTiffinSheet" runat="server" Height="31px" Text="Master Sheet" Width="100px" CssClass = "styled-button-4"
                                        OnClick="btnMasterTiffinSheet_Click" />
                                    
                                    <asp:Button ID="btnBkashSheet" runat="server" Height="31px" Text="bKash Sheet" Width="100px" CssClass = "styled-button-4"
                                    ...
                                    <%--<asp:Button ID="btnTiffinRequsitionSummery" runat="server" Height="31px" 
                                        Text="Summery" CssClass = "styled-button-4"
