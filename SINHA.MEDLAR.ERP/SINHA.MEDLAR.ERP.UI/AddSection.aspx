<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddSection.aspx.cs" EnableEventValidation="false" Inherits="SINHA.MEDLAR.ERP.UI.AddSection" %>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSectionId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Section Name(Eng) :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSectionNameEng" runat="server" Width="236px" BackColor="White"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Section Name(Bng) :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSectionNameBng" runat="server" Width="236px" Font-Names="KarnaphuliMJ"
            ...
            <tr>
                ...
                <td style="height: 19px">
                    <asp:DropDownList ID="ddlEmployeeTypeId" runat="server" Width="241px" Height="22px">
                    </asp:DropDownList>
                </td>
                <td style="height: 19px">
                </td>
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="SECTION_ID" HeaderText="ID" />
                            <asp:BoundField DataField="SECTION_NAME" HeaderText="SECTION NAME" />
                            <asp:BoundField DataField="SECTION_NAME_BANGLA" HeaderText="SECTION NAME(BANGLA)" />
