<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ERP.Master" CodeBehind="EmployeeShiftMapping.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmployeeShiftMapping" %>
                    ...
                    <table class="style1">
                        <tr>
                            <td style="text-align: right; width: 200px;">
                                <asp:Label ID="lblShiftId" runat="server" Font-Bold="False" Text="Team :"></asp:Label>
                            </td>
                            <td style="text-align: left; width: 250px;" class="auto-style6">
                                <asp:DropDownList ID="ddlShiftId" runat="server" Width="213px" Height="22px"></asp:DropDownList>
                        ...
                        <%--<tr>
                            <td style="text-align: right; width: 200px;">
                                <asp:Label ID="Label2" runat="server" Text="End Date:" Font-Bold="False"></asp:Label>
                            </td>
                            <td style="text-align: left; width: 250px;" class="auto-style6">
                                <asp:TextBox ID="txtEndDate" runat="server" BackColor="White" Width="210" CssClass="date"></asp:TextBox>
                            </td>
                            <td style="text-align: left;">&nbsp;</td>
                            <td style="text-align: right;" class="auto-style5">
                            ...
                            <td>
                                <asp:TextBox ID="TextBox2" runat="server" Width="269px" Height="20px" BackColor="Yellow"
                                    ReadOnly="True" Font-Bold="True" ForeColor="Red"></asp:TextBox>
                            </td>
                        </tr>--%>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 250px;" class="auto-style6">
                                <asp:TextBox ID="dtpEndDate" runat="server" BackColor="White" Width="210" CssClass="date"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 250px;" class="auto-style6">
                                <asp:Button ID="btnAdd" runat="server" Height="31px" Text="Add" Width="55px"
                                    CssClass="styled-button-4" OnClick="btnAdd_Click" />
                                <asp:Button ID="btnUpdate" runat="server" Height="31px" Text="Update" Width="55px"
                                    CssClass="styled-button-4" OnClick="btnUpdate_Click" Visible="false"/>
                                <asp:Button ID="btnShow" runat="server" Height="31px" Text="Show" Width="55px" CssClass="styled-button-4"
                                    OnClientClick="target = '_SELF';" OnClick="btnShow_Click" />
                                <asp:Button ID="btnClear" runat="server" Height="31px" Text="Reset" Width="55px" CssClass="styled-button-4"
                                ...
                                <fieldset>
                                    ...
                                    <table class="style1">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 163px">
                                                <asp:DropDownList ID="ddlShiftSearching" runat="server" Width="240px" Height="22px">
                                                </asp:DropDownList>
                                            </td>
                                            <td style="width: 66px">&nbsp;
                                            </td>
