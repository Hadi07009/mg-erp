<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="ArrearEntryWorker.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.ArrearEntryWorker" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtManualIncrementAmount.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>WORKER ARREAR INFORMATION</legend>
        <table class="style1">
            <tr>
                ...
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                <td style="width: 278px; text-align: right">
                                    <asp:Label ID="Label43" runat="server" Text="Amount :"></asp:Label>
                                </td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtIncrementAmount" runat="server" Width="63px" Height="20px" defaultfocus="txtWorkingDay"
                                        Font-Bold="True" BackColor="Yellow" ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox ID="txtManualIncrementAmount" runat="server" Width="63px" Height="20px"
                                        defaultfocus="txtWorkingDay" onkeydown="javascript:TextName_OnKeyDown(event)"
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnArrearProcessWroker" runat="server" Height="31px" Text="Process"
                                        Width="66px" CssClass="styled-button-4" OnClick="btnArrearProcessWroker_Click" />
                                    <asp:Button ID="btnArrearSheetWorker" runat="server" Height="31px" Text="Sheet" Width="50px"
                                        CssClass="styled-button-4" OnClick="btnArrearSheetWorker_Click" />
                            ...
                            <tr>
                                <td style="text-align: right" colspan="4">
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            <tr>
                                                <td style="text-align: right; width: 271px;" class="style4">
                                            ...
                                            <tr>
                                                <td style="text-align: right; width: 271px;" class="style5">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 163px">
                                                    <asp:TextBox ID="txtYear" runat="server" Width="101px" Height="20px" Font-Bold="True"
                                                        MaxLength="4"></asp:TextBox>
                                                    <asp:DropDownList ID="ddlMonthId" runat="server" Width="134px" Height="22px">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="width: 66px">
                                                    &nbsp;
                                            ...
                                            <tr>
                                                <td style="text-align: right" class="style5" colspan="5">
                                                    &nbsp;
                                                </td>
                                            </tr>
                                        </table>
                ...
                <td colspan="2">
                    <asp:GridView ID="GridView2" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="INCREMENT_AMOUNT_MANUAL" HeaderText="AMOUNT" />
                ...
                <td colspan="2">
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DESIGNATION_NAME" HeaderText="DESIGNATION" />
                            <asp:BoundField DataField="joining_date" HeaderText="J.D" />
                            <asp:BoundField DataField="increment_amount" HeaderText="INC.AMOUNT" />
                            <asp:BoundField DataField="EMPLOYEE_ID" HeaderText="ID" />
