...
{
    public partial class AddProductName : System.Web.UI.Page
    {
        ...
        public void loadProductRecord()
        {
            ...
            dt = objLookUpBLL.loadProductRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveProductInformation()
        {
            ...
            objLookUpDTO.ProductId = txtProductId.Text;
            ...
            string strMsg = objLookUpBLL.saveProductInformation(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteProductName()
        {
            ...
            string strMsg = objLookUpBLL.deleteProductName(objLookUpDTO);
            lblMsg.Text = strMsg;
            //MessageBox(strMsg);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string strMsg = "Please Enter Product Name!!!";
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strCourseId = gvUnit.SelectedRow.Cells[0].Text.Replace("&nbsp;", "");
            string strcourseName = gvUnit.SelectedRow.Cells[1].Text.Replace("&nbsp;", "");


            txtProductId.Text = strCourseId;
            txtProductName.Text = strcourseName;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                string strMsg = "Please Enter Product ID!!!";
                txtProductId.Focus();
                MessageBox(strMsg);
                return;
