<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddLeaveLockEntry.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddLeaveLockEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD LEAVE LOCK INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>LEAVE LOCK ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSalaryYear" runat="server" Width="142px" BackColor="Yellow"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                            </tr>
                ...
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LEAVE_YEAR" HeaderText="YEAR" Visible="True" />
