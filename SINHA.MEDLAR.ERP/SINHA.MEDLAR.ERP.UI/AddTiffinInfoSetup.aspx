<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddTiffinInfoSetup.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddTiffinInfoSetup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtTiffinFee.ClientID %>").focus(); }) 
    </script>
    <table class="style1">
        <tr>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD TIFFIN_FEE SETUP</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 335px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Tiffin Fee :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtTiffinFee" runat="server" Width="236px" BackColor="White" Height="20px"
            ...
            <tr>
                <td style="text-align: right; width: 335px; height: 19px"></td>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TIFFIN_FEE" HeaderText="TIFFIN FEE" />
