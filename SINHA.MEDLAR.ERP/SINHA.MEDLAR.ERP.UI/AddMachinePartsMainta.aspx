<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddMachinePartsMainta.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachinePartsMainta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtMachineParts.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>MACHINE PARTS ENTRY</legend>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="height: 19px">
                                    <asp:TextBox ID="txtMachinePartsId" runat="server" Width="36px" 
                            ...
                            <tr>
                                ...
                                <td style="height: 19px">
                                    <asp:DropDownList ID="ddlMachineId" runat="server" Height="20px" Width="202px"
                                        AutoPostBack="True" 
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px; height: 19px">
                                    <asp:Label ID="lblProductCataroy2" runat="server" Text="Model Name :"></asp:Label>
                                </td>
                                <td style="height: 19px">
                                    <asp:DropDownList ID="ddlMAchineModelId" runat="server" Height="20px" AutoPostBack="True"
                                        Width="202px">
                                        <asp:ListItem></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px; height: 19px">
                                    <asp:Label ID="Label5" runat="server" Text="Machine Parts :"></asp:Label>
                                </td>
                                <td style="height: 19px">
                                    <asp:TextBox ID="txtMachineParts" runat="server" onkeydown="javascript:TextName_OnKeyDown(event)"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
       <legend>SEARCH RESULT</legend>
            ...
            <div id="divGridViewScroll" style="width: 680px; height: 300px; overflow: scroll">
                            <table style="width: 100%">
            <tr>
                    ...
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           <%-- <asp:TemplateField HeaderText="SL">
                            ...
                            <asp:BoundField DataField="MACHINE_PARTS_ID" HeaderText="ID" Visible="True" />
                            ...
                            <asp:BoundField DataField="MACHINE_PARTS" HeaderText="PARTS" />
