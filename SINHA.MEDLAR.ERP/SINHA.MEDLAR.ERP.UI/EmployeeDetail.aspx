<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="EmployeeDetail.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmployeeDetail" %>
            ...
            <td colspan="2">
                <fieldset>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: right; " class="auto-style2">
                                &nbsp;<asp:Label ID="lblProductCataroy8" runat="server" Text="Confirm From :"></asp:Label>
                                &nbsp;
                            </td>
                            <td style="width: 167px; height: 22px;">
                            ...
                            <td style="height: 22px; text-align: right; width: 98px;">
                                <asp:Label ID="lblProductCataroy10" runat="server" Text="Confirm To :"></asp:Label>
                            </td>
                            <td style="height: 22px">
                                <asp:TextBox ID="dtpToConfirmDate" runat="server" Width="149px" placeHolder="CONFIRM DATE"
                                    CssClass="date" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; " class="auto-style2">
                                <asp:Label ID="lblProductCataroy11" runat="server" Text="Create From :"></asp:Label>
                            </td>
                            <td style="width: 167px; height: 22px;">
                            ...
                            <td style="height: 22px">
                                &nbsp;</td>
                            <td style="height: 22px; text-align: right; width: 98px;">
                                <asp:Label ID="lblProductCataroy12" runat="server" Text="Create To : "></asp:Label>
                            </td>
                            <td style="height: 22px">
                        ...
                        <tr>
                            <td style="text-align: right; " class="auto-style2">
                                <asp:Label ID="lblProductCataroy9" runat="server" Text="Employee Type : "></asp:Label>
                            </td>
                            <td style="width: 167px; height: 22px;">
                                <asp:DropDownList ID="ddlEmployeeTypeId" runat="server" Width="240px" Height="22px">
                                </asp:DropDownList>
                            </td>
                            <td style="height: 22px">
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <td style="width: 167px; height: 22px;">
                                <asp:TextBox ID="txtNIDNoSearch" runat="server" Width="238px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvEmployeeList" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ForeColor="#333333" AllowSorting="True" OnSorting="gvEmployeeList_Sorting" EnableViewState="true"
