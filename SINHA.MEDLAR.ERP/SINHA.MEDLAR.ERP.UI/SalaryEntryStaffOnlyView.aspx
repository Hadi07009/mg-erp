<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryEntryStaffOnlyView.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryEntryStaffOnlyView" %>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 288px; text-align: left;">
                                    <asp:TextBox ID="txtWorkingDay" runat="server" Width="130px" Height="20px" Enabled="false" onkeydown="javascript:TextName_OnKeyDown(event)"
                            ...
                            <tr>
                                ...
                                <td style="width: 288px; text-align: left;">
                                    <asp:TextBox ID="txtAdvanceFee" runat="server" Width="62px" Height="20px" Font-Bold="True" Enabled="false"
                            ...
                            <tr style="display:none;">
                                ...
                                <td style="height: 15px">
                                    <asp:TextBox ID="txtRemarks" runat="server" Width="385px" Height="20px" Font-Bold="True" Enabled="false" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="gvEmployeeList" runat="server" DataSourceID="" AutoGenerateColumns="False" DataKeyNames="EMPLOYEE_ID"
                        ...
                        <Columns>
                            <asp:BoundField DataField="SL" HeaderText="SL" HeaderStyle-Width="30" />
                            <asp:BoundField DataField="CARD_NO" HeaderText="CARD NO" HeaderStyle-Width="40"/>
                            ...
                            <asp:TemplateField HeaderText="HISTORY" ItemStyle-Width="1%" HeaderStyle-Width="40">
                                <ItemTemplate>
                                   <asp:ImageButton ID="btnHistoryX" runat="server" Text="History" ImageUrl="~/images/sheet.png"
                                        AlternateText="History" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                        Width="30px" CommandName="History"
                                        Height="25px" Visible="true" />
                                 </ItemTemplate>
