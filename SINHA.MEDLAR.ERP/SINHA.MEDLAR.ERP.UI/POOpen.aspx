<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="POOpen.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.POOpen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>PO OPEN INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 336px;">
                                    <asp:Label ID="lblPONo0" runat="server" Text="PO No :"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="height: 19px">
                    ...
                    <asp:Button ID="btnSearch" runat="server" CssClass="styled-button-4" 
                        Height="31px"  Text="Search" Width="66px" OnClick="btnSearch_Click" />
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <%--<asp:GridView ID="gvPOOpenInfo" runat="server" DataSourceID="" 
                        AutoGenerateColumns="False" DataKeyNames="PO_NO, PO_OPEN_DATE"
                        GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                        AlternatingRowStyle-CssClass="alt" OnRowDataBound="OnRowDataBound"  
                       OnRowDeleting="gvPOOpenInfo_OnRowDeleting">
                        <Columns>
                            ...
                            <asp:BoundField DataField="PO_OPEN_DATE" HeaderText="PO Open DATE" />
                    ...
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="PO DATE">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtPODate" runat="server" Text='<%#Eval("PO_OPEN_DATE")%>'></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtPODate" runat="server" Text='<%#Eval("PO_OPEN_DATE")%>'></asp:TextBox>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblPODate" runat="server" Text='<%#Eval("PO_OPEN_DATE")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                           
                        </Columns>
                    </asp:GridView>
