<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddIncrementSetupMonthly.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddIncrementSetupMonthly" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 214px">
                    <asp:TextBox ID="txtIncrementYear" runat="server" Width="211px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 338px">
                    <asp:Label ID="lblId3" runat="server" Text="Month :"></asp:Label>
                </td>
                <td style="width: 214px">
                    <asp:DropDownList ID="ddlSalaryMonthId" runat="server" Width="211px" 
                        Height="22px">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
               <td style="text-align: right; width: 338px">
                ...
                <td style="height: 19px">
                    <asp:CheckBox ID="LockYn" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 338px">
                ...
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="lock_yn" HeaderText="Lock" />
                             <asp:BoundField DataField="INCREMENT_MONTH" HeaderText="MONTH" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn" />  
