<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddEmployeeType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddEmployeeType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(window).load(function () { document.getElementById("<%= txtEmployeeTypeId.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEmployeeTypeId" runat="server" Width="72px" 
            ...
            <tr>
                <td style="text-align: right; width: 337px">
                    <asp:Label ID="lblEmployeeName" runat="server" Text="Employee Type:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtEmployeeTypeName" runat="server" Width="236px" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvEmployeeType" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvEmployeeType_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvEmployeeType_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="EMPLOYEE_TYPE_ID" HeaderText="ID" />
