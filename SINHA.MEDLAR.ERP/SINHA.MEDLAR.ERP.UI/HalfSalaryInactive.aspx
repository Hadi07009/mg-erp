<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="HalfSalaryInactive.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.HalfSalaryInactive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>HALF SALARY INACTIVE</legend>
        <table class="style1">
            <tr>
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkEmployee" runat="server" AutoPostBack="False" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
