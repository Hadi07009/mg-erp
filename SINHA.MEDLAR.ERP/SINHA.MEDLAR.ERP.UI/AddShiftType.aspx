<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddShiftType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddShiftType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtShiftTypeName.ClientID %>").focus(); }) 
    </script>
    <table class="style1">
        <tr>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtShiftTypeId" runat="server" Width="107px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtShiftTypeName" runat="server" Width="227px" BackColor="White" Height="20px"
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SHIFT_TYPE_NAME" HeaderText="NAME" />
