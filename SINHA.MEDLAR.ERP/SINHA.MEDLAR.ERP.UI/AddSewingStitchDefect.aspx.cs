...
{
    public partial class AddSewingStitchDefect : System.Web.UI.Page
    {
       ...
       // string strUpdateDate = "";
        ...
        public void loadSewingStitchDefect()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadSewingStitchDefect(strHeadOfficeId, strBranchOfficeId);
        ...
        public void clear()
        {
            ...
            txtSewingStitchDefectId.Text = string.Empty;
            
            txtSewingStitchDefectName.Text = string.Empty;


        }
        public void saveSewingStitchDefect()
        {
            ...
            objLookUpDTO.SewingDefectEntryId = txtSewingStitchDefectId.Text;
            objLookUpDTO.SewingDefectEntryName= txtSewingStitchDefectName.Text;
            ...
            string strMsg = objLookUpBLL.saveSewingStitchDefect(objLookUpDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtSewingStitchDefectName.Text == "")
                {
                    string strMsg = "Please Enter Sewing Stitch Defect Name!!!";
                    MessageBox(strMsg);
                    return;
                }
                else
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtSewingStitchDefectId.Text = strSewingStitchDefectId;
            txtSewingStitchDefectName.Text = strSewingStitchDefectName;
