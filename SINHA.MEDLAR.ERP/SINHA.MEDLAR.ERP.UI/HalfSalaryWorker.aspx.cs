...
{
    public partial class HalfSalaryWorker : System.Web.UI.Page
    {
        ...
        protected void btnParcialSalaryBkashSheet_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlUnitGroupId.SelectedItem.Value == "")
        ...
        public void GetParcialBkashSalarySheet()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/RptParcialSalaryBkashSheetWorker.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetParcialSalarySheet(objReportDTO));
        ...
        protected void btnParcialSalaryCashSheet_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlUnitGroupId.SelectedItem.Value == "")
        ...
        public void GetParcialCashSalarySheet()
        {
        ...
        protected void btnParcialSalaryBkashReq_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlUnitGroupId.SelectedItem.Value == "")
        ...
        public void GetParcialSalaryBKashReq()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptParcialSalaryBKashReq.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalaryReq(objReportDTO));
        ...
        protected void btnParcialSalaryCashReq_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlUnitGroupId.SelectedItem.Value == "")
        ...
        public void GetParcialSalaryCashReq()
        {
        ...
        //By Asad
        protected void btnGetHalfSalarySummary_Click(object sender, EventArgs e)
        {
            try
            {

                if (string.IsNullOrEmpty(txtSalaryYear.Text))
                {
                    string strMsg = "Please Enter Month!!!";
                    MessageBox(strMsg);
                    txtsalaryMonth.Focus();
                ...
                if (string.IsNullOrEmpty(txtsalaryMonth.Text))
                {
                    string strMsg = "Please Enter Month!!!";
                    MessageBox(strMsg);
                    txtsalaryMonth.Focus();
        ...
        public void GetHalfSalarySummaryByBkash()
        {
            try
            {
                string strDefaultName = "Report";
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/RptHalfSalarySummaryByPaymentMode.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalarySummaryByPaymentMode(objReportDTO));
        ...
        public void GetHalfSalarySummaryByCash()
        {
            try
            {
                string strDefaultName = "Report";
        ...
        public void searchHalfSalaryInfoWorker()
        {
            ...
            dt = objEmployeeBLL.searchHalfSalaryInfoWorker(objEmployeeDTO);
        ...
        public void goToNextRecordAbove()
        {
            ...
            else
            {
                ...
                string strOverTimeHour = GridView1.SelectedRow.Cells[6].Text;
                string strOverTimeAmount = GridView1.SelectedRow.Cells[7].Text;
                ...
                txtOverTimeHour.Text = strOverTimeHour;
                txtOverTimeAmount.Text = strOverTimeAmount;
        ...
        public void goToPreviousRecordAbove()
        {
            int i = 1, j, k, result;
            j = Convert.ToInt32(txtSL.Text);
            k = j;
        ...
        public void saveHalfSalaryWorker()
        {
            ...
            string strMsg = objSalaryBLL.saveHalfSalaryWorker(objSalaryDTO);
            if (strMsg == "PLEASE CHECK WORKING DAY!!!")
            {
            ...
            else
            {
                ...
                clearTextBox();
                goToNextRecord();
                searcHalfSalaryEntryWorker();
                searchHalfSalaryInfoWorker();
        ...
        public void searcHalfSalaryEntryWorker()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            objSalaryDTO = objSalaryBLL.searcHalfSalaryEntryWorker(txtEmployeeId.Text, txtSalaryYear.Text, txtsalaryMonth.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);
            ...
            if (objSalaryDTO.OverTimeAmount == null || objSalaryDTO.OverTimeAmount == "0")
            {
            ...
            else
            {
                ...
                txtOverTimeAmount.Text = objSalaryDTO.OverTimeAmount;
            }
        ...
        public void rptHalfSalaryW()
        {
            ...
            try
            {
                ...
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.rptHalfSalaryW(objReportDTO));
        ...
        //By Asad
        public void GetHalfSalarySummary()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/RptHalfSalarySummaryForWorker.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalarySummaryForWorker(objReportDTO));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtWorkingDay.Text == string.Empty)
                {
                    //commented on 23.04.2022
                    saveHalfSalaryWorker();
        ...
        public void saveHalfSalaryAddWorker()
        {
            ...
            foreach (GridViewRow row in gvEmployeeList.Rows)
            {
                ...
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    string strMsg = objSalaryBLL.saveHalfSalaryAddWorker(objSalaryDTO);
                    //MessageBox(strMsg);
                    //lblMsg.Text = strMsg;
        ...
        public void deleteHalfSalaryAddWorker()
        {
            ...
            string strMsg = objSalaryBLL.deleteHalfSalaryAddWorker(objSalaryDTO);
            //MessageBox(strMsg);
            //lblMsg.Text = strMsg;

        }
        protected void btnBKashTemplate_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtSalaryYear.Text == string.Empty)
                ...
                GetWorkerHalfSalaryWalletSheet();
            }
        ...
        public void GetWorkerHalfSalaryWalletSheet()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptHalfSalaryWalletSheet.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalaryWalletSheet(objReportDTO));
        ...
        public void GetHalfSalaryWalletSheetAll()
        {
        ...
        public void GetHalfSalaryMasterReq()
        {
        ...
        public void GetHalfSalaryDFormReq()
        {
            try
            {
                string strDefaultName = "Report";
                ...
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalaryDFormReq(objReportDTO));
        ...
        public void GetHalfSalaryNonDFormReq()
        {
            try
            {
                string strDefaultName = "Report";
                ...
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalaryNonDFormReq(objReportDTO));
        ...
        public void GetHalfSalaryDFormWalletSheet()
        {
            ...
            try
            {
                ...
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalaryDFormWalletSheet(objReportDTO));
        ...
        protected void btnNonDformWallet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                GetHalfSalaryNonDFormWalletSheet();
            }
        ...
        public void GetHalfSalaryNonDFormWalletSheet()
        {
            ...
            try
            {
                ...
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.GetHalfSalaryNonDFormWalletSheet(objReportDTO));
