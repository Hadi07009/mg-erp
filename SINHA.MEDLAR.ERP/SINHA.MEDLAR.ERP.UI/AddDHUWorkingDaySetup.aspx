<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddDHUWorkingDaySetup.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddDHUWorkingDaySetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD WORKING DAY SETUP</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>WORKING DAY ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSalaryYear" runat="server" Width="65px" BackColor="Yellow" 
                                        Font-Bold="True"></asp:TextBox>
                                    <asp:TextBox ID="txtSalaryMonth" runat="server" Width="48px" MaxLength="300" BackColor="Yellow"
                            ...
                            <tr>
                                ...
                                <td style="height: 19px">
                                    <asp:TextBox ID="txtWorkingDay" runat="server" 
                                        onkeydown="javascript:TextName_OnKeyDown(event)" Width="122px" 
