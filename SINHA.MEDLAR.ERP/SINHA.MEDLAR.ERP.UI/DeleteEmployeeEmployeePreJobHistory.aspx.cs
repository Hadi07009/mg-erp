...
{
    public partial class DeleteEmployeeEmployeePreJobHistory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                clearMsg();
                getOfficeName();
                searchEmployeePreviousJobHistoryForDelete();
                btnSearch.Focus();
        ...
        public void searchEmployeePreviousJobHistoryForDelete()
        {
            ...
            dt = objEmployeeBLL.searchEmployeePreviousJobHistoryForDelete(objEmployeeDTO);
        ...
        public void DeleteEmpEmployeePreJobHistory()
        {
            EmployeeDTO objEmployeeDTO = new EmployeeDTO();
            EmployeeBLL objEmployeeBLL = new EmployeeBLL();
            ...
            string strMsg = objEmployeeBLL.DeleteEmployeePreviousJobHistory(objEmployeeDTO);
            MessageBox(strMsg);
        ...
        public void goToNextRecord()
        {
            ...
            else
            {
                ...
                string strOrganization = gvEmployeeList.SelectedRow.Cells[6].Text;
                string strSection = gvEmployeeList.SelectedRow.Cells[7].Text;
                ...
                txtOrganizationName.Text = strOrganization;
                txtSectionName.Text = strSection;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DeleteEmpEmployeePreJobHistory();
                    searchEmployeePreviousJobHistoryForDelete();
                    clearTextBox();
                    clearYellowTextBox();
