<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="MFSTemplateEidBomus.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.MFSTemplateEidBomus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend style="text-align:left; font-size:15px;" >MFS TEMPLATE- EID BONUS</legend>
        <table class="style1">
	...
	CssClass="styled-button-4" OnClick="BtnPaymentHold_Click" style="text-align:center;"/>
            ...
            <tr>
               ...
               <asp:TextBox ID="txtSalaryYear" runat="server" Width="117px" Height="22px" 
            ...
            <tr>
               <td style="width: 100px; text-align:right;"> 
               <asp:Label ID="Label20" runat="server" Text="Eid Type :" Width="100px" Height="22"></asp:Label>   
                </td>
               <td style="width: 300px">
               <asp:DropDownList ID="ddlEidTypeId" runat="server" Width="180px" Height="28px">
               </asp:DropDownList>
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="Unit" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                            ...
                            <%--<asp:TemplateField HeaderText="payment_type_id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                               <ItemTemplate>
                                    <asp:TextBox ID="txtpayment_type_id" runat="server" Text='<%#Eval("payment_phase_source")%>' ReadOnly="true"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="eid_type_id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn">
                               <ItemTemplate>
                                    <asp:TextBox ID="txteid_type_id" runat="server" Text='<%#Eval("payment_phase_source")%>' ReadOnly="true"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                    ...
                    <asp:GridView ID="gvEmployeeList" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="SL" HeaderText="SL" ItemStyle-Width="30px"/>
                             ...
                             <asp:BoundField DataField="SECTION_NAME" HeaderText="SECTION" ItemStyle-Width="150px"/>
                            <asp:BoundField DataField="SECTION_NAME" HeaderText="EMP_COUNT" ItemStyle-Width="150px"/>
