<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="JobCardWH.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.JobCardWH" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
     <table style="width: 100%">
         ...
         <tr>
             <td colspan="2">
                 <asp:GridView ID="grdWorkingHours" runat="server" CssClass="mGrid" Width="100%">
