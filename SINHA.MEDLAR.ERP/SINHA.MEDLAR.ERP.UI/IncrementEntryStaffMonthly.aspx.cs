...
{
    public partial class IncrementEntryStaffMonthly : System.Web.UI.Page
    {
        ...
        public void getYearForIncrementProposal()
        {
            ...
            txtIncrementMonth.Text = objLookUpDTO.Month;
        ...
        public void searchStaffRecordForIncrement()
        {
            ...
            dt = objEmployeeBLL.searchStaffRecordForIncrementMonthly(objEmployeeDTO);
        ...
        public void searchIncrementEntryStaff()
        {
            ...
            dt = objEmployeeBLL.searchIncrementEntryStaffMonthly(objEmployeeDTO);
        ...
        public void saveIncrementStaff()
        {
            ...
            objSalaryDTO.EffectiveDate = dtpYearlyIncEffectDate.Text;

            if(chkYearlyIncrement.Checked==true)
            {
                objSalaryDTO.YearlyIncYesOrNot = "Y";
            }
            else
            {
                objSalaryDTO.YearlyIncYesOrNot = "N";
            }
            ...
            string strMsg = objSalaryBLL.saveIncrementStaffMonthly(objSalaryDTO);
        }
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "increment_sheet_staff_annual");
        ...
        public void processIncrementAmountToGrossStaff()
        {
            ...
            objReportDTO.Year = txtIncrementYear.Text;
            objReportDTO.Month = txtIncrementMonth.Text;
            ...
            objReportDTO.BranchOfficeId = strBranchOfficeId;
            objReportDTO.UpdateBy = strEmployeeId;
            string strMsg = objReportBLL.processIncrementAmountToGrossStaffMonthly(objReportDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
            ...
            foreach (GridViewRow row in gvEmployeeList.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                        ...
                        objSalaryDTO.BranchOfficeId = strBranchOfficeId;
                         ...
                         strMsg = objSalaryBLL.addStaffIncrementMonthly(objSalaryDTO);
        ...
        public void searchStaffIncrementEntry()
        {
            ...
            objSalaryDTO = objSalaryBLL.searchStaffIncrementEntryMonthly(txtEmployeeId.Text, txtIncrementYear.Text, txtIncrementMonth.Text,  strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);
        ...
        protected void btnIncrementMonthlyStaffProposalSheet_Click(object sender, EventArgs e)
        {
