<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="SalaryMasterStaff.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryMasterStaff" %>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 288px; text-align: left;">
                                    <asp:TextBox ID="txtAdvanceFee" runat="server" Width="62px" Height="20px" Font-Bold="True"
                                        onkeydown="javascript:TextName_OnKeyDown(event)" ForeColor="Red" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRemarks" runat="server" Width="400px" Height="20px" Font-Bold="True" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    <asp:Button ID="btnAdd" runat="server" Height="31px" Text="ATTEN." CssClass="styled-button-4"
                                        Width="51px" OnClick="btnAdd_Click" />
                ...
                <td colspan="2">
                    <fieldset>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GvSalaryMasterStaff" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        CausesValidation="false" OnRowDataBound="GvSalaryMasterStaff_OnRowDataBound" AllowSorting="True"
                                        EnableViewState="true" GridLines="None" AllowPaging="false" OnRowEditing="GvSalaryMasterStaff_OnRowEditing"
                                        CssClass="mGrid" PagerStyle-CssClass="pgr" OnSelectedIndexChanged="GvSalaryMasterStaff_OnSelectedIndexChanged"
                                        OnRowCommand="GvSalaryMasterStaff_RowCommand" AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="GvSalaryMasterStaff_PageIndexChanging">
                                        <Columns>
