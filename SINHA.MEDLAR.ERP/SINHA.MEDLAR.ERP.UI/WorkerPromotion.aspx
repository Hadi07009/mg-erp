<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="WorkerPromotion.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.WorkerPromotion" %>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtYear" runat="server" Width="175px" Height="20px" 
                                        Font-Bold="True"></asp:TextBox>
                                    <asp:TextBox ID="txtMonth" runat="server" Width="58px" Height="20px" 
                                        Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="width: 247px; text-align: right;">
                                    &nbsp;
                            ...
                            <tr>
                                <td style="text-align: center; height: 22px;" colspan="4">
                                    ...
                                    <asp:Button ID="btnAdd" runat="server" Height="31px" Text="Add" Width="66px"
