<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="IdCardProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.IdCardProcess" %>
                            ...
                            <tr>
                                <td style="text-align: right">
                                    <table class="style1">
                                        ...
                                        <tr>
                                            <td style="width: 254px; text-align: right">
                                                <asp:Label ID="Label41" runat="server" Text="Issue Date :"></asp:Label>
                                                </td>
                                            <td style="width: 163px">
                                        <asp:TextBox ID="dtpIssueDate" runat="server" Width="236px" BackColor="white"
                                            ...
                                            <td style="text-align: right; width: 81px">
                                                Is Issue :</td>
                                            <td>
                                                <asp:CheckBox ID="chkIsIssued" runat="server" Width="180px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 254px; text-align: right">
                                        ...
                                        <tr>
                                            ...
                                            <asp:Button ID="btnSearch" runat="server" Height="31px" Text="Search" Width="66px"
                                                ...
                                                <asp:Button ID="btnProcess" runat="server" Height="31px" Text="Sheet" Width="66px"
                                            ...
                                            <td style="width: 66px">
                                                <asp:Button ID="BtnIssueCase" runat="server" Height="31px" Text="Issue Case" Width="80px" BackColor="Red"
                                                    OnClick="BtnIssueCase_Click" CssClass="styled-button-4" Visible="false" />

                                                                                             &nbsp;
                                            </td>
                                            <td style="text-align: right; width: 81px">
                                                <asp:Button ID="btnCaseSheet" runat="server" Height="31px" Text="Case Sheet" Width="80px" BackColor="Red"
                                                    OnClick="btnCaseSheet_Click" CssClass="styled-button-4" Visible="false"/>
                                                   &nbsp;

                                            </td>
                                            <td>
                                                <asp:Button ID="BtnReorderCase" runat="server" Height="31px" Text="Re-Order" Width="80px" BackColor="Red"
                                                    OnClick="BtnReorderCase_Click" CssClass="styled-button-4" Visible="false"/>
                                             
                                               <asp:Button ID="BtnSearchCaseOnly" runat="server" Height="31px" Text="Search Case Only" Width="150px" BackColor="Red"
                                                    OnClick="BtnSearchCaseOnly_Click" CssClass="styled-button-4" Visible="false"/>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GridViewCaseInfo" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        OnPageIndexChanging="GridViewCaseInfo_PageIndexChanging">
                                        <Columns>
