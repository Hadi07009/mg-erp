<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ...
    CodeBehind="SalaryCheckProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SalaryCheckProcess" %>
                                            ...
                                            <td colspan="2">
                                                <asp:GridView ID="gvSalaryAprovedEmpList" runat="server" DataSourceID=""
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="INCREMENT_AMOUNT" HeaderText="Five(%)" />
                                                        <asp:BoundField DataField="MANUAL_INCREMENT_AMOUNT" HeaderText="INC. AMT" />
                                                        ...
                                                        <asp:BoundField DataField="occurence_type_name" HeaderText="TYPE" />
                                                         <asp:BoundField DataField="CHECKED_STATUS" HeaderText="STATUS" />
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UNIT_NAME" HeaderText="UNIT" />
                                            <asp:BoundField DataField="SECTION_NAME" HeaderText="SECTION" />
                                            <asp:BoundField DataField="FIRST_SALARY_PRE" HeaderText="FIRST SALARY" />
                                           
                                            <asp:BoundField DataField="GROSS_SALARY_PRE" HeaderText="GROSS SALARY" />
