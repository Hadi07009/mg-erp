<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddArrearLockSetup.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddArrearLockSetup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtArrearYear.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD ARREAR LOCK INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>ARREAR LOCK ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtArrearYear" runat="server" Width="144px" BackColor="Yellow"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                            </tr>
                    ...
                    <asp:DropDownList ID="ddlBranchOfficeId" runat="server" Width="150px" Height="22px">
                            ...
                            <tr>
                                            ...
                                            <td style="width: 292px; text-align: left;">
                                                <asp:DropDownList ID="ddlFromMonthId" runat="server" Width="150px" Height="22px">
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 292px; text-align: left;">
                                                <asp:DropDownList ID="ddlToMonthId" runat="server" Width="150px" Height="22px">
                                                </asp:DropDownList>
                                                &nbsp;
                                            </td>
                                            <td style="width: 74px; text-align: right;">&nbsp;
                ...
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ARREAR_YEAR" HeaderText="YEAR" Visible="True" />
                             <asp:BoundField DataField="FROM_MONTH_NAME" HeaderText="FROM MONTH" Visible="True" />
                            <asp:BoundField DataField="TO_MONTH_NAME" HeaderText="TO MONTH" Visible="True" />
                            ...
                            <asp:BoundField DataField="LOCK_ID" HeaderText="LOCK ID" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn" />
                            <asp:BoundField DataField="arrear_from_month_id" HeaderText="from month id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn" />
                            <asp:BoundField DataField="arrear_to_month_id" HeaderText="to month id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
