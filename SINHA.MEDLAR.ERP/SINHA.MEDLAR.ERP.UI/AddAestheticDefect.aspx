<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddAestheticDefect.aspx.cs" EnableEventValidation="false" Inherits="SINHA.MEDLAR.ERP.UI.AddAestheticDefect" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtAestheticDefectName.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD AESTHETIC DEFECT</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAestheticDefectId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td>&nbsp;
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAestheticDefectName" runat="server" Width="236px" BackColor="White"
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="Aesthetic_Defect_ID" HeaderText="ID" />
                            <asp:BoundField DataField="Aesthetic_Defect_NAME" HeaderText="NAME" />
