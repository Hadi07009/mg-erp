...
<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="EmploymentApproval.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmploymentApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>Employment Approval</legend>
        <table class="style1">
            <tr>
            ...
            <tr>
             <td colspan="5">
                ...
                <asp:BoundField DataField="employee_name_bangla" HeaderText="Name (Bng)" ItemStyle-Width="120" ControlStyle-Font-Names ="KarnaphuliMJ">
                    <ItemStyle Font-Names="KarnaphuliMJ" Font-Size="12pt"/>
                </asp:BoundField>

                <asp:BoundField DataField="card_no" HeaderText="Card No" ItemStyle-Width="80" />
                <asp:BoundField DataField="employee_id" HeaderText="ID" ItemStyle-Width="90" />                                             

                <asp:BoundField DataField="designation_name" HeaderText="Designation" ItemStyle-Width="100" />
                <asp:BoundField DataField="joining_date" HeaderText="Joining Date" ItemStyle-Width="90" />
                <asp:BoundField DataField="create_date" HeaderText="Entry Date" ItemStyle-Width="90" />                                       
                <asp:BoundField DataField="approve_date" HeaderText="Approve Date" ItemStyle-Width="90" />                                       
                
                <asp:BoundField DataField="unit_name" HeaderText="Unit" ItemStyle-Width="200" />
                <asp:BoundField DataField="section_name" HeaderText="Section" ItemStyle-Width="150" />
                <asp:BoundField DataField="approve_yn" HeaderText="Approve?" ItemStyle-Width="60" />
                <asp:BoundField DataField="recognize_yn" HeaderText="Recognize?" ItemStyle-Width="60" />            
                
                <asp:TemplateField HeaderText="DELETE" ItemStyle-Width="1%" >
                     <ItemTemplate>
                         <asp:ImageButton ID="btnDelete" runat="server" Text="Delete" ImageUrl="~/images/del.png" 
                             AlternateText="Delete" CommandArgument="<%# Container.DataItemIndex %>"
                             Width="30px" CommandName="Delete" OnClientClick="return isDelete();"
                             Height="25px" Visible="true" />
                     </ItemTemplate>
               </asp:TemplateField>

               <asp:TemplateField HeaderText="APPROVE" ItemStyle-Width="1%">
                     <ItemTemplate>
                         <asp:ImageButton ID="btnApprove" runat="server" Text="Approve" ImageUrl="~/images/approve.png"
                             AlternateText="Approve" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                             Width="30px" CommandName="Approve" OnClientClick="return isApprove();"
                             Height="25px" Visible="true" />
                     </ItemTemplate>
               </asp:TemplateField>
