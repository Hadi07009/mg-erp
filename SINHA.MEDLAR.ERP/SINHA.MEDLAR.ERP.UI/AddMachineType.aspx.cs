...
{
    public partial class AddMachineType : System.Web.UI.Page
    {
        ...
        public void loadMachineTypeRecord()
        {
            ...
            dt = objLookUpBLL.loadMachineTypeRecord();
        ...
        public void clearTextBox()
        {
            ...
            txtMachineTypeName.Text = string.Empty;

        }

        public void saveMachineTypeInfo()
        {
            ...
            objWokerProcessDTO.MachineType = txtMachineTypeName.Text;
            ...
            string strMsg = objWorkerProcessBLL.saveMachineTypeInfo(objWokerProcessDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
