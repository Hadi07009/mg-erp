<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="Tax.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.Tax" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
     ...
     <script language="javascript">
         $(window).load(function () { document.getElementById("<%= txtTaxFee.ClientID %>").focus(); }) 
    </script>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        ...
                        <table class="style1">
                            <tr>
                                <td style="width: 376px; text-align: right">
                                    <asp:Label ID="Label42" runat="server" Text="ID :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtEmployeeId" runat="server" Width="269px" Height="20px" ReadOnly="True"
                            ...
                            <tr>
                                ...
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtYear" runat="server" Width="77px" Height="20px" 
                            ...
                            <tr>
                                <td style="width: 376px; text-align: right">
                                    <asp:Label ID="Label27" runat="server" Text="Tax Fee :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtTaxFee" runat="server" Width="130px" Height="20px" Font-Bold="True" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                            ...
                            <tr>
                                <td style="width: 376px; text-align: right; height: 15px;">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td style="text-align: center; height: 15px;" colspan="4">
                                    ...
                                    <asp:Button ID="btnProcess" runat="server" Height="31px" Text="Process" Width="66px"  CssClass = "styled-button-4"
                                        OnClick="btnProcess_Click" />
                                    <asp:Button ID="btnTaxSheet" runat="server" Height="31px" Text="Sheet"   CssClass = "styled-button-4"
                                        Width="66px" onclick="btnTaxSheet_Click"
                                       />
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right" colspan="4">
                                    <fieldset>
                                        ...
                                        <table class="style1">
                                            <tr>
                                                <td style="width: 362px; text-align: right">
                                        ...
                                        <td colspan="2">
                                            <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="TAX_FEE" HeaderText="TAX FEE" />
