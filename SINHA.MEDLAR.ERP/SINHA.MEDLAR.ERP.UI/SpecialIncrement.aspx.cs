...
{
    //public partial class SpecialIncrement : System.Web.UI.Page
    //{
    ...
    public partial class SpecialIncrement : System.Web.UI.Page
    {
        ...
        public void GetSpecialIncrement()
        {
            ...
            //objEmployeeDTO.IncrementLimit = txtIncrementAmountLimit.Text.Trim();
        ...
        public void GetSpecialIncrementAmountByEmployeeId()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            decimal incrementAmount = objSalaryBLL.GetSpecialIncrementAmountByEmployeeId(objSalaryDTO);
            ...
            {
                txtIncrementAmount.Text = Convert.ToString(incrementAmount);
            }
        }
        ...
        public void goToNextRecord()
        {
            ...
            else
            {
                ...
                GetSpecialIncrementAmountByEmployeeId();
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "increment_sheet_worker_monthly");
        ...
        public void ProcessSpecialIncrement()
        {
            ...
            string strMsg = objSalaryBLL.ProcessSpecialIncrement(objSalaryDTO);
            lblMsg.Text = strMsg;
        }
