...
{
    public partial class AddDHUWorkingDaySetup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtSalaryMonth.Attributes.Add("onkeypress", "return controlEnter('" + txtWorkingDay.ClientID + "', event)");
            txtWorkingDay.Attributes.Add("onkeypress", "return controlEnter('" + btnSave.ClientID + "', event)");
        ...
        public void loadDHUWorkingDaySetup()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadDHUWorkingDaySetup(txtSalaryYear.Text, txtSalaryMonth.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveDHUWorkingDaySetup()
        {
            ...
            objLookUpDTO.WorkingDay = txtWorkingDay.Text;
            ...
            string strMsg = objLookUpBLL.saveDHUWorkingDaySetup(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
