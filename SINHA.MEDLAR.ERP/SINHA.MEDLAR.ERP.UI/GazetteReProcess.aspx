<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="GazetteReProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.GazetteReProcess" %>
                            ...
                            <tr>
                                <td style="text-align: right" colspan="4">
                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right" class="auto-style3">
                                                    <asp:Label ID="Label35" runat="server" Text="Arrear:"></asp:Label>
                                                    &nbsp;
                                                </td>
                                                <td style="width: 163px">
                                            ...
                                            <tr>
                                              ...
                                              <td style="text-align: right;" class="auto-style7">
                                                    <asp:Label ID="Label40" runat="server" Text="Arrear Month :"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;" class="auto-style7">
                                                    <asp:Label ID="lblIncrementYear" runat="server" Text="Increment Year :"></asp:Label>
                                                </td>
                                                <td class="auto-style7">
                                                    <asp:TextBox ID="txtIncrementYear" runat="server" Width="235px" BackColor="White"></asp:TextBox>
                                                </td>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <td style="text-align: right;" class="auto-style7">
                                                    <asp:Label ID="lblIncrementMonth" runat="server" Text="Increment Month :"></asp:Label>
                                                </td>
                                                <td class="auto-style7">
                                                    <asp:DropDownList ID="ddlIncrementMonth" runat="server" Width="240px" Height="22px">
                                                    </asp:DropDownList>
                                                </td>
                              ...
                              <tr>
                                ...
                                <td style="text-align: left" colspan="4">
                                    ...
                                    <asp:Button ID="btnAnalyze" runat="server" Height="31px" Text="Analyze" Width="66px"
                                        CssClass="styled-button-4" OnClick="btnAnalyze_Click" />
                                    ...
                                    <asp:Button ID="btnReqSummary" runat="server" Height="31px" Text="Summary" Width="80px"
                                        CssClass="styled-button-4" OnClick="btnReqSummary_Click"/>
                                    <asp:Button ID="btnIncrementSheet" runat="server" Height="31px" Text="Increment Detail" Width="110px"
                                        CssClass="styled-button-4" OnClick="btnIncrementSheet_Click" />
                                    <asp:Button ID="btnIncrementRequisition" runat="server" Height="31px" Text="Increment requisition" Width="130px"
                                        CssClass="styled-button-4" OnClick="btnIncrementRequisition_Click" />
                                    <asp:Button ID="btnIncrementSummary" runat="server" Height="31px" Text="Increment Summary" Width="130px"
                                        CssClass="styled-button-4" OnClick="btnIncrementSummary_Click" />
