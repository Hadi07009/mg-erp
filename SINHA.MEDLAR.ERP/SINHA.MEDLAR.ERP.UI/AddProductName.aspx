<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddProductName.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddProductName" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtProductId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtProductName" runat="server" Width="236px" BackColor="White" Height="20px"
