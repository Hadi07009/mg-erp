...
{
    public partial class MFSTemplateEidBomus : System.Web.UI.Page
    {
        private const string paymentTypeId = "3";
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox("Please select Eid Type");
                return;
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //    return;
            //}
            if (ddlEidTypeId.SelectedItem.Value == string.Empty)
            {
                MessageBox("Please Select Eid Type");
                ddlEidTypeId.Focus();
                return;
