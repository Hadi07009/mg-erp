<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddCurrency.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddCurrency" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtCurrencyName.ClientID %>").focus(); }) 
    </script>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtCurrencyId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Currency :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCurrencyName" runat="server" Width="236px" BackColor="White"
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="CURRENCY_ID" HeaderText="ID" />
