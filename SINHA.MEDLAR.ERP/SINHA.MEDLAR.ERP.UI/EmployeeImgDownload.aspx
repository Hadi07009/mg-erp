<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="EmployeeImgDownload.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmployeeImgDownload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>EMPLOYEE IMAGE DOWNLOAD</legend>
        <table class="style1">
            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        DataKeyNames="EMPLOYEE_ID" OnRowDataBound="GridView1_OnRowDataBound" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Image">
                                                <ItemTemplate>
                                                    <asp:Image ID="ImageEmployee" runat="server" Height="40" Width="40" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                         <%--   <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="DownloadBtn" runat="server" CommandName="Download" OnClick="DownloadDocument">Download</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("employee_id", "ImageDownload.ashx?employee_id={0}") %>'
