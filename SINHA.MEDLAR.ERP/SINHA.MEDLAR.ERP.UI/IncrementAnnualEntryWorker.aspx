<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="IncrementAnnualEntryWorker.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.IncrementAnnualEntryWorker" %>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 191px; text-align: left;">
                                    ...
                                    <asp:TextBox ID="txtIncrementAmount2ndTerm" runat="server" Width="80px" Height="20px" Visible="false"
                                        onkeydown="javascript:TextName_OnKeyDown(event)" Font-Bold="True" ></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="width: 269px; text-align: left;">
                                    ...
                                    <asp:TextBox ID="txtGrossSalary" runat="server" Width="80px" Height="20px" defaultfocus="txtWorkingDay"
                                        Font-Bold="True" BackColor="Yellow" ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox ID="txtProposesGross" runat="server" Width="80px" Height="20px"
                                        Font-Bold="True" BackColor="Yellow" ReadOnly="True"></asp:TextBox>
                                    &nbsp;
                                </td>
                                <td style="text-align: right; width: 100px;">
                                ...
                                <td>
                                    <asp:TextBox ID="dtpFromDate" runat="server" Width="156px" BackColor="White" CssClass="date"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="dtpToDate" runat="server" Width="156px" BackColor="White" CssClass="date"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align: center" colspan="4">
                                    ...
                                    <asp:Button ID="btnIncrementSheetByRequisition" runat="server" Height="31px" 
                                        Text="Sheet By Unit" Width="100px"
                                        CssClass="styled-button-4" 
                                        OnClick="btnIncrementSheetByRequisition_Click"  />
                                    ...
                                    <asp:Button ID="btnIncrementSheetByUnitGroup" runat="server" Height="31px" 
                                        Text="Requisition (UG)" Width="105px"
                                        CssClass="styled-button-4" 
                                        OnClick="btnIncrementSheetByUnitGroup_Click"  />
                                    <asp:Button ID="btnIncrementDetail" runat="server" Height="31px" Text="Detail" Width="80px"
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="GROSS_SALARY" HeaderText="P. GROSS" />

                                            <asp:BoundField DataField="TOTAL_5_PERCENT" HeaderText="5PERCENT" ItemStyle-Width="40px" />

                                            <asp:BoundField DataField="INCREMENT_AMOUNT" HeaderText="INC." ItemStyle-Width="20px"/>
                                            <asp:BoundField DataField="increment_amount_2nd_term" HeaderText="INC(2nd)" ItemStyle-Width="20px"/>

                                            <%--9--%>
                                            <asp:BoundField DataField="proposed_gross_salary" HeaderText="PROP. GROSS" ItemStyle-Width="20px"/>

                                            <asp:BoundField DataField="current_gross" HeaderText="C. GORSS" />
                                            <asp:BoundField DataField="EMPLOYEE_ID" HeaderText="ID" />
                                            <asp:BoundField DataField="FINALIZED_YN" HeaderText="Status" />
                ...
                <td colspan="2">
                    <asp:GridView ID="gvEmployeeList" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TOTAL_5_PERCENT" HeaderText="Auto Increment" />
