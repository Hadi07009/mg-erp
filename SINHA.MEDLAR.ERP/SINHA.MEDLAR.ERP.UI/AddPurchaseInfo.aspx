<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddPurchaseInfo.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddPurchaseInfo" %>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtIssuedBy" runat="server" Width="236px" BackColor="White" onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvPurchaseInfo" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvPurchaseInfo_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvPurchaseInfo_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="PURCHASE_ID" HeaderText="ID" />
                    <asp:BoundField DataField="PURCHASE_OFFICE_NAME" HeaderText="NAME" />
                    ...
                    <asp:BoundField DataField="ISSUED_BY" HeaderText="ISSUED.BY" />
