    ...
    public partial class AddItem : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtItemName.Text == string.Empty)
            {
                ...
                string strMsg = "Please Enter Item Name!!!";
                MessageBox(strMsg);
        ...
        public void saveItemInfo()
        {
            ...
            objLookUpDTO.ItemId = txtItemId.Text;
            objLookUpDTO.ItemName = txtItemName.Text;
            ...
            string strMsg = objLookUpBLL.saveItemInfo(objLookUpDTO);
            MessageBox(strMsg);
        ...
        public void searchItemInfo()
        {
            ...
            objLookUpDTO = objLookUpBLL.searchItemInfo(txtItemId.Text, strHeadOfficeId, strBranchOfficeId);

            txtItemId.Text = objLookUpDTO.ItemId;
            txtItemName.Text = objLookUpDTO.ItemName;


        }

        public void loadItemRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadItemRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (txtItemId.Text == string.Empty)
            {
                ...
                string strMsg = "Please Enter Item ID!!!";
                MessageBox(strMsg);
                txtItemId.Focus();
                return;
            }
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtItemId.Text = strUnitId;
            txtItemName.Text = strUnitName;
