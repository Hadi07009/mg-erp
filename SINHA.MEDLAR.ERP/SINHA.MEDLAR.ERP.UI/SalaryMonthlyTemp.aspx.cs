...
{
    public partial class SalaryMonthlyTemp : System.Web.UI.Page
    {
        ...
        public void searchSalaryInfoTemp()
        {
            ...
            dt = objEmployeeBLL.searchSalaryInfoTemp(objEmployeeDTO);
        ...
        public void processMonthlySalaryTemp()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            string strMsg = objSalaryBLL.processMonthlySalaryTemp(objSalaryDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        public void searchEmployeeRecordforTemp()
        {
            ...
            dt = objEmployeeBLL.searchEmployeeRecordforTemp(objEmployeeDTO);
        ...
        public void saveSalaryEntryTempSave()
        {
            ...
            string strMsg = objSalaryBLL.saveSalaryEntryTempSave(objSalaryDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
            txtWorkingDay.Focus();
            ...
            else
            {
                ...
                clearTextBox();
                goToNextRecord();
                searchSalaryEntryTemp();
                searchSalaryInfoTemp();
        ...
        public void searchSalaryEntryTemp()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            objSalaryDTO = objSalaryBLL.searchSalaryEntryTemp(txtEmployeeId.Text, txtSalaryYear.Text, txtsalaryMonth.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);
        ...
        public void monthlySalaryWorkerSheetTemp()
        {
            ...
            try
            {
                ...
                if (strBranchOfficeId == "110")
                {
                    ...
                    string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetWorkerBPTemp.rpt"));
                    this.Context.Session["strReportPath"] = strPath;
                    rd.Load(strPath);
                    rd.SetDataSource(objReportBLL.monthlySalaryWorkerSheetTemp(objReportDTO));

                }
                else
                {

                    string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetWorkerTemp.rpt"));
                    this.Context.Session["strReportPath"] = strPath;
                    rd.Load(strPath);
                    rd.SetDataSource(objReportBLL.monthlySalaryWorkerSheetTemp(objReportDTO));
        ...
        public void monthlySalaryStaffSheetTemp()
        {
            ...
            try
            {
                ...
                if (strBranchOfficeId == "110")
                {
                    string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetStaffBPTemp.rpt"));
                    rd.Load(strPath);
                    rd.SetDataSource(objReportBLL.monthlySalaryStaffSheetTemp(objReportDTO));
                }

                else
                {

                    string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetStaffTemp.rpt"));
                    this.Context.Session["strReportPath"] = strPath;
                    rd.Load(strPath);
                    rd.SetDataSource(objReportBLL.monthlySalaryStaffSheetTemp(objReportDTO));
                }
