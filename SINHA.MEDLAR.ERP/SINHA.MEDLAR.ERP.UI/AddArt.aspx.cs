...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddArt : System.Web.UI.Page
    {
        ...
        public void loadArtRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadArtRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveArtInfo()
        {

            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            objLookUpDTO.ArtId = txtArtId.Text;
            objLookUpDTO.ArtNo = txtArtName.Text;
            ...
            string strMsg = objLookUpBLL.saveArtInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        public void deleteArtInfo()
        {
            ...
            string strMsg = objLookUpBLL.deleteArtInfo(objLookUpDTO);
            lblMsg.Text = strMsg;
            //MessageBox(strMsg);
        ...
        {
            if (txtArtName.Text == string.Empty)
            {
                string strMsg = "Please Enter Art No!!!";
                txtArtName.Focus();
                MessageBox(strMsg);
                return;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtArtId.Text = strCourseId;
            txtArtName.Text = strcourseName;
