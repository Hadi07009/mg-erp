<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="EmployeeInfoUpdate.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmployeeInfoUpdate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type='text/javascript'>
        ...
        //  <a href="EmployeeInfoUpdate.aspx">EmployeeInfoUpdate.aspx</a>          dataType: "json",
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 247px">
                    <asp:TextBox ID="txtCardNo" runat="server" Width="211px"  BackColor="#CCCCCC" Font-Bold="True" ReadOnly="true"
                ...
                <td>
                    <asp:TextBox ID="txtPunchCode" runat="server" Width="211px" BackColor="#CCCCCC" OnTextChanged="txtEmployeeName2_TextChanged" Enabled="false"
            ...
            <tr>
                ...
                <td style="width: 247px">
                    <asp:TextBox ID="txtEmployeeName" runat="server" Width="211px" BackColor="#CCCCCC" ReadOnly="true"
            ...
            <tr>
                ...
                <td style="height: 5px; text-align: right; width: 108px;">
              ...
              <tr>
                <td style="text-align: right; width: 247px; height: 3px">
                    <asp:Label ID="lblBKashNo" runat="server" Text="Bkash No :" Visible="false"></asp:Label>
                </td>
                <td style="height: 3px; width: 247px;">
                    <asp:TextBox ID="txtBKashNo" runat="server" Width="211px" BackColor="White" Visible="false"  Font-Bold="True"></asp:TextBox>
                </td>
                <td style="height: 3px; text-align: right; width: 108px;">
                    <asp:Label ID="lblRocketNo" runat="server" Text="Rocket No :" Visible="false"></asp:Label>
                </td>
                <td style="height: 3px">
            ...
            <tr>
                ...
                <td style="height: 19px; text-align: right; width: 108px;">
                    <asp:Label ID="lblMaritalStatus0" runat="server" Text="Religion :"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:DropDownList ID="ddlReligionId" runat="server" Width="215px" Height="22px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                    <asp:Label ID="lblFirstSalary" runat="server" Text="First Salary :" Visible="false"></asp:Label>
                </td>
                <td style="height: 19px; width: 247px;">
                    <asp:TextBox ID="txtFirstSalary" runat="server" Width="211px" BackColor="White" OnTextChanged="txtEmployeeName2_TextChanged" Visible="false"
            ...
            <tr>
             ...
             <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                    <asp:Label ID="lblCompany0" runat="server" Text="Company :"></asp:Label>
                 </td>
                <td style="height: 19px; text-align:left">
                    <asp:DropDownList ID="ddlCompanyId" runat="server" Width="215px" Height="22px" BackColor="#CCCCCC" Enabled="false"> </asp:DropDownList>
                </td>
                                                 
                <td style="height: 19px; text-align: right; width: 108px;">
                    <asp:Label ID="lblIdcardNo0" runat="server" Text="Id Card No :" Visible="false"></asp:Label>
                 </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtIdCardNo" runat="server" Width="211px" BackColor="White" Visible="false" 
                        Font-Bold="True"></asp:TextBox>
                 </td>
            ...
            <tr>
                ...
                <td style="height: 19px;" colspan="3">
                    ...
                    <asp:Button ID="BtnUpdateEmployeeInfo1" runat="server" Height="31px" Text="Update" Width="66px" CssClass="styled-button-4"
                        OnClick="BtnUpdateEmployeeInfo1_Click" />

                    <asp:Button ID="Button2" runat="server" Height="31px" Text="Clear" Width="60px"
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:DropDownList ID="ddlJobTypeId" runat="server" Width="215px" Height="22px" BackColor="#CCCCCC" Enabled="false"> 
                    </asp:DropDownList>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
            ...
            <tr>
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:TextBox ID="dtpJoiningDate" runat="server" Width="211px" BackColor="#CCCCCC" Enabled="false"
                        CssClass="date"></asp:TextBox>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="dtpOrderDate" runat="server" Width="211px" BackColor="#CCCCCC" CssClass="date" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:TextBox ID="dtpEffectiveDate" runat="server" Width="211px" BackColor="#CCCCCC" Enabled="false"
                ...
                <td style="height: 19px">
                    <asp:TextBox ID="dtpConfirmDate" runat="server" Width="211px" CssClass="date" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                ...
                <td style="height: 19px">
                    <asp:DropDownList ID="ddlSectionId" runat="server" Width="215px" Height="22px" BackColor="#CCCCCC" Enabled="false"> 
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:DropDownList ID="ddlDepartmentId" runat="server" Width="215px" Height="22px" Enabled="false">
                    </asp:DropDownList>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                ...
                <td style="height: 19px">
                    <asp:DropDownList ID="ddlShiftId" runat="server" Width="215px" Height="22px" Enabled="false">
                    </asp:DropDownList>
                </td>
            </tr>
           <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                    <asp:Label ID="Label12" runat="server" Text="Catagory :" ForeColor="Red"></asp:Label>
                </td>
                <td style="height: 19px; width: 247px;">
                    <asp:DropDownList ID="ddlCatagoryId" runat="server" Width="215px" Height="22px" BackColor="#CCCCCC" Enabled="false"> 
                    </asp:DropDownList>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                    <asp:Label ID="Label11" runat="server" Text="Curr. Designation :" ForeColor="Red"></asp:Label>
                </td>
                <td style="height: 19px">
            ...
            <tr>
                ...
                <td style="height: 19px; text-align: right; width: 108px;">
                    <asp:Label ID="Label14" runat="server" Text="Grade :"></asp:Label>                    
                </td>
                 <td style="height: 19px">
                     <asp:DropDownList ID="ddlGradeNo" runat="server" Width="215px" Height="22px" BackColor="#CCCCCC" Enabled="false"></asp:DropDownList>
                </td>
            </tr>
             <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                ...
                <td style="height: 19px">
                    <asp:DropDownList ID="ddlApprovedBy" runat="server" Width="215px" Height="22px" BackColor="#CCCCCC" Enabled="false">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:TextBox ID="txtReferenceName" runat="server" Width="211px" BackColor="White" Enabled="false"
                        OnTextChanged="txtEmployeeName2_TextChanged" Font-Bold="True"></asp:TextBox>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
            ...
            <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                    <asp:Label ID="Label36" runat="server" Text="Employee Type :"></asp:Label>
                </td>
                <td style="height: 19px; width: 247px;">
                    <asp:DropDownList ID="ddlEmployeeTypeId" runat="server" Width="215px" Height="22px" Enabled="false">
                    </asp:DropDownList>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                ...
                <td style="height: 19px">
                    <asp:DropDownList ID="ddlPaymentTypeId" runat="server" Width="215px" Height="22px" Enabled="false">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 247px; height: 2px">
                    <asp:Label ID="Label38" runat="server" Text="Account No :" Visible="false"></asp:Label>
                </td>
                <td style="height: 2px; width: 247px;">
                    <asp:TextBox ID="txtAccountNo" runat="server" Width="211px" BackColor="White" OnTextChanged="txtEmployeeName2_TextChanged"
                        Font-Bold="True" Visible="false" ></asp:TextBox>
                </td>
                <td style="height: 2px; text-align: right; width: 108px;">
                    <asp:Label ID="Label355" runat="server" Text="Bank :" Visible="false"></asp:Label>
                    
                </td>
                <td style="height: 2px">
                    <asp:DropDownList ID="ddlBank" runat="server" Width="215px" Height="22px" Visible="false">
                    </asp:DropDownList>
            ...
            <tr>
                <td style="text-align: right; width: 247px; height: 2px">
                    <asp:Label ID="Label40" runat="server" Text="Joining Salary :" ForeColor="Red" Visible="false"></asp:Label>
                </td>
                <td style="height: 2px; width: 247px;">
                    <asp:TextBox ID="txtJoiningSalary" runat="server" Width="211px" BackColor="#CCCCCC"
                        Height="3px" Font-Bold="True" Visible="false"></asp:TextBox>
                </td>
                <td style="height: 2px; text-align: right; width: 108px;">
                    <asp:Label ID="Label13" runat="server" Text="Gross Salary :" ForeColor="Red" Visible="false"></asp:Label>
                </td>
                <td style="height: 2px">
                    <asp:TextBox ID="txtGrossSalary" runat="server" Width="211px" BackColor="#CCCCCC"
                        placeHolder="GROSS SALARY" Height="2px" Font-Bold="True" Visible="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:TextBox ID="dtpResignDate" runat="server" Width="211px" CssClass="date" Height="20px" Enabled="false"></asp:TextBox>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                    <asp:Label ID="Label47" runat="server" Text="Resign Casue :"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtResignCause" runat="server" Width="211px" Height="20px"  Enabled="false"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:CheckBox ID="chkAcftiveYn" runat="server" Text="Yes" Enabled="false" />
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                    <asp:Label ID="Label17" runat="server" Text="Allow Payment :" Visible="false"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:CheckBox ID="ChkPaymentYn" runat="server" Text="Yes"  Visible="false"/>
                </td>
            </tr>

             <tr>
                <td style="text-align: right; width: 247px; height: 19px">
                    <asp:Label ID="Label16" runat="server" Text="Sitting Branch :"></asp:Label>
                    &nbsp;
                </td>
                <td style="height: 19px; width: 247px;">
                    <asp:DropDownList ID="ddlSittingBranchOfficeId" runat="server" Width="215px" Height="22px" BackColor="White"  Enabled ="false"> </asp:DropDownList>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                ...
                <td style="height: 19px">
                   <asp:TextBox ID="txtAllowanceFee" runat="server" Width="211px" BackColor="White"
                        OnTextChanged="txtEmployeeName2_TextChanged" Height="20px" Font-Bold="True" Enabled="false"></asp:TextBox> 
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="height: 19px; width: 247px;">
                    <asp:DropDownList ID="ddlTrainingPeriodId" runat="server" Width="215px" Height="22px" Enabled="false">
                    </asp:DropDownList>
                </td>
                <td style="height: 19px; text-align: right; width: 108px;">
                </td>
