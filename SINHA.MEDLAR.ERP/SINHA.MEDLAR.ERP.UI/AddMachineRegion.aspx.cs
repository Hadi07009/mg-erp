...
{
    public partial class AddMachineRegion : System.Web.UI.Page
    {
        ...
        public void loadMachineRegionRecord()
        {
            ...
            dt = objLookUpBLL.loadMachineRegionRecord();
        ...
        {
            txtMachineRegionId.Text = string.Empty;
            txtMachineRegion.Text = string.Empty;

        }

        public void saveMachineRegionInfo()
        {
            ...
            objWokerProcessDTO.MachineRegionId = txtMachineRegionId.Text;
            objWokerProcessDTO.MachineRegionName = txtMachineRegion.Text;
            ...
            string strMsg = objWorkerProcessBLL.saveMachineRegionInfo(objWokerProcessDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtMachineRegionId.Text = strProcessId;
            txtMachineRegion.Text = strProcessName;

            string strMsg = "Row Index: " + strRowId + "\\nMachine Region ID: " + strProcessId + "\\nMachine Region : " + strProcessName;
        ...
        {
            saveMachineRegionInfo();
            loadMachineRegionRecord();
            clearTextBox();
            txtMachineRegion.Focus();
        }
