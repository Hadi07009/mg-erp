...
{
    public partial class SalaryMonthlyResignEntry : System.Web.UI.Page
    {
        ...
        public void processMonthlyResignSalary()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
            ...
            string strMsg = objSalaryBLL.processMonthlyResignSalary(objSalaryDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        }
        ...
        public void searchEmployeeRecordforResignEntry()
        {
            ...
            if (strBranchOfficeId == "110")
                ...
                objEmployeeDTO.EmployeeTypeId = "2"; // Worker only
        ...
        public void monthlySalaryResignSheet()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalaryResignSheetWorker.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.monthlySalaryResignSheetWorker(objReportDTO));
