...
{
    public partial class AddOrderQty : System.Web.UI.Page
    {
        ...
        public void loadQtyRecordRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadQtyRecordRecord(txtPoNo.Text,txtStyleNo.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveTotalOrderQty()
        {
            ...
            objLookUpDTO.TotalOrderQTY = txttotalOrderQty.Text.Trim();

            objLookUpDTO.HeadOfficeId = strHeadOfficeId;
            objLookUpDTO.BranchOfficeId = strBranchOfficeId;
            objLookUpDTO.UpdateBy = strEmployeeId;

            string strMsg = objLookUpBLL.saveTotalOrderQty(objLookUpDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        }
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtStyleNo.Text = strSectionId;
            txtPoNo.Text = strSectionName;
            txttotalOrderQty.Text = strSectionBng;
