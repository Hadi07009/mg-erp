<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddArt.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddArt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtArtName.ClientID %>").focus(); }) 
    </script>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtArtId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="txtLineName" runat="server" Text="Art Name :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtArtName" runat="server" Width="236px" BackColor="White" Height="20px"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnDelete" runat="server" Height="31px" Text="Delete" Width="66px"
                        CssClass="styled-button-4" OnClick="btnDelete_Click" Visible="False" />
                </td>
                <td>
                    &nbsp;
                </td>
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="ART_ID" HeaderText="ID" />
                    <asp:BoundField DataField="ART_NO" HeaderText="ART NO" />
