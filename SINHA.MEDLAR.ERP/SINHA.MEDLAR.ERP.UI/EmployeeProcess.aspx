<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="EmployeeProcess.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.EmployeeProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>EMPLOYEE PROCESS INFORMATION</legend>
        <table class="style1">
            <tr>
                    ...
                    <fieldset>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td style="width: 390px; text-align: left;">
                                    <table style="width: 93%">
                                        <asp:DropDownList ID="ddlProcessId" runat="server" Width="238px" Height="22px">
                                        </asp:DropDownList>
                                    </table>
                                </td>
                                <td style="width: 247px; text-align: right;">
                            ...
                            <tr>
                                ...
                                <td style="width: 390px; text-align: left;">
                                    <asp:DropDownList ID="ddLEfficiencyId" runat="server" Width="238px" Height="22px">
                                    </asp:DropDownList>
                                    &nbsp;
                                </td>
                                <td style="width: 247px; text-align: right;">
                            ...
                            <tr>
                                <td style="width: 635px; text-align: right">
                                    <asp:Label ID="Label47" runat="server" Text="Capacity :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtCapacity" runat="server" Width="97px" Height="20px" BackColor="White"
                            ...
                            <tr>
                                <td style="width: 635px; text-align: right">
                                    <asp:Label ID="Label48" runat="server" Text="Stitch Length :"></asp:Label>
                                </td>
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtStitchLength" runat="server" Width="97px" Height="20px" BackColor="White"
                            ...
                            <tr>
                                ...
                                <td style="width: 390px; text-align: left;">
                                    <asp:TextBox ID="txtRemarks" runat="server" Width="269px" Height="46px" BackColor="White"
                                        ...
                                        <table class="style1">
                                            <tr>
                                                <td style="width: 118px; text-align: right; height: 22px;">
                                                    <asp:Label ID="Label45" runat="server" Text="Unit :"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 118px; text-align: right; height: 22px;">
                                                    <asp:Label ID="Label46" runat="server" Text="Section :"></asp:Label>
                                                </td>
                                                <td style="width: 163px; height: 22px;">
                                            ...
                                            <tr>
                                                <td style="width: 118px; text-align: right; height: 22px;">
                                                    <asp:Label ID="Label49" runat="server" Text="From Capacity :"></asp:Label>
                                                </td>
                                                <td style="width: 163px; height: 22px;">
                                                    <asp:TextBox ID="txtFromCapacity" runat="server" Width="149px" BackColor="White"
                                                        placeHolder="FROM CAPACITY"></asp:TextBox>
                                                </td>
                                                <td style="height: 22px; width: 97px;">
                                                    &nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 118px; text-align: right; height: 22px;">
                                                    <asp:Label ID="Label50" runat="server" Text="To Capacity :"></asp:Label>
                                                </td>
                                                <td style="width: 163px; height: 22px;">
                                                    <asp:TextBox ID="txtToCapacity" runat="server" Width="149px" BackColor="White" placeHolder="TO CAPACITY"></asp:TextBox>
                                                </td>
                                                <td style="height: 22px; width: 97px;">
                                                    &nbsp;
                                                </td>
                                    ...
                                    <td colspan="2">
                                        <asp:GridView ID="GridView1" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TARGET_VALUE" HeaderText="TARGET" />
                                                <asp:BoundField DataField="CAPACITY" HeaderText="CAPACITY" />
                                                <asp:BoundField DataField="STITCH_LENGTH" HeaderText="LENGTH" />
