<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddSupplierType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddSupplierType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript">
        $(window).load(function () { document.getElementById("<%= txtSupplierType.ClientID %>").focus(); }) 
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD SUPPLIER TYPE</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 337px; height: 22px;">
                    <asp:Label ID="lblId" runat="server" Text="ID : "></asp:Label>
                </td>
                <td style="height: 22px">
                    <asp:TextBox ID="txtSupplierTypeId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 337px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Supplier Type :"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSupplierType" runat="server" Width="236px" BackColor="White"
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="SUPPLIER_TYPE_ID" HeaderText="ID" />
                    <asp:BoundField DataField="SUPPLIER_TYPE" HeaderText="TYPE" />
