<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    ValidateRequest="false" EnableEventValidation="false" CodeBehind="AddArrearBonus.aspx.cs"
    Inherits="SINHA.MEDLAR.ERP.UI.AddArrearBonus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD ARREAR BONUS INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtArrearBonusId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtYear" runat="server" Width="140px" Height="20px" BackColor="Yellow"></asp:TextBox>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 337px; height: 19px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="To Month :"></asp:Label>
                </td>
            ...
            <tr>
                <td style="text-align: right; width: 337px; height: 19px">
                    <asp:Label ID="lblProductCataroy1" runat="server" Text="Total Bonus Month :"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtTotalArrearBounsMonth" runat="server" onkeydown="javascript:TextName_OnKeyDown(event)"
                        Width="72px" Height="20px"></asp:TextBox>
                    &nbsp;
                </td>
                <td style="height: 19px">
                    &nbsp;
                ...
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="arrear_from_month" HeaderText="FROM MONTH" />
                            <asp:BoundField DataField="arrear_to_month" HeaderText="TO MONTH" />
                            <asp:BoundField DataField="BONUS_MONTH" HeaderText="BONUS MONTH" />
