<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="Roster.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.Roster" %>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtRosterId" runat="server" Width="72px" BackColor="Yellow"  ReadOnly="True"></asp:TextBox>
                </td>
                <td style="height: 22px">
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td style="height: 21px">
                    <asp:TextBox ID="dtpEffectDate" runat="server" Width="191px" CssClass="date"></asp:TextBox>
                </td>
                <td style="height: 21px">
                </td>
            </tr>
            <tr>
                <td style="text-align: right; width: 339px; height: 19px">
                    <asp:Label ID="lblActiveYn" runat="server" Text="Active Y/N:"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:CheckBox ID="chkAcftiveYn" runat="server" />
                </td>
                <td style="height: 19px">
                    &nbsp;
                </td>
            ...
            <tr>
            <td style="text-align: right; height: 19px" colspan="5">
            <asp:GridView ID="gvRoster" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowDataBound="OnRowDataBound" >
                <Columns>
                    <asp:BoundField DataField="ROSTER_ID" HeaderText="ID" />
                    <asp:BoundField DataField="EFFECT_DATE" HeaderText="DATE" />
