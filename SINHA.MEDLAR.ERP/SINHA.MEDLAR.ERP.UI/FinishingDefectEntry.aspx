<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="FinishingDefectEntry.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.FinishingDefectEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>FINISHING DEFECT ENTRY</legend>
        <table style="width: 99%; height: 441px; font-weight: 700;">
            ...
            <tr>
                ...
                <td style="width: 108px; height: 19px;">
                    <asp:TextBox ID="txtFinishingDefectentryId" runat="server" BackColor="Yellow" 
            ...
            <tr>
                ...
                <td style="height: 11px; width: 94px">
                </td>
            ...
            <tr>
                ...
                <td style="height: 5px; width: 94px">
                    </td>
            ...
            <tr>
                ...
                <td style="height: 28px; width: 101px; text-align: right;">
                ...
                <td style="height: 28px; width: 94px; text-align: right;">
            ...
            <tr>
                <td style="text-align: right; width: 87px; height: 8px">
                    <asp:Label ID="Label6" runat="server" Font-Bold="False" Text="BTN/Hole Defect:"></asp:Label>
                </td>
                <td style="width: 108px; height: 21px;">
                    <asp:TextBox ID="txtBtnHoleDefect" runat="server" Width="115px" 
                        Height="16px"></asp:TextBox>
                </td>
                <td style="height: 8px; width: 101px; text-align: right;" class="style3">
                    <asp:Label ID="Label7" runat="server" Font-Bold="False" Text="Broken Stitch :"></asp:Label>
                </td>
                <td style="height: 8px; width: 74px;">
                    <asp:TextBox ID="txtBrokenStitch" runat="server" Width="115px" Height="16px"></asp:TextBox>
                </td>
                <td style="height: 8px; width: 94px; text-align: right;">
            ...
            <tr>
                ...
                <td style="height: 4px; width: 101px; text-align: right;">
                ...
                <td style="width: 94px; height: 4px; text-align: right;">
            ...
            <tr>
                ...
                <td style="height: 14px; width: 101px; text-align: right;">
                ...
                <td style="height: 14px; width: 94px; text-align: right;">
            ...
            <tr>
                ...
                <td style="height: 20px; width: 101px; text-align: right;">
                ...
                <td style="height: 20px; width: 94px; text-align: right;">
                    <asp:Label ID="Label21" runat="server" Font-Bold="False" Text="Rawedge/Fraying:"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td style="height: 4px; width: 94px">
                </td>
            ...
            <tr>
                ...
                <td style="height: 21px; width: 101px; text-align: right;">
                ...
                <td style="height: 21px; width: 94px; text-align: right;">
            ...
            <tr>
                ...
                <td style="height: 13px; width: 101px; text-align: right;">
                ...
                <td style="height: 13px; width: 94px; text-align: right;">
                    &nbsp;<asp:Label ID="Label28" runat="server" Font-Bold="False" Text="Pnl HiLw/Updwn:"></asp:Label>
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td style="height: 9px; width: 101px; text-align: right;">
                ...
                <td style="height: 9px; width: 94px; text-align: right;">
                    <asp:Label ID="Label31" runat="server" Font-Bold="False" 
                        Text="Umtch Pair Unbl:"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td style="height: 3px; width: 101px; text-align: right;">
                ...
                <td style="height: 3px; width: 94px; text-align: right;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        <legend style="font-weight: 700">FINISHING DEFECT ENTRY RESULT </legend>
        <div id="divGridViewScroll" style="width: 680px;  overflow: scroll">
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                            ...
                            OnRowEditing="gvUnit_RowEditing" Width="667px">
                            <Columns>
                              
                                <asp:BoundField DataField="FINISHING_DEFECT_ENTRY_ID" HeaderText="ID" />
