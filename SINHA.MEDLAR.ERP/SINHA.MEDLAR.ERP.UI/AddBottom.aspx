<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" EnableEventValidation ="false"
    CodeBehind="AddBottom.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddBottom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: right; width: 279px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Bottom Name :"></asp:Label>
                </td>
                <td>
    ...
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="BOTTOM_ID" HeaderText="ID" />
                    <asp:BoundField DataField="BOTTOM_NAME" HeaderText="NAME" />
                </Columns>
            </asp:GridView>
        </td>
    </fieldset>
