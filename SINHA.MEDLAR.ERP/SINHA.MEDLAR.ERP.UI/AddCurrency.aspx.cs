...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class AddCurrency : System.Web.UI.Page
    {
        ...
        public void loadCurrencyRecord()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadCurrencyRecord(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveCurrencyName()
        {
            ...
            objLookUpDTO.CurrencyId = txtCurrencyId.Text;
            objLookUpDTO.CurrencyName = txtCurrencyName.Text;
            ...
            string strMsg = objLookUpBLL.saveCurrencyName(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtCurrencyId.Text = strCourseId;
            txtCurrencyName.Text = strcourseName;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (txtCurrencyName.Text == "")
            {
                ...
                string strMsg = "Please Enter Currency Name!!!";
