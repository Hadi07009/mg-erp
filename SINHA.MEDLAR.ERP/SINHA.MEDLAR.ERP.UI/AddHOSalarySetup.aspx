<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddHOSalarySetup.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddHOSalarySetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD HO SALARY SETUP</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <%--<td>
                    <asp:TextBox ID="txtZipperQtyUnitId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
