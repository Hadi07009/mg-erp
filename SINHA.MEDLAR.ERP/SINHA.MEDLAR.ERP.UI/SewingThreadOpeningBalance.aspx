<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="SewingThreadOpeningBalance.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.SewingThreadOpeningBalance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>SEWING THREAD OPENINIG BALANCE INFORMATION</legend>
        <table class="style1">
            <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2">
                    <fieldset>
                        <legend>SEWING THREAD OPENING BALANCE ENTRY</legend>
                        <table class="style1">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;" class="style3">
                                    <asp:Label ID="lblPOType0" runat="server" Text="Programme :"></asp:Label>
                                </td>
                                <td style="text-align: left;" class="style3">
                                    <%--<asp:TextBox ID="txtPoType" runat="server" Width="236px" BackColor="White" Font-Bold="False"
                                        ForeColor="Black"></asp:TextBox>--%>
                                    <asp:DropDownList ID="ddlProgrammeId" runat="server" Width="240px"
                                        Height="22px">
                                    </asp:DropDownList>
                                </td>
                                <td class="style3"></td>
                            ...
                            <tr>
                                <td style="text-align: right" colspan="4">
                                    <fieldset>
                                        <legend>SEWING THREAD OPENING BALANCE SEARCH</legend>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvPOEntry" runat="server" DataSourceID="" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="ART NO" ItemStyle-Width="1%">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtArtNo" runat="server" Text='<%#Eval("ART_NO")%> ' Width="300"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="COUNT" ItemStyle-Width="1%">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="QUANTITY" ItemStyle-Width="1%">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtBalanceQty" runat="server" Text='<%#Eval("QUANTITY")%> ' Width="300"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="ID" ItemStyle-Width="1%">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtThreadId" runat="server" Text='<%#Eval("TRAN_ID")%> ' Width="10"
                                                                        DataField="THREAD_ID" BackColor="Yellow" ReadOnly="true" SortExpression="THREAD_ID"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
