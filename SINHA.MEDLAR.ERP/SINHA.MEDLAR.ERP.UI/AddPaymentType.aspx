<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddPaymentType.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddPaymentType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(window).load(function () { document.getElementById("<%= txtPaymentTypeId.ClientID %>").focus(); }) 
    </script>
    ...
    <fieldset>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPaymentTypeId" runat="server" Width="72px" 
            ...
            <tr>
                <td style="text-align: right; width: 339px">
                    <asp:Label ID="lblPaymentTypeName" runat="server" Text="Payment Type:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPaymentTypeName" runat="server" Width="236px" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <fieldset>
        ...
        <td style="text-align: right; height: 19px" colspan="3">
            <asp:GridView ID="gvPaymentType" runat="server" DataSourceID="" AutoGenerateColumns="False"
                GridLines="None" AllowPaging="false" CssClass="mGrid" PagerStyle-CssClass="pgr"
                AlternatingRowStyle-CssClass="alt" OnPageIndexChanging="gvPaymentType_PageIndexChanging"
                OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged"
                OnRowEditing="gvPaymentType_RowEditing" BorderStyle="Solid">
                <Columns>
                    <asp:BoundField DataField="PAYMENT_TYPE_ID" HeaderText="ID" />
