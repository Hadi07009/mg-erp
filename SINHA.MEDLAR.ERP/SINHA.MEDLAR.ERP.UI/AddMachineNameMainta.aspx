<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddMachineNameMainta.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddMachineNameMainta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD MACHINE NAME</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMachineNameId" runat="server" Width="50px" 
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:TextBox ID="txtMachineName" runat="server" Height="20px" 
                        Width="200px"  onkeydown="javascript:TextName_OnKeyDown(event)"></asp:TextBox>
                </td>
                <td style="height: 22px">
                </td>
            </tr>
