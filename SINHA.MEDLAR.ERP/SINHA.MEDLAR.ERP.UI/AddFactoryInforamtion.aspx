<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddFactoryInforamtion.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddFactoryInforamtion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD FACTORY INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="3">
                    <fieldset>
                        <legend>FACTORY INFORMATION ENTRY</legend>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtFactoryId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblId0" runat="server" Text="Factory Name :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtFactoryName" runat="server" Width="236px" BackColor="White"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblId1" runat="server" Text="Phone No :"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblProductCataroy" runat="server" Text="Factory Address :"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align: right; width: 279px">
                                    <asp:Label ID="lblProductCataroy3" runat="server" Text="Office Address :"></asp:Label>
                                </td>
                                <td>
            ...
            <tr>
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="FACTORY_ID" HeaderText="ID" />
                            <asp:BoundField DataField="FACTORY_NAME" HeaderText="NAME" />
                            <asp:BoundField DataField="FACTORY_ADDRESS" HeaderText="FACTORY ADDRESS" />
