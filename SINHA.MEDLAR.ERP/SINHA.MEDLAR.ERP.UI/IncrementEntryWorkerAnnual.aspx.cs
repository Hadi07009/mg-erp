...
{
    public partial class IncrementEntryWorkerAnnual : System.Web.UI.Page
    {
        ...
        public void searchWorkerRecordForIncrement()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                // getFirsatIndex();
                addWorkerIncrementAnnual();
                processIncrementWorkerAnnual();
...
(CrystalDecisions.Shared.ExportFormatType.ExcelRecord, Response, true, "salary_sheet_worker");
        ...
        public void processIncrementWorkerAnnual()
        {
        ...
        public void addWorkerIncrementAnnual()
        {
            ...
            foreach (GridViewRow row in gvEmployeeList.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                        ...
                        strMsg = objSalaryBLL.addWorkerIncrementAnnual(objSalaryDTO);
            ...
            //if (strMsg == "ADDED SUCCESSFULLY" || strMsg == "PLEASE CHECK UNIT OR SECTION OR CLICK SEARCH BUTTON!!!")
            //{
            //    MessageBox(strMsg);
            //    lblMsg.Text = strMsg;
        ...
        public void searchWorkerIncrementEntry()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
           ...
           // objSalaryDTO = objSalaryBLL.searchWorkerIncrementEntry(txtEmployeeId.Text, txtIncrementYear.Text, txtsalaryMonth.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);
