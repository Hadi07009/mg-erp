<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AddColorContract.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddColorContract" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD COLOR CONTRACT INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                <td style="text-align: left;" colspan="2">
                    <fieldset>
                        <legend>ADD COLOR CONTRACT</legend>
                        <table class="style1">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtColorName" runat="server" Width="236px" BackColor="White"
            ...
            <tr>
                <td style="text-align: right;" colspan="2">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        OnRowEditing="gvUnit_RowEditing" BorderStyle="Solid" Width="1017px">
                        <Columns>
