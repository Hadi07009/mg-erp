...
{
    public partial class MiscEntryHO : System.Web.UI.Page
    {
        ...
        public void searchSalaryInfoHO()
        {
            ...
            dt = objEmployeeBLL.searchSalaryInfoHO(objEmployeeDTO);
        ...
        public void searchEmployeeRecordforMiscEntry()
        {
            ...
            dt = objEmployeeBLL.searchEmployeeRecordforMiscEntryHO(objEmployeeDTO);
        ...
        public void searchEmployeeMisc()
        {
            ...
            objEmployeeDTO = objEmployeeBLL.searchEmployeeMisc(txtEmployeeId.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);

            if (objEmployeeDTO.Msg == "1")
            {

                strMsg = objEmployeeDTO.EmployeeName + " HAS MISCELLANEOUS SHEET";
                lblMsgSecondSheet.ForeColor = System.Drawing.Color.OrangeRed;
                lblMsgSecondSheet.Text = strMsg;
            }
            else
            {

                lblMsgSecondSheet.Text = "";
        ...
        public void saveSalaryMiscEntry()
        {
            ...
            string strMsg = objSalaryBLL.saveSalaryMiscEntry(objSalaryDTO);
        ...
        public void searchMonthLoanEntryStaff()
        {
            SalaryDTO objSalaryDTO = new SalaryDTO();
            SalaryBLL objSalaryBLL = new SalaryBLL();
        ...
        public void searchMiscEntry()
        {
            ...
            objSalaryDTO = objSalaryBLL.searchMiscEntry(txtEmployeeId.Text, txtSalaryYear.Text, txtsalaryMonth.Text, strUnitId, strSectionId, strHeadOfficeId, strBranchOfficeId);
            ...
            if (objSalaryDTO.WorkingDay == null || objSalaryDTO.WorkingDay == "-32")
            {
                ...
                objSalaryDTO = objSalaryBLL.searchWorkingDay(txtEmployeeId.Text, txtSalaryYear.Text, txtsalaryMonth.Text, strHeadOfficeId, strBranchOfficeId);
        ...
        public void monthlySalarySheetTIN()
        {
            ...
            try
            {
                ...
                //string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetHO.rpt"));
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetHOTIN.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.salarySheetHO(objReportDTO));
        ...
        public void monthlyBankSlip()
        {
            ...
            string strPath = Path.Combine(Server.MapPath("~/Reports/rptBankSlip.rpt"));
            this.Context.Session["strReportPath"] = strPath;
            rd.Load(strPath);
            rd.SetDataSource(objReportBLL.montlyBankSalarySlip(objReportDTO));
        ...
        public void monthlyBankSheet()
        {
            ...
            //New
            rd.SetDataSource(objReportBLL.GetSalaryAdvice(objReportDTO));
        ...
        protected void btnSalarySheetByBank_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        public void monthlySalarySheetByBank()
        {
        ...
        public void processSalaryHO()
        {
            ...
            string strMsg = objSalaryBLL.processSalaryHO(objSalaryDTO);
            MessageBox(strMsg);
            lblMsg.Text = strMsg;
        ...
        public void monthlyCashSalarySheet()
        {
        ...
        public void GetCNFCashSalarySheet()
        {
            ...
            objReportDTO.UnitId = "133"; //C&F
            objReportDTO.SectionId = "80"; //C&F
            ...
            this.Context.Session["strReportPath"] = strPath;
            rd.Load(strPath);
            rd.SetDataSource(objReportBLL.GetCNFCashSalarySheet(objReportDTO));
        ...
        public void monthlyCashSalarySheetDirector()
        {
            ...
            string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalaryCashSheetHODirector.rpt"));
            this.Context.Session["strReportPath"] = strPath;
            rd.Load(strPath);
            rd.SetDataSource(objReportBLL.monthlySalaryCheckSheetDirector(objReportDTO));
        ...
        public void monthlyCashSalarySheetDirectorHO()
        {
            ...
            string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalaryCashSheetHODirectorHO.rpt"));
            this.Context.Session["strReportPath"] = strPath;
            rd.Load(strPath);
            rd.SetDataSource(objReportBLL.monthlySalaryCheckSheetDirectorHO(objReportDTO));
        ...
        public void monthlyCashSalarySlip()
        {
        ...
        protected void btnMonthlyCashSheet_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        protected void btnMonthlyCashSalarySlip_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        protected void btnMonthlyBankSalarySlip_Click(object sender, EventArgs e)
        {
        ...
        protected void btnMonthlySalaryRequisition_Click(object sender, EventArgs e)
        {
        ...
        protected void btnMonthlyCashRequisition_Click(object sender, EventArgs e)
        {
            if (txtSalaryYear.Text == "")
            {
        ...
        protected void btnMonthlyCashSheetDirector_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    monthlyCashSalarySheetDirector();
        ...
        protected void btnMonthlyCashRequisitionDirector_Click(object sender, EventArgs e)
        {
            //if (txtSalaryYear.Text == "")
            //{
            ...
            //    string strPath = Path.Combine(Server.MapPath("~/Reports/rptMonthlyCashRequisitionDirector.rpt"));
            //    this.Context.Session["strReportPath"] = strPath;
            //    rd.Load(strPath);
            //    DataSet ds = new DataSet();

            //    ds = (objReportBLL.monthlyCashRequisitionDirector(objReportDTO));
            //    rd.SetDataSource(ds);
            //    rd.SetDatabaseLogon("erp", "erp");
            //    CrystalReportViewer1.ReportSource = rd;
            //    CrystalReportViewer1.DataBind();
            ...
            try
            {
                ...
                {
                    monthlyCashSalarySheetDirectorHO();
        ...
        protected void btnSalarySheetTemporary_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtSalaryYear.Text == string.Empty)
        ...
        public void monthlySalarySheetTemp()
        {
            ...
            try
            {
                ...
                string strPath = Path.Combine(Server.MapPath("~/Reports/rptSalarySheetHOTemp.rpt"));
                this.Context.Session["strReportPath"] = strPath;
                rd.Load(strPath);
                rd.SetDataSource(objReportBLL.salarySheetHOTemp(objReportDTO));
        ...
        protected void BtnCashSheetCNF_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        protected void BtnCashReqCNF_Click(object sender, EventArgs e)
        {
            if (txtSalaryYear.Text == "")
            {
            ...
            else
            {
                ...
                ds = (objReportBLL.GetCNFCashRequisitionMAL(objReportDTO));
                rd.SetDataSource(ds);
                rd.SetDatabaseLogon("erp", "erp");
                CrystalReportViewer1.ReportSource = rd;
                CrystalReportViewer1.DataBind();
        ...
        protected void btnSalaryTIN_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtSalaryYear.Text == string.Empty)
