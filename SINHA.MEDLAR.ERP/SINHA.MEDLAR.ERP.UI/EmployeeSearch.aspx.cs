...
namespace SINHA.MEDLAR.ERP.UI
{
    public partial class EmployeeSearch : System.Web.UI.Page
    {
        ...
        public void showEmployee(string strEmployeeId, string strHeadOfficeId, string strBranchOfficeId)
        {

            this.Context.Session["strID"] = strEmployeeId;
            //Response.Redirect("EmployeeBasic.aspx", strEmployeeId);
            //Response.Redirect("EmployeeBasic.aspx?Parameter=" + strEmployeeId);

            //EmployeeBasicInfo objEmployeeBasicInfo = new EmployeeBasicInfo();
            //objEmployeeBasicInfo.passValue(strEmployeeId, strHeadOfficeId);
            Response.Redirect("EmployeeBasic.aspx?Parameter=" + strEmployeeId, true);
        ...
        public void employeeSheet()
        {
            ...
            try
            {
                ...
                objReportDTO.FromCreateDate = dtpFromCreateDate.Text;
                objReportDTO.ToCreateDate = dtpToCreateDate.Text;
