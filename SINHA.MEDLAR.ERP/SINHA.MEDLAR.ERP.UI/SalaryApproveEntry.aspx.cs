...
{
    public partial class SalaryApproveEntry : System.Web.UI.Page
    {
        ...
        public void saveSalaryApproveEntry()
        {
            ...
            objSalaryDTO.OccurrenceTypeId = 3;
            ...
            string strMsg = objSalaryBLL.saveSalaryApproveEntry(objSalaryDTO);
            //MessageBox(strMsg);
            lblMsg.Text = strMsg;
