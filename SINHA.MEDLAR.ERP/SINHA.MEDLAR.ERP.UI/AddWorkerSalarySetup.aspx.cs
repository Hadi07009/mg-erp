...
{
    public partial class AddWorkerSalarySetup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtExtraFoodFee.Attributes.Add("onkeypress", "return controlEnter('" + btnSave.ClientID + "', event)");
        }
        ...
        public void loadWorkerSalarySetup()
        {
            LookUpDTO objLookUpDTO = new LookUpDTO();
            LookUpBLL objLookUpBLL = new LookUpBLL();

            DataTable dt = new DataTable();
            dt = objLookUpBLL.loadWorkerSalarySetup(strHeadOfficeId, strBranchOfficeId);
        ...
        public void saveWorkerSalarySetup()
        {
            ...
            string strMsg = objLookUpBLL.saveWorkerSalarySetup(objLookUpDTO);
            lblMsg.Text = strMsg;
            MessageBox(strMsg);
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strStaffRowNum = gvUnit.SelectedRow.Cells[0].Text.Replace("&nbsp;", "");
