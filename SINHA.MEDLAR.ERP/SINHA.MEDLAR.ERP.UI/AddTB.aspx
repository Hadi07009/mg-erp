<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true"
    CodeBehind="AddTB.aspx.cs" Inherits="SINHA.MEDLAR.ERP.UI.AddTB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <fieldset>
        <legend>ADD TOP/BOTTOM INFORMATION</legend>
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtProcessId" runat="server" Width="72px" BackColor="Yellow"></asp:TextBox>
            ...
            <tr>
                <td style="text-align: right; width: 279px">
                    <asp:Label ID="lblProductCataroy" runat="server" Text="Top/Bottom :"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlProcessTypeId" runat="server" Width="215px" Height="22px">
                    </asp:DropDownList>
                </td>
                <td>
                    &nbsp;
            ...
            <tr>
                <td style="text-align: right; width: 279px">
                    <asp:Label ID="lblProductCataroy1" runat="server" Text="Under Top/Bottom :"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlProcessSelectTypeId" runat="server" Width="215px" 
                        Height="22px">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
                <td style="text-align: right; width: 279px; height: 19px">
                    <asp:Label ID="lblProductCataroy0" runat="server" Text="Name :"></asp:Label>
                </td>
                <td style="height: 19px">
                    <asp:TextBox ID="txtProcessName" runat="server" Width="210px" BackColor="White" MaxLength="300"  onkeydown="javascript:TextName_OnKeyDown(event)"
                ...
                <td style="text-align: right;" colspan="3">
                    <asp:GridView ID="gvUnit" runat="server" DataSourceID="" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SIZE_TYPE_NAME" HeaderText="PROCESS" />
