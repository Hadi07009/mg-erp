...
namespace SINHA.MEDLAR.ERP.BLL
{
    public class ReportBLL
    {
        ...
        public DataSet rptArrearSheetStaff(ReportDTO objReportDTO)
        {
            try
            {
                DataSet ds = new DataSet();
                ...
                try
                {
                    ...
                    ReportDAL objReportDAL = new ReportDAL();
                    ds = objReportDAL.rptArrearSheetStaff(objReportDTO);
                }
                catch (Exception ex)
                {
                    throw ex;
        ...
        public DataTable GetWorkerNightSheetByUnitGroup(ReportDTO objReportDTO)
        {
            try
            {
                ...
                {
                    ReportDAL objReportDAL = new ReportDAL();
                    dt = objReportDAL.GetWorkerNightSheetByUnitGroup(objReportDTO);
                }
                catch (Exception ex)
                {
                    throw ex;
        ...
        public DataSet TiffinRequiDaily(ReportDTO objReportDTO)
        {
            try
            {
                ...
                try
                {
                    ...
                    ReportDAL objReportDAL = new ReportDAL();
                    ds = objReportDAL.TiffinRequiDaily(objReportDTO);
                }
                catch (Exception ex)
                {
                    throw ex;
        ...
        public DataSet monthlySalRequSummeryS(ReportDTO objReportDTO)
        {
            try
            {
                DataSet ds = new DataSet();
                ...
                try
                {
                    ...
                    ReportDAL objReportDAL = new ReportDAL();
                    ds = objReportDAL.monthlySalRequiSummeryS(objReportDTO);
                }
                catch (Exception ex)
                {
                    throw ex;
        ...
        public string TiffinRequisitionDaily(ReportDTO objReportDTO)
        {
            ReportDAL objReportDAL = new ReportDAL();
            string strMsg = "";
            strMsg = objReportDAL.TiffinRequisitionDaily(objReportDTO);
            return strMsg;
        }
        ...
        public string processSalaryRequisitionS(ReportDTO objReportDTO)
        {
            ReportDAL objReportDAL = new ReportDAL();
            string strMsg = "";
            strMsg = objReportDAL.processSalaryRequisitionS(objReportDTO);
            return strMsg;
        }
